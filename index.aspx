...
<html lang="en" class=" is-copy-enabled is-u2f-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Frank's personal website</title>
...
<ul class="vcard-details border-top border-gray-light py-3">
  ...
  <div class="single-column">
    <div class="boxed-group flush js-pinned-repos-reorder-container">
      <h3>
        ...
        <ul class="boxed-group-inner mini-repo-list">
          <li style="text-align:left;padding:5px 20px;">I'm now  a first year <strong><a href="http://itws.rpi.edu/">MSIT</a></strong> (Master of Science in Information Technology) student at <strong><a href="http://www.rpi.edu">RPI</a></strong>.</li>
        </ul>
    </div>
  </div>
</div>
    ...
    <ul class="boxed-group-inner mini-repo-list">
         <li  style="text-align:left;padding:5px 20px;"><strong>Vertical Search Engine</strong><br />
          I was responsible for the final develiry, design and schedule.<br />
          Laguanges/Framework/Tools/DB used: C#, .net framework, MongoDB, MySQL, and etc.  <br /><br /></li>

          <li  style="text-align:left;padding:5px 20px;"><strong>Life Insurance Core System</strong><br />
          I took charge of the high level design (both functional and technical).<br /> 
         Laguanges/Framework/Tools/DB used: AS/400, Cobol, DB2, and etc.  <br /><br /></li>
    </ul>
</div>
    ...
    <ul class="boxed-group-inner mini-repo-list">
    <li style="text-align:left;padding:5px 20px;">1991 - 1995 <strong>Computer Science</strong> student at <strong>Tianjin University</strong>.</li>
    </ul>
    </div>
