...
function() {
    var e = require("github/jquery")["default"]
      ...
      , n = void 0
      , o = void 0;
    i = require("github/inspect")["default"],
    ...
    e(document).on("ajaxError", "[data-remote]", function(e, r, s, a) {
        ...
        if (this === e.target && "abort" !== a && "canceled" !== a) {
            if (c = "." + this.className.split(" ").sort().join("."),
            u = new t(a + " (" + r.status + ") from " + c),
            n(u, {
                dataRemote: {
                    target: i(this),
...
function() {
    ...
    e = {
        ...
        recordPageView: function() {
            ...
            null == this.app ? !1 : null == this.host ? (i("Host not set, you are doing something wrong"),
        ...
        _queryString: function(e, t, i) {
            ...
            return o = function() {
                ...
                for (n in e)
                    r = e[n],
                    t.push("dimensions[" + n + "]=" + r);
                return t
            }
            .call(this),
            o.push(this._encodeObject("dimensions", this._merge(this.dimensions, e))),
            ...
            o.push(this._encodeObject("context", this._merge(this.context, i))),
            o.push(this._actor()),
        ...
        _performanceTiming: function() {
            ...
            if (null == window.performance || null == window.performance.timing || null == window.performance.timing.navigationStart)
                return null ;
            for (u = {},
            s = this.expectedPerformanceTimingKeys,
            t = 0,
            n = s.length; n > t; t++)
                i = s[t],
                u[i] = null != (a = window.performance.timing[i]) ? a : 0;
            l = 1,
            r = [],
            e = u.navigationStart;
            for (i in u)
        ...
        _merge: function() {
            var e = void 0
              ...
              , s = void 0
              , a = void 0;
            for (s = 1 <= arguments.length ? o.call(arguments, 0) : [],
            n = {},
            e = 0,
            i = s.length; i > e; e++) {
                r = s[e];
        ...
        _encodeObject: function(e, t) {
            var i = void 0
              ...
              , s = void 0;
            if (r = [],
            null != Array.isArray && Array.isArray(t) || "[object Array]" === Object.prototype.toString.call(t))
                for (n = 0,
                o = t.length; o > n; n++)
                    i = t[n],
                    r.push(this._encodeObject(e + "[]", i));
            else if (t === Object(t))
                for (s in t)
                    r.push(this._encodeObject(e + "[" + s + "]", t[s]));
            else
        ...
        _actor: function() {
            ...
            for (o in s)
                if (a = s[o],
                e = "dimensions[actor_" + o + "]",
                a.join)
                    for (n = 0,
                    r = a.length; r > n; n++)
                        i = a[n],
                        t.push(e + "[]=" + this._encode(i));
                else
                    t.push(e + "=" + this._encode(a));
            return t.join("&")
        },
        ...
        _getClientId: function() {
            ...
            s = n.length; s > r; r++)
                ...
                a = i.value.split("."),
                o = a.shift(),
                "GH1" === o && a.length > 1 && (u = a.shift().split("-"),
                1 === u.length && (u[1] = "1"),
                u[0] *= 1,
                u[1] *= 1,
                e = a.join("."),
        ...
        _setClientId: function() {
            ...
            e = Math.round(Math.random() * (Math.pow(2, 31) - 1)) + "." + Math.round(o / 1e3),
            t = "GH1.1." + e,
            n = new Date(o + 63072e6).toGMTString(),
            i = "." + document.domain.split(".").reverse().slice(0, 2).reverse().join("."),
            document.cookie = "_octo=" + t + "; expires=" + n + "; path=/; domain=" + i,
            e
        },
        _encode: function(e) {
        ...
        applyCall: function(e) {
            ...
            return n = e[0],
            t = e.slice(1),
            this[n] ? this[n].apply(this, t) : i(n + " is not a valid method")
        },
        ...
        _addField: function(e, t, i) {
            return i.attributes["data-array"] ? (null == e[t] && (e[t] = []),
            e[t].push(i.content)) : e[t] = i.content
        },
    ...
    window._octo ? window._octo.slice && (t = window._octo.slice(0),
    window._octo = e,
    window._octo.applyQueuedCalls(t)) : window._octo = e
}
.call(this),
function() {
...
function() {
    ...
    var t = require("github/jquery")["default"]
      ...
      , n = require("github/focused")["default"]
      , o = require("github/throttled-input")
      , r = o.addThrottledInputEventListener
      , s = o.removeThrottledInputEventListener
      , a = void 0
      , u = void 0
      , c = void 0
      , l = void 0
      ...
      , v = void 0
      , m = void 0;
    a = require("github/sliding-promise-queue")["default"],
    d = require("delegated-events").fire,
    l = require("github/fetch").fetchText,
    v = new WeakMap,
    f = new WeakMap,
    h = function(e, i) {
        var n = void 0;
        return (n = v.get(e)) || (n = new a,
        v.set(e, n)),
        i.value.trim() ? (i.authenticity_token = null != e.form.elements.authenticity_token ? e.form.elements.authenticity_token.value : void 0,
        n.push(l(e.getAttribute("data-autocheck-url"), {
            method: "post",
            body: t.param(i),
            headers: {
    ...
    c = function(e) {
        ...
        t(e).find("p.note").hide()
    }
    ,
    m = function(e) {
        return e.classList.remove("errored"),
        e.classList.remove("warn"),
        t(e).find("p.note").show(),
        t(e).find("dd.error").remove(),
        t(e).find("dd.warning").remove()
    }
    ,
    u = function(e) {
        var n = void 0
        ...
        d(e, "autocheck:send", r),
        s = t.param(r).split("&").sort().join("&"),
        s !== f.get(e) ? (f.set(e, s),
        n.closest("dl.form-group").removeClass("errored successed"),
        e.classList.remove("is-autocheck-successful", "is-autocheck-errored"),
        l = function(t) {
            return e.classList.toggle("is-autocheck-loading", t),
            n.closest("dl.form-group").toggleClass("is-loading", t)
        }
        ,
        o = function() {
            return l(!1),
            d(e, "autocheck:complete")
        }
        ,
        a = function(t) {
            var i = void 0;
            return e.classList.add("is-autocheck-successful"),
            i = e.closest("dl.form-group"),
            m(i),
            i.classList.add("successed"),
            d(e, "autocheck:success", t),
            o()
        }
        ,
        u = function(t) {
            var n = void 0
              , r = void 0;
            return n = e.closest("dl.form-group"),
            "empty" === t.message ? m(n) : i(e) && (e.classList.add("is-autocheck-errored"),
            r = (null != t.response ? t.response.text() : void 0) || Promise.resolve("Something went wrong"),
            r.then(function(i) {
                var o = void 0;
                ...
                null != t.response && t.response.headers.get("Content-Type").match("text/html") ? o.innerHTML = i : o.textContent = i,
                n.append(o),
                d(e, "autocheck:error")
            })),
            o()
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , u = require("github/navigation").pop
      , c = require("github/navigation").push
      , l = void 0
      , d = void 0
      , h = void 0
      , f = void 0
    ...
    ;
    d = require("github/sliding-promise-queue")["default"],
    f = require("github/fetch").fetchText,
    l = function() {
        function i() {
            this.onNavigationOpen = v(this.onNavigationOpen, this),
            this.onNavigationKeyDown = v(this.onNavigationKeyDown, this),
            this.onInputChange = v(this.onInputChange, this),
            this.onResultsMouseDown = v(this.onResultsMouseDown, this),
            this.onInputBlur = v(this.onInputBlur, this),
            this.onInputFocus = v(this.onInputFocus, this),
            this.focusedInput = this.focusedResults = null ,
            this.mouseDown = !1,
            this.fetchQueue = new d
        }
        return i.prototype.bindEvents = function(t, i) {
            return e(t).on("blur", this.onInputBlur),
            r(t, this.onInputChange),
            e(i).on("mousedown", this.onResultsMouseDown),
            e(i).on("navigation:open", "[data-autocomplete-value]", this.onNavigationOpen),
            e(i).on("navigation:keydown", "[data-autocomplete-value]", this.onNavigationKeyDown)
        }
        ,
        i.prototype.unbindEvents = function(t, i) {
            return e(t).off("blur", this.onInputBlur),
            s(t, this.onInputChange),
            e(i).off("mousedown", this.onResultsMouseDown),
            e(i).off("navigation:open", "[data-autocomplete-value]", this.onNavigationOpen),
            e(i).off("navigation:keydown", "[data-autocomplete-value]", this.onNavigationKeyDown)
        }
        ,
        i.prototype.onInputFocus = function(t) {
            var i = void 0
              , n = void 0;
            i = e(t).closest(".js-autocomplete-container"),
            n = i.find(".js-autocomplete")[0],
            this.focusedInput = t,
            this.focusedResults = n,
            this.bindEvents(t, n),
            e(t).attr("autocomplete", "off"),
            e(t).trigger("autocomplete:focus"),
        ...
        i.prototype.onInputBlur = function() {
            var t = void 0
              , i = void 0;
            t = this.focusedInput,
            i = this.focusedResults,
            this.mouseDown || (this.hideResults(),
            this.inputValue = null ,
            this.focusedInput = this.focusedResults = null ,
            this.unbindEvents(t, i),
            e(t).trigger("autocomplete:blur"))
        }
        ,
        ...
        i.prototype.onInputChange = function(t) {
            var i = void 0;
            i = t.currentTarget,
            this.inputValue !== i.value && (e(i).removeData("autocompleted"),
            e(i).trigger("autocomplete:autocompleted:changed")),
            this.fetchResults(i.value)
        }
        ,
        i.prototype.fetchResults = function(t) {
            var i = void 0
              , n = void 0
              , o = void 0
              , r = this.focusedResults.getAttribute("data-search-url");
            return r ? (i = e(this.focusedInput).closest(".js-autocomplete-container"),
            o = t.trim() ? (r += ~r.indexOf("?") ? "&" : "?",
            r += "q=" + encodeURIComponent(t),
            i.addClass("is-sending"),
            f(r)) : e(this.focusedResults).find("[data-autocomplete-value]").length > 0 ? this.hideResults() : Promise.resolve(""),
            n = function() {
            ...
            this.fetchQueue.push(o).then(function(i) {
                return function(n) {
                    return e(i.focusedResults).find(".js-autocomplete-results").html(n),
                    i.onResultsChange(t)
                }
        ...
        i.prototype.onResultsChange = function(t) {
            var i = void 0;
            if (i = e(this.focusedResults).find("[data-autocomplete-value]"),
            0 === i.length)
                this.hideResults();
            else if (this.inputValue !== t && (this.inputValue = t,
            this.showResults(),
            e(this.focusedInput).is("[data-autocomplete-autofocus]"))) {
        ...
        i.prototype.onNavigationOpen = function(t) {
            var i = void 0
              , n = void 0;
            i = t.currentTarget,
            i.classList.contains("disabled") || (n = e(i).attr("data-autocomplete-value"),
            this.inputValue = n,
            e(this.focusedInput).val(n),
            e(this.focusedInput).data("autocompleted", n),
            e(this.focusedInput).trigger("autocomplete:autocompleted:changed", [n]),
            e(this.focusedInput).trigger("autocomplete:result", [n]),
        ...
        i.prototype.showResults = function(i, n) {
            var o = void 0
              ...
              , s = void 0
              , a = void 0;
            if (null == i && (i = this.focusedInput),
            null == n && (n = this.focusedResults),
            !t(n)) {
                r = e(i).offset(),
                s = r.top,
                o = s + e(i).innerHeight(),
                ...
                e(i).addClass("js-navigation-enable");
    ...
    h = new l,
    e(document.activeElement).is(".js-autocomplete-field") && h.onInputFocus(document.activeElement),
    n(".js-autocomplete-field", function() {
...
function() {
        ...
        return regeneratorRuntime.async(function(u) {
            for (; ; )
                ...
                case 0:
                    ...
                    u.prev = 2,
                    i = t(e).serialize(),
                    o = (e.action + "&" + i).replace(/[?&]/, "?"),
                    u.next = 7,
                    regeneratorRuntime.awrap(d.push(n(o)));
                case 7:
                    return s = u.sent,
                    a = document.getElementById(e.getAttribute("data-results-container")),
                    a.innerHTML = s,
                    u.abrupt("return", r(null , "", "?" + i));
                case 11:
                    return u.prev = 11,
    ...
    var t = require("github/jquery")["default"]
      ...
      , n = i.fetchText
      , o = require("github/history")
      , r = o.replaceState
      , s = require("github/sliding-promise-queue")["default"]
      , a = require("github/focused")["default"]
      , u = require("github/throttled-input")
      , c = u.addThrottledInputEventListener
      , l = u.removeThrottledInputEventListener
      , d = new s;
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , u = void 0
      , c = void 0;
    s = require("github/pjax"),
    a = require("github/history").replaceState,
    c = null ,
    u = function() {
        var t = void 0
          , i = void 0
          ...
          , l = void 0;
        return c && c.abort(),
        u = e(this).attr("data-item-name") || "items",
        l = parseInt(e(this).attr("data-item-minimum")) || 0,
        o = parseInt(e(this).attr("data-item-count")) || 0,
        r = Math.max(l, parseInt(this.value) || 0),
        t = r > 300,
        e(".js-purchase-button").prop("disabled", 0 === r || t),
        e(".js-downgrade-button").prop("disabled", r === o),
        i = {},
        i[u] = r,
        c = e.ajax({
        ...
        n = function(i) {
            var n = void 0
              , o = void 0
              , u = void 0;
            e(".js-contact-us").toggleClass("d-none", !t),
            e(".js-payment-summary").toggleClass("d-none", t),
            e(".js-billing-section").toggleClass("has-removed-contents", i.free),
            e(".js-upgrade-info").toggleClass("d-none", 0 >= r),
            e(".js-downgrade-info").toggleClass("d-none", r >= 0),
            e(".js-extra-seats-line-item").toggleClass("d-none", i.no_additional_seats),
            n = i.selectors;
            for (o in n)
                u = n[o],
                e(o).text(u);
...
function() {
    ...
    i(".js-card-select-number-field", function() {
        ...
        t = i.find(".js-card"),
        n = i.find(".js-card-select-type-field"),
        e(this).on("input", function() {
            var i = void 0
              ...
              , a = void 0;
            if (a = e(this).val(),
            s = e.payment.cardType(a))
                for (o = 0,
                r = t.length; r > o; o++)
                    i = t[o],
                    e(i).toggleClass("enabled", e(i).attr("data-name") === s),
                    e(i).toggleClass("disabled", e(i).attr("data-name") !== s);
            else
                t.removeClass("enabled disabled");
            n.val(s)
        })
    }),
    ...
    e(document).on("click", ".js-card", function() {
        ...
        i = t.find(".js-card-select-number-field"),
        i.focus()
    }),
    e(document).on("click", ".js-enter-new-card", function(t) {
        var i = void 0
          , n = void 0;
        i = e(this).closest(".js-setup-creditcard"),
        n = i.find(".js-card-select-number-field"),
        i.removeClass("has-credit-card"),
        n.attr("required", "required"),
        n.attr("data-encrypted-name", "billing[credit_card][number]"),
        t.preventDefault()
    }),
    e(document).on("click", ".js-cancel-enter-new-card", function(t) {
        ...
        i = e(this).closest(".js-setup-creditcard"),
        n = i.find(".js-card-select-number-field"),
        i.addClass("has-credit-card"),
        n.removeAttr("required"),
        n.removeAttr("data-encrypted-name"),
        t.preventDefault()
    }),
    n = function(t) {
        var i = void 0
        ...
        a = s[n],
        e(".js-setup-creditcard").toggleClass("is-vat-country", null != a),
        u = null != a ? "(" + a + ")" : "",
        i = t.parents(".js-setup-creditcard").find(".js-vat-help-text"),
        i.html(u),
        "United States of America" !== n ? (e(".js-setup-creditcard").addClass("is-international"),
        e(".js-select-state").removeAttr("required").val("")) : (e(".js-setup-creditcard").removeClass("is-international"),
        e(".js-select-state").attr("required", "required")),
        o.call(r, n) >= 0 ? (e(".js-setup-creditcard").addClass("no-postcodes"),
        e(".js-postal-code-field").removeAttr("required").val("")) : (e(".js-setup-creditcard").removeClass("no-postcodes"),
        e(".js-postal-code-field").attr("required", "required"))
    }
    ,
...
function() {
    ...
    e(document).on("change", ".js-payment-methods .js-payment-method", function() {
        ...
        i = e(this).attr("data-selected-tab"),
    ...
    e(document).on("click", ".js-toggle-change-payment-method", function() {
        ...
        e.querySelector(".js-current-payment-method").classList.toggle("d-none")
    })
}(),
define("github/accessibility", ["exports", "./inspect"], function(e, t) {
    ...
    function o(e) {
        ...
        this.element = e,
        this.message = "Missing alt attribute on " + f["default"](e)
    }
    function r(e) {
        this.name = "LinkWithoutLabelError",
        this.stack = (new Error).stack,
        this.element = e,
        this.message = "Missing text, title, or aria-label attribute on " + f["default"](e)
    }
    function s(e) {
        this.name = "LinkWithoutLabelOrRoleError",
        this.stack = (new Error).stack,
        this.element = e,
        this.message = "Missing href or role=button on " + f["default"](e)
    }
    function a(e) {
        this.name = "LabelMissingControl",
        this.stack = (new Error).stack,
        this.element = e,
        this.message = "Label missing control on " + f["default"](e)
    }
    function u(e) {
        this.name = "ButtonWithoutLabelError",
        this.stack = (new Error).stack,
        this.element = e,
        this.message = "Missing text or aria-label attribute on " + f["default"](e)
    }
    function c(e) {
    ...
    function d(e) {
        ...
        case Node.ELEMENT_NODE:
            if (l(e.getAttribute("alt")) || l(e.getAttribute("aria-label")))
                return !0;
    ...
    function r(e) {
        ...
        return regeneratorRuntime.async(function(y) {
            for (; ; )
                ...
                case 0:
                    return t = e.target,
                    i = Array.from(t.querySelectorAll(".js-bulk-actions-toggle:checked")),
                    o = i.map(function(e) {
                        return e.closest(".js-bulk-actions-item").getAttribute("data-bulk-actions-id")
                    }).sort(),
                    r = t.getAttribute("data-bulk-actions-url"),
                    s = t.getAttribute("data-bulk-actions-parameter"),
                    a = o.map(function(e) {
                        return s + "[]=" + e
                    }).join("&"),
                    c = r + "?" + a,
                    y.prev = 7,
                    y.next = 10,
                    regeneratorRuntime.awrap(u.push(n.fetchText(c)));
                case 10:
                    l = y.sent,
                    d = t.querySelector(".js-bulk-actions"),
                    d.innerHTML = l;
                case 13:
                    for (y.prev = 13,
                    h = o.length > 0,
                    f = t.querySelectorAll(".js-bulk-actions-show-on-selected"),
                    v = 0; v < f.length; v++)
                        m = f[v],
                        m.classList.toggle("d-none", !h);
                    for (p = t.querySelectorAll(".js-bulk-actions-hide-on-selected"),
                    g = 0; g < p.length; g++)
                        b = p[g],
                        b.classList.toggle("d-none", h);
                    return y.finish(13);
                case 20:
                case "end":
                    return y.stop()
...
define("github/details", ["./hash-change", "delegated-events", "./once", "./perform-transition", "./setimmediate"], function(e, t, i, n, o) {
    ...
    function a(e) {
        e.classList.contains("tooltipped") && (e.classList.remove("tooltipped"),
        l["default"](e, "mouseleave").then(function() {
    ...
    t.on("click", ".js-details-target", function(e) {
        var t = this
          , i = t.getAttribute("data-details-container") || ".js-details-container"
          , n = t.closest(i);
    ...
    c["default"](function(e) {
        for (var t = e.target; (t = t.parentNode) && t !== document.documentElement; )
            t.matches(".js-details-container") && t.classList.add("open")
    })
}),
...
define("github/sticky-scroll-into-view", ["exports", "./fragment-target"], function(e, t) {
    ...
    e.scrollToFragmentTarget = o,
    e.computeFixedYOffset = r
}),
...
define("github/git-clone-help", ["delegated-events"], function(e) {
    e.on("click", ".js-git-clone-help-container .js-git-clone-help-switcher", function() {
        ...
        if (e.querySelector(".js-git-clone-help-field").value = t,
        this.matches(".js-git-protocol-clone-url"))
            for (var i = e.querySelectorAll(".js-git-clone-help-text"), n = 0; n < i.length; n++) {
                var o = i[n];
                o.textContent = t
            }
...
define("github/google-analytics-overrides", ["exports", "./google-analytics"], function(e, t) {
    ...
    function o() {
        var e = i("meta[name=analytics-location-query-strip]")
          , t = "";
    ...
    function s() {
        var e = document.title
          , t = i("meta[name=analytics-location]");
...
define("github/google-analytics-tracking", ["./google-analytics-overrides", "./google-analytics", "./observe", "./document-ready"], function(e, t, i, n) {
    ...
    o && (t.setGlobalAccount(o.content, "github.com"),
    ...
    i.observe("[data-ga-load]", function() {
...
define("github/homepage/play-video", ["delegated-events"], function(e) {
    function t(e, t) {
        ...
        var i = e.getBoundingClientRect()
          , n = i.top - t
          , o = i.bottom - window.innerHeight + t;
        0 > n ? window.scrollBy(0, n) : o > 0 && window.scrollBy(0, o)
    }
    e.on("click", ".js-video-play, .js-video-close, .is-expanded", function(e) {
        e.preventDefault();
        var i = this
          , n = i.classList.contains("js-video-play")
          , o = i.closest(".js-video-container")
          , r = o.querySelector(".js-video-iframe")
          , s = document.querySelector(".js-video-bg");
        n ? r.src = r.getAttribute("data-src") : r.removeAttribute("src"),
...
define("github/menu", ["exports", "./jquery", "./fire", "delegated-events", "./hotkey", "./observe", "./perform-transition"], function(e, t, i, n, o, r, s) {
    ...
    function u(e) {
        p && c(p),
        n.fire(e, "menu:activate") && (h["default"](document).on("keydown.menu", d),
        h["default"](document).on("click.menu", l),
        p = e,
        m["default"](e, function() {
        ...
        f["default"](e, "menu:activated", {
            async: !0
        }))
    }
    function c(e) {
        e && n.fire(e, "menu:deactivate") && (h["default"](document).off(".menu"),
        p = null ,
        m["default"](e, function() {
        ...
        f["default"](e, "menu:deactivated", {
            async: !0
        }))
    }
    function l(e) {
        p && (h["default"](e.target).closest(p)[0] || (e.preventDefault(),
        c(p)))
    }
    function d(e) {
        if (p && "esc" === v["default"](e.originalEvent)) {
            var t = h["default"](document.activeElement).parents().get();
            t.indexOf(p) >= 0 && document.activeElement.blur(),
            e.preventDefault(),
            c(p)
        }
    }
    ...
    h["default"](document).on("click", ".js-menu-container", function(e) {
        var t = this
          , i = h["default"](e.target).closest(".js-menu-target")[0];
        i ? (e.preventDefault(),
        t === p ? c(t) : u(t)) : h["default"](e.target).closest(".js-menu-content")[0] || t === p && (e.preventDefault(),
        c(t))
    }),
    h["default"](document).on("click", ".js-menu-container .js-menu-close", function(e) {
        c(this.closest(".js-menu-container")),
        e.preventDefault()
    }),
...
function(e) {
    ...
    function i(e, t, i) {
        if (e) {
            ...
            do
                if (">*" === n && e.parentNode === i || ("" === n || e.nodeName.toUpperCase() == n) && (!t.length || ((" " + e.className + " ").match(o) || []).length == t.length))
                    return e;
    ...
    function a(e, t, i) {
        ...
        if (n) {
            if (void 0 === i)
                return R.defaultView && R.defaultView.getComputedStyle ? i = R.defaultView.getComputedStyle(e, "") : e.currentStyle && (i = e.currentStyle),
                void 0 === t ? i : i[t];
            t in n || (t = "-webkit-" + t),
    ...
    function c(e, t, i, n, o, r, s) {
        var a = R.createEvent("Event")
          , u = (e || t[N]).options
          , c = "on" + i.charAt(0).toUpperCase() + i.substr(1);
        a.initEvent(i, !0, !0),
        a.to = t,
        a.from = o || t,
        a.item = n || t,
    ...
    []), Y = p(function(e, t, i) {
        if (i && t.scroll) {
            ...
            k === !0)) {
                k = i;
                do
                    if (k.offsetWidth < k.scrollWidth || k.offsetHeight < k.scrollHeight)
                        break;
                while (k = k.parentNode)
            }
            k && (n = k,
            o = k.getBoundingClientRect(),
            r = (U(o.right - c) <= a) - (U(o.left - c) <= a),
            s = (U(o.bottom - l) <= a) - (U(o.top - l) <= a)),
            r || s || (r = (a >= d - c) - (a >= c),
            s = (a >= h - l) - (a >= l),
            (r || s) && (n = O)),
            (I.vx !== r || I.vy !== s || I.el !== n) && (I.el = n,
            I.vx = r,
            I.vy = s,
            clearInterval(I.pid),
            n && (I.pid = setInterval(function() {
                n === O ? O.scrollTo(O.pageXOffset + r * u, O.pageYOffset + s * u) : (s && (n.scrollTop += s * u),
                r && (n.scrollLeft += r * u))
            }, 24)))
        }
    }, 30), V = function(e) {
    ...
    return e.prototype = {
        ...
        _onTapStart: function(e) {
            ...
            if (!("mousedown" === r && 0 !== e.button || o.disabled) && (a = i(a, o.draggable, n))) {
                if (E = m(a),
                "function" == typeof l) {
                    if (l.call(this, e, a, this))
                        return c(t, u, "filter", a, n, E),
                        void e.preventDefault()
                } else if (l && (l = l.split(",").some(function(e) {
                    return e = i(u, e.trim(), n),
                    e ? (c(t, e, "filter", a, n, E),
                    !0) : void 0
                })))
        ...
        _prepareDragStart: function(e, t, i) {
            ...
            n = function() {
                ...
                b.draggable = !0,
                s(b, r.options.chosenClass, !0),
                r._triggerDragStart(t)
            }
            ,
            c.ignore.split(",").forEach(function(e) {
                u(b, e.trim(), d)
            }),
            o(l, "mouseup", r._onDrop),
            o(l, "touchend", r._onDrop),
            o(l, "touchcancel", r._onDrop),
            c.delay ? (o(l, "mouseup", r._disableDelayedDrag),
            o(l, "touchend", r._disableDelayedDrag),
            o(l, "touchcancel", r._disableDelayedDrag),
            o(l, "mousemove", r._disableDelayedDrag),
            o(l, "touchmove", r._disableDelayedDrag),
            r._dragStartTimer = setTimeout(n, c.delay)) : n())
        },
        _disableDelayedDrag: function() {
            var e = this.el.ownerDocument;
            clearTimeout(this._dragStartTimer),
            r(e, "mouseup", this._disableDelayedDrag),
            r(e, "touchend", this._disableDelayedDrag),
            r(e, "touchcancel", this._disableDelayedDrag),
            r(e, "mousemove", this._disableDelayedDrag),
            r(e, "touchmove", this._disableDelayedDrag)
        },
        _triggerDragStart: function(e) {
            ...
            this._onDragStart(M, "touch")) : this.nativeDraggable ? (o(b, "dragend", this),
            o(x, "dragstart", this._onDragStart)) : this._onDragStart(M, !0);
            try {
                R.selection ? R.selection.empty() : window.getSelection().removeAllRanges()
            } catch (t) {}
        },
        _dragStarted: function() {
            x && b && (s(b, this.options.ghostClass, !0),
            e.active = this,
            c(this, x, "start", b, x, E))
        },
        _emulateDragOver: function() {
            if (D) {
                if (this._lastX === D.clientX && this._lastY === D.clientY)
                    return;
                this._lastX = D.clientX,
                this._lastY = D.clientY,
                B || a(j, "display", "none");
                var e = R.elementFromPoint(D.clientX, D.clientY)
                  , t = e
                ...
                if (t)
                    do {
                        ...
                        e = t
                    } while (t = t.parentNode);B || a(j, "display", "")
            }
        },
        _onTouchMove: function(t) {
            if (M) {
                ...
                var i = t.touches ? t.touches[0] : t
                  , n = i.clientX - M.clientX
                  , o = i.clientY - M.clientY
                  , r = t.touches ? "translate3d(" + n + "px," + o + "px,0)" : "translate(" + n + "px," + o + "px)";
                P = !0,
                D = i,
                a(j, "webkitTransform", r),
                a(j, "mozTransform", r),
                a(j, "msTransform", r),
                a(j, "transform", r),
                t.preventDefault()
        ...
        _appendGhost: function() {
            if (!j) {
                ...
                a(j, "top", t.top - z(i.marginTop, 10)),
                a(j, "left", t.left - z(i.marginLeft, 10)),
                a(j, "width", t.width),
                a(j, "height", t.height),
                a(j, "opacity", "0.8"),
                a(j, "position", "fixed"),
                ...
                n.fallbackOnBody && R.body.appendChild(j) || x.appendChild(j),
        ...
        _onDragStart: function(e, t) {
            var i = e.dataTransfer
              , n = this.options;
            this._offUpEvents(),
            "clone" == _.pull && (w = b.cloneNode(!0),
            a(w, "display", "none"),
            x.insertBefore(w, b)),
            t ? ("touch" === t ? (o(R, "touchmove", this._onTouchMove),
            o(R, "touchend", this._onDrop),
            o(R, "touchcancel", this._onDrop)) : (o(R, "mousemove", this._onTouchMove),
            o(R, "mouseup", this._onDrop)),
            this._loopId = setInterval(this._emulateDragOver, 50)) : (i && (i.effectAllowed = "move",
            n.setData && n.setData.call(this, i, b)),
            o(R, "drop", this),
            setTimeout(this._dragStarted, 0))
        },
        _onDragOver: function(e) {
            var n, o, r, s = this.el, u = this.options, c = u.group, d = c.put, v = _ === c, m = u.sort;
            if (void 0 !== e.preventDefault && (e.preventDefault(),
            !u.dragoverBubble && e.stopPropagation()),
            P = !0,
            _ && !u.disabled && (v ? m || (r = !x.contains(b)) : _.pull && d && (_.name === c.name || d.indexOf && ~d.indexOf(_.name))) && (void 0 === e.rootEl || e.rootEl === this.el)) {
                if (Y(e, u, this.el),
                $)
                    return;
                if (n = i(e.target, u.draggable, s),
                o = b.getBoundingClientRect(),
                r)
                    return t(!0),
                    void (w || q ? x.insertBefore(b, w || q) : m || x.appendChild(b));
                if (0 === s.children.length || s.children[0] === j || s === e.target && (n = f(s, e))) {
                    ...
                    t(v),
                    l(x, s, b, o, n, g) !== !1 && (b.contains(s) || (s.appendChild(b),
                    y = s),
                    this._animate(o, b),
                    n && this._animate(g, n))
                    ...
                    if (H !== !1) {
                        ...
                        1 === H || -1 === H)
                            ...
                            p = I !== b && !M || D && M;
                        b.contains(s) || (p && !I ? s.appendChild(b) : n.parentNode.insertBefore(b, p ? I : n)),
                        y = b.parentNode,
                        this._animate(o, b),
                        this._animate(g, n)
                    }
        ...
        _animate: function(e, t) {
            ...
            if (i) {
                ...
                a(t, "transition", "none"),
                a(t, "transform", "translate3d(" + (e.left - n.left) + "px," + (e.top - n.top) + "px,0)"),
                t.offsetWidth,
                a(t, "transition", "all " + i + "ms"),
        ...
        _offUpEvents: function() {
            var e = this.el.ownerDocument;
            r(R, "touchmove", this._onTouchMove),
            r(e, "mouseup", this._onDrop),
            r(e, "touchend", this._onDrop),
            r(e, "touchcancel", this._onDrop)
        },
        _onDrop: function(t) {
            var i = this.el
              , n = this.options;
            ...
            clearInterval(I.pid),
            clearTimeout(this._dragStartTimer),
            r(R, "mousemove", this._onTouchMove),
            this.nativeDraggable && (r(R, "drop", this),
            r(i, "dragstart", this._onDragStart)),
            this._offUpEvents(),
            t && (P && (t.preventDefault(),
            !n.dropBubble && t.stopPropagation()),
            j && j.parentNode.removeChild(j),
            b && (this.nativeDraggable && r(b, "dragend", this),
            d(b),
            s(b, this.options.ghostClass, !1),
            s(b, this.options.chosenClass, !1),
            x !== y ? (T = m(b),
            T >= 0 && (c(null , y, "sort", b, x, E, T),
            c(this, x, "sort", b, x, E, T),
            c(null , y, "add", b, x, E, T),
            c(this, x, "remove", b, x, E, T))) : (w && w.parentNode.removeChild(w),
            b.nextSibling !== q && (T = m(b),
            T >= 0 && (c(this, x, "update", b, x, E, T),
            c(this, x, "sort", b, x, E, T)))),
            e.active && ((null === T || -1 === T) && (T = E),
            c(this, x, "end", b, x, E, T),
            this.save())),
            x = b = y = j = q = w = k = S = M = D = P = T = L = C = _ = e.active = null )
        },
        handleEvent: function(e) {
            var t = e.type;
            "dragover" === t || "dragenter" === t ? b && (this._onDragOver(e),
            n(e)) : ("drop" === t || "dragend" === t) && this._onDrop(e)
        },
        toArray: function() {
            for (var e, t = [], n = this.el.children, o = 0, r = n.length, s = this.options; r > o; o++)
                e = n[o],
                i(e, s.draggable, this.el) && t.push(e.getAttribute(s.dataIdAttr) || v(e));
            return t
        },
        sort: function(e) {
            var t = {}
        ...
        destroy: function() {
            ...
            this.nativeDraggable && (r(e, "dragover", this),
            r(e, "dragenter", this)),
...
define("github/not-scrolling", ["exports", "./normalized-event-timestamp", "./debounce", "./setimmediate"], function(e, t, i, n) {
    ...
    function r(e) {
        return new Promise(function(i) {
            if (e === window && t.timeSinceTimestamp(u) > 500)
                return void a["default"](i);
...
define("github/preserve-position", ["exports", "./jquery", "./cumulative-scrollby", "./not-scrolling"], function(e, t, i, n) {
    ...
    function c(e) {
        for (var t = 0, i = e.length; i > t; t++) {
            var n = e[t];
            if (l["default"].contains(document, n.element))
                return n
        }
    }
    Object.defineProperty(e, "__esModule", {
...
define("github/milestone-dragging", ["./jquery", "sortablejs", "./debounce", "./fetch", "./has-interactions", "./hotkey", "./navigation", "./observe", "./preserve-position", "./google-analytics"], function(e, t, i, n, o, r, s, a, u, c) {
    ...
    function d(e) {
        ...
        return regeneratorRuntime.async(function(r) {
            for (; ; )
                ...
                case 2:
                    return t = e.getAttribute("data-url"),
                    r.next = 5,
                    regeneratorRuntime.awrap(n.fetchSafeDocumentFragment(document, t));
                case 5:
                    i = r.sent,
                    u.preserveInteractivePosition(function() {
                        e.replaceWith(i)
                    });
                case 7:
                case "end":
    ...
    var w = b["default"](function(e) {
        var t = e.newIndex
          , i = e.item
          , n = i.closest(".js-draggable-issues-container")
          , o = i.getAttribute("data-id")
          , r = h(n, t - 1)
          , s = r && r.getAttribute("data-id")
          , a = n.closest(".js-milestone-sort-form");
        a.querySelector(".js-item-id").value = o,
        a.querySelector(".js-prev-id").value = s || "",
        c.trackEvent({
            category: "Milestone",
            action: "reorder",
            label: e.trackingLabel || "drag-and-drop"
        }),
        n.setAttribute("data-is-sorting", "1"),
        p["default"](a).submit()
    }, 200);
        ...
        if (e.target) {
            ...
            if (t) {
                ...
                if ("J" === y["default"](e.originalEvent)) {
                    ...
                    n && (t.parentNode.insertBefore(t, n.nextElementSibling),
                    f(i, t),
                    e.preventDefault(),
                    e.stopPropagation())
                } else
                    "K" === y["default"](e.originalEvent) && (t.parentNode.insertBefore(t, t.previousElementSibling),
                    f(i, t),
                    e.preventDefault(),
                    e.stopPropagation())
            }
    ...
    a.observe(".js-draggable-issues-container", {
        add: v,
        remove: m
    }),
    a.observe(".js-backfill-status", function() {
        var e = this;
        setTimeout(function() {
...
define("github/pjax/capture-keypresses", ["delegated-events", "../capture-keypresses"], function(e, t) {
    ...
    e.on("pjax:end", "#js-repo-pjax-container", function() {
        if (o) {
            var t = o()
              , i = document.querySelector(".js-pjax-restore-captured-input");
            i && t && (i.value = t,
            e.fire(i, "change")),
            o = null
        }
...
define("github/pjax/history-navigate", ["../history", "delegated-events"], function(e, t) {
    t.on("pjax:click", ".js-pjax-history-navigate", function(t) {
        this.href === e.getBackURL() ? (history.back(),
        t.detail.relatedEvent.preventDefault(),
        t.preventDefault()) : this.href === e.getForwardURL() && (history.forward(),
        t.detail.relatedEvent.preventDefault(),
        t.preventDefault())
    })
}),
    ...
    function r(e, t, i) {
        ...
        return regeneratorRuntime.async(function(c) {
            for (; ; )
                ...
                case 6:
                    return e.style.transform = "translateZ(0) translate(" + s + "px, " + u + "px)",
                ...
                case 10:
                    ...
                    e.style.transition = "",
                    c.abrupt("return", a["default"](e, "transitionend"));
                case 13:
                case "end":
                    return c.stop()
                }
...
define("github/project-updater", ["exports", "./magic-move", "./debounce", "./fetch"], function(e, t, i, n) {
    ...
    function r(e) {
        e && (h && clearTimeout(h),
        document.querySelector(".js-project-updated-message").textContent = e,
    ...
    function c(e, t) {
        var i = Array.from(e.querySelectorAll(".js-project-column"))
          , n = i.map(function(e) {
        ...
        return regeneratorRuntime.async(function(I) {
            for (; ; )
                ...
                case 0:
                    ...
                    l = e.querySelectorAll(".js-project-column"),
                    d = t.recordPositions(l),
                    h = e.getAttribute("data-url"),
                    f = e.getAttribute("data-columns-url"),
                    v = e.getAttribute("data-cards-url"),
                    I.t0 = i.state,
                    I.t0) {
                        I.next = 11;
                        break
                    ...
                    return I.next = 10,
                    regeneratorRuntime.awrap(n.fetchJSON(h));
                case 10:
                    I.t0 = I.sent;
                case 11:
                    if (m = I.t0,
                    ...
                    y = 0; y < b.length; y++)
                        j = b[y],
                        w = a(j, f),
                        x = w.querySelector(".js-project-column-cards"),
                        p[x.id] = x.scrollTop,
                        g.appendChild(w);
                    s(e),
                    e.appendChild(g);
                    for (q in p)
                        ...
                        x.scrollTop = p[q];
                    return I.next = 22,
                    regeneratorRuntime.awrap(t.animate(l, d));
                case 22:
                    k = e.querySelectorAll(".js-project-column-card"),
                    S = t.recordPositions(k),
                    L = m.columns,
                    C = 0;
                case 26:
                    if (!(C < L.length)) {
                    ...
                    if (A = L[C],
                    E = document.getElementById("project-column-" + A.id)) {
                        I.next = 31;
                        break
                    }
                    return I.abrupt("return");
                case 31:
                    for (E.querySelector(".js-project-column-name").textContent = A.name,
                    E.querySelector(".js-column-card-count").textContent = A.card_ids.length,
                    T = document.createDocumentFragment(),
                    _ = A.card_ids,
                    M = 0; M < _.length; M++)
                        D = _[M],
                        T.appendChild(u(D, v));
                    P = E.querySelector(".js-project-column-cards"),
                    s(P),
                    P.appendChild(T);
                case 39:
                    C++,
                ...
                case 42:
                    return I.next = 44,
                    regeneratorRuntime.awrap(t.animate(k, S));
                case 44:
                    r(i.message),
...
define("github/projects", ["delegated-events", "./jquery", "sortablejs", "./menu", "./hash-change", "./hotkey", "./observe", "./project-updater"], function(e, t, i, n, o, r, s, a) {
    ...
    function c(e, t) {
        if (!t)
            return e.elements.namedItem("card_id").value = "",
            e.elements.namedItem("content_id").value = "",
            void (e.elements.namedItem("content_type").value = "");
        var i = t.getAttribute("data-card-id");
        i ? e.elements.namedItem("card_id").value = i : (e.elements.namedItem("content_id").value = t.getAttribute("data-content-id"),
        e.elements.namedItem("content_type").value = t.getAttribute("data-content-type"))
    }
    function l(t, i) {
        var n = document.querySelector(".js-create-project-column");
        c(n, i),
        e.fire(t, "click"),
        t.querySelector(".js-project-column-card").remove()
    }
    function d(e) {
        var t = e.item
          , i = t.closest(".js-new-project-column");
        if (i)
            return l(i, t);
        ...
        if (n) {
            ...
            r ? o.elements.namedItem("previous_card_id").value = r.getAttribute("data-card-id") : o.elements.namedItem("previous_card_id").value = "",
            v["default"](o).submit()
        }
    }
    function h(e) {
        var t = e.item
          , i = document.querySelector(".js-reorder-columns-form");
        i.elements.namedItem("column_id").value = t.getAttribute("data-id");
        var n = t.previousElementSibling;
        n ? i.elements.namedItem("previous_column_id").value = n.getAttribute("data-id") : i.elements.namedItem("previous_column_id").value,
        v["default"](i).submit()
    }
    function f(e) {
    ...
    var v = u(t)
      ...
      , p = u(o)
      , g = u(r);
    v["default"](document).on("ajaxSuccess", ".js-project-update-card", function(e, t, i, n) {
        var o = v["default"].parseHTML(n)[0]
          , r = o.getAttribute("data-card-id")
          , s = void 0;
        if (r && (s = document.querySelector('[data-card-id="' + r + '"]')),
        !s) {
            var a = o.getAttribute("data-content-type")
              , u = o.getAttribute("data-content-id");
    ...
    v["default"](document).on("ajaxSuccess", ".js-create-project-column", function(t, i, n, o) {
        var r = v["default"].parseHTML(o)[0]
          , s = r.classList.contains("js-column-form-container");
        if (s)
            this.closest(".js-column-form-container").replaceWith(r);
        else {
            var a = document.querySelector(".js-project-columns-container");
            a.insertAdjacentHTML("beforeend", o),
            Array.from(document.querySelectorAll(".js-create-project-column")).forEach(function(e) {
                c(e, null )
            }),
    ...
    v["default"](document).on("ajaxSuccess", ".js-update-project-column", function(t, i, n, o) {
        ...
        if (s)
            ...
            document.querySelector('.js-project-column[data-id="' + a + '"]').replaceWith(r),
            e.fire(document, "facebox:close")
        }
    }),
    v["default"](document).on("ajaxSuccess", ".js-delete-project-column", function() {
        var t = this.getAttribute("data-column-id");
        document.querySelector('.js-project-column[data-id="' + t + '"]').remove(),
        e.fire(document, "facebox:close")
    }),
    ...
    v["default"](document).on("ajaxSuccess", ".js-note-form", function(t, i, n, o) {
        var r = v["default"].parseHTML(o)[0]
          , s = r.classList.contains("js-note-form-container");
        if (s)
            this.closest(".js-note-form-container").replaceWith(r);
        else {
            var a = this.getAttribute("data-card-id");
            document.getElementById("card-" + a).replaceWith(r),
            e.fire(document, "facebox:close")
        }
    }),
    ...
    s.observe(".js-project-column-card", function() {
        if (this.getAttribute("data-card-id")) {
            var e = this.getAttribute("data-content-type")
              ...
              , i = document.getElementById("card-" + e + "-" + t);
            i && i.remove()
        }
    }),
...
define("github/pulls/change-base", ["../jquery", "../menu", "../facebox"], function(e, t, i) {
    ...
    o["default"](document).on("selectmenu:select", ".js-pull-base-branch-item", function(e) {
        ...
        t.deactivate(i),
        e.preventDefault(),
        i.querySelector(".js-pull-change-base-branch-field").value = this.getAttribute("data-branch"),
        r["default"](i.querySelector(".js-change-base-facebox").innerHTML)
    })
}),
define("github/pulls/reviews", ["../jquery", "../menu", "../hash-change", "../once", "../inflector"], function(e, t, i, n, o) {
    ...
    function s(e, t) {
        var i = e.closest(".js-review-state-classes")
          , n = i.querySelectorAll(".js-pending-review-comment").length;
        t && (n += t),
        i.classList.toggle("is-review-pending", n > 0);
        ...
        n > 0 && !function() {
            ...
            l["default"](t, "animationend").then(function() {
...
define("github/select-menu/base", ["../jquery", "../menu", "delegated-events"], function(e, t, i) {
    ...
    r["default"](document).on("navigation:open", ".js-select-menu:not([data-multiple]) .js-navigation-item", function() {
        ...
        if (!e) {
            ...
            r["default"](s).find(".js-navigation-item.selected").removeClass("selected"),
            n.addClass("selected"),
            n.removeClass("indeterminate"),
            n.find("input[type=radio], input[type=checkbox]").prop("checked", !0).change(),
            i.fire(this, "selectmenu:selected"),
            r["default"](s).hasClass("is-loading") || t.deactivate(s)
        }
    }),
    r["default"](document).on("navigation:open", ".js-select-menu[data-multiple] .js-navigation-item", function() {
        ...
        if (!e) {
            ...
            t.toggleClass("selected", !n),
            t.removeClass("indeterminate"),
            t.find("input[type=radio], input[type=checkbox]").prop("checked", !n).change(),
            i.fire(this, "selectmenu:selected")
        }
    })
}),
define("github/select-menu/button", ["../jquery"], function(e) {
    ...
    i["default"](document).on("selectmenu:selected", ".js-select-menu .js-navigation-item", function() {
        var e = this.closest(".js-select-menu")
          , t = i["default"](this).find(".js-select-button-text");
...
define("github/select-menu/css", ["../jquery", "../visible"], function(e, t) {
    ...
    n["default"](document).on("selectmenu:change", ".js-select-menu .select-menu-list", function(e) {
        ...
        if (t.removeClass("last-visible"),
        n["default"](Array.from(t).filter(o["default"])).last().addClass("last-visible"),
        !this.hasAttribute("data-filterable-for")) {
...
define("github/select-menu/filterable", ["../jquery", "delegated-events"], function(e, t) {
    ...
    n["default"](document).on("menu:deactivate", ".js-select-menu", function() {
        ...
        for (var i = this.querySelectorAll(".js-navigation-item.selected"), n = 0; n < i.length; n++) {
            var o = i[n]
              , r = o.querySelector("input[type=radio], input[type=checkbox]");
...
define("github/select-menu/navigation", ["../navigation", "../jquery"], function(e, t) {
    ...
    n["default"](document).on("filterable:change selectmenu:tabchange", ".js-select-menu .select-menu-list", function() {
        var t = this.closest(".js-select-menu")
          , i = t.querySelector(".js-navigation-container");
        i && e.refocus(i, this)
    })
}),
define("github/select-menu/new", ["../jquery", "delegated-events"], function(e, t) {
    ...
    function n(e, t) {
        for (var i = e.querySelectorAll(".js-select-button-text, .js-select-menu-filter-text"), n = 0, o = i.length; o > n; n++) {
            var r = i[n]
              , s = r.textContent.toLowerCase().trim();
            if (s === t.toLowerCase())
                return !0
        }
        return !1
    ...
    o["default"](document).on("filterable:change", ".js-select-menu .select-menu-list", function(e) {
        ...
        if (i) {
            ...
            if ("" === r || n(this, r))
                o["default"](this).removeClass("is-showing-new-item-form");
            else {
...
define("github/select-menu/tabs", ["../jquery", "delegated-events", "../observe"], function(e, t, i) {
    ...
    function o(e, i) {
        for (var n = e.getAttribute("data-tab-filter"), o = e.closest(".js-select-menu"), r = o.querySelectorAll(".js-select-menu-tab-bucket"), s = 0; s < r.length; s++) {
            var a = r[s];
            a.getAttribute("data-tab-filter") === n && (a.classList.toggle("selected", i),
            i && t.fire(a, "selectmenu:tabchange"))
        }
    }
    var r = n(e);
    ...
    r["default"](document).on("click", ".js-select-menu .js-select-menu-tab", function() {
        ...
        if (i) {
            ...
            n && i.setAttribute("placeholder", n),
            i.focus()
        }
        return !1
    }),
...
define("github/sticky", ["./observe"], function(e) {
    ...
    function i() {
        h || (window.addEventListener("resize", o, {
            passive: !0
        }),
    ...
    function a(e) {
        ...
        t.style.marginTop = i.style.marginTop,
    ...
    function c(e) {
        ...
        i.style.display = "none",
        i.style.height = window.getComputedStyle(e).height,
        i.className = e.className,
        i.classList.remove("js-sticky"),
        i.classList.add("is-placeholder"),
        e.parentNode.insertBefore(i, e)
    }
    function l(e) {
        var t = c(e)
          , i = window.getComputedStyle(e).position;
        e.style.position = "static";
        var n = e.offsetParent;
        e.style.position = "fixed";
        var o = window.getComputedStyle(e).top
          , r = {
            element: e,
            placeholder: t,
            offsetParent: n,
...
function(e) {
    var t = function() {
        ...
        var e = "s"
          ...
          , o = function() {
            var t = n(new Date(i.BASELINE_YEAR,0,2))
              , o = n(new Date(i.BASELINE_YEAR,5,2))
              , r = t - o;
            return 0 > r ? t + ",1" : r > 0 ? o + ",1," + e : t + ",0"
        }
          , r = function() {
            var e, t;
            if ("undefined" != typeof Intl && "undefined" != typeof Intl.DateTimeFormat && (e = Intl.DateTimeFormat(),
            ...
            for (var o = function(t) {
                for (var o = 0, r = 0; r < e.length; r++)
                    if (t.rules[r] && e[r]) {
                        ...
                        if (o = 0,
                        o += Math.abs(e[r].s - t.rules[r].s),
                        o += Math.abs(t.rules[r].e - e[r].e),
                        o > i.MAX_SCORE) {
                            o = "N/A";
                            break
                        }
          ...
          , d = function() {
            var e = r();
            return e || (e = t.olson.timezones[o()],
            "undefined" != typeof i.AMBIGUITIES[e] && (e = l(e))),
            {
                name: function() {
                    return e
                }
...
delete define.amd,
define("github/tz-cookie", ["jstimezonedetect", "./timezone"], function(e, t) {
    function i(e) {
        return e && e.__esModule ? e : {
            "default": e
        }
...
define("github/u2f-auth-form", ["exports", "delegated-events", "./u2f"], function(e, t, i) {
    function n() {
        ...
        var e = document.querySelector(".js-u2f-auth-form")
          , n = "true" === e.getAttribute("data-remote")
          , o = e.querySelector(".js-u2f-auth-response")
          , r = e.getAttribute("data-app-id")
          , s = e.getAttribute("data-challenge")
          , a = JSON.parse(e.getAttribute("data-sign-requests"));
        i.u2fSign(r, s, a).then(function(i) {
            o.value = JSON.stringify(i),
            n ? t.fire(e, "submit") : e.submit()
        })["catch"](function(e) {
            ...
            document.querySelector(".js-u2f-login-waiting").classList.add("d-none")
        })
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
...
define("github/u2f-login", ["./feature-detection", "./observe", "delegated-events", "./u2f-auth-form"], function(e, t, i, n) {
    ...
    t.observe(".js-u2f-auth-form-body", function() {
        this.classList.toggle("unavailable", !r["default"].u2f),
        r["default"].u2f && n.waitForDevice()
    })
}),
define("github/u2f-settings", ["./jquery", "./feature-detection", "./fetch", "./observe", "delegated-events", "./u2f"], function(e, t, i, n, o, r) {
    ...
    function h(e, t) {
        ...
        i.classList.add("is-showing-error"),
        i.classList.remove("is-sending"),
        Array.from(i.querySelectorAll(".js-u2f-error")).forEach(function(e) {
            return e.classList.add("d-none")
        });
        var n = i.querySelector(e);
        null != t && (n.textContent = t),
...
define("github/updatable-content", ["exports", "./jquery", "./has-interactions", "./preserve-position", "./xhr"], function(e, t, i, n, o) {
        ...
        return regeneratorRuntime.async(function(r) {
            for (; ; )
                ...
                case 2:
                    ...
                    r.prev = 7,
                    r.next = 10,
                    regeneratorRuntime.awrap(o.send(t));
                case 10:
                    if (n = r.sent,
                    !i.hasInteractions(e)) {
                        r.next = 13;
                ...
                case 16:
                    r.prev = 16,
                    r.t0 = r["catch"](7),
                    "XMLHttpRequest abort" !== r.t0.message && console.warn("Failed to update content", e, r.t0);
                case 19:
                    return r.prev = 19,
                    l["delete"](e),
                    r.finish(19);
    ...
    function u(e, t) {
        return n.preserveInteractivePosition(function() {
            ...
            return c["default"](e).replaceWith(i),
            i
        })
    }
    Object.defineProperty(e, "__esModule", {
...
define("github/upload/avatar", ["../facebox", "../fetch", "delegated-events"], function(e, t, i) {
    ...
    i.on("upload:setup", ".js-upload-avatar-image", function(e) {
        var t = e.detail.policyRequest
          , i = this.getAttribute("data-alambic-organization")
          , n = this.getAttribute("data-alambic-owner-type")
          , o = this.getAttribute("data-alambic-owner-id");
        i && t.body.append("organization_id", i),
        n && t.body.append("owner_type", n),
        o && t.body.append("owner_id", o)
    }),
    i.on("upload:complete", ".js-upload-avatar-image", function(e) {
        var i = e.detail.result
          , n = "/settings/avatars/" + i.id;
        o["default"](function() {
...
define("github/text", ["exports"], function(e) {
    function t(e, t, i) {
        var n = e.value.substring(0, e.selectionEnd)
          , o = e.value.substring(e.selectionEnd);
        n = n.replace(t, i),
        o = o.replace(t, i),
        e.value = n + o,
        e.selectionStart = n.length,
        e.selectionEnd = n.length
    }
    function i(e, t) {
        var i = e.selectionEnd
          , n = e.value.substring(0, i)
          , o = e.value.substring(i)
          , r = "" === e.value || n.match(/\n$/) ? "" : "\n";
        e.value = n + r + t + o,
...
define("github/html-validation", ["exports"], function(e) {
    function t(e) {
        if (null == o) {
            ...
            "checkValidity"in t ? (t.required = !0,
            t.value = "hi",
            o = t.cloneNode().checkValidity()) : o = !1
        }
        return o
    }
    function i(e) {
...
define("github/upload/markdown", ["../text", "../image-dimensions", "delegated-events", "../html-validation", "../setimmediate"], function(e, t, i, n, o) {
    ...
    i.on("upload:complete", ".js-upload-markdown-image", function(t) {
        function i(t) {
            ...
            if (c(o.file)) {
                var r = u(o.policy.asset.name)
                  , a = o.policy.asset.href;
                if (t && t.ppi === f) {
        ...
        var o = t.detail
          , r = this
          , s = r.querySelector(".js-comment-field")
          , l = a(o.file);
...
define("github/upload/release-file", ["delegated-events", "../setimmediate"], function(e, t) {
    ...
    e.on("upload:setup", ".js-upload-release-file", function(e) {
        ...
        1 === r.length && document.querySelector(".js-save-draft").click())
    }),
    ...
    e.on("upload:complete", ".js-upload-release-file", function(e) {
        var t = e.detail
          , i = t.policy
          , n = document.querySelector(".js-releases-field")
          , o = n.querySelector(".js-template").cloneNode(!0);
        o.classList.remove("template", "js-template"),
        o.querySelector("input.id").value = i.asset.id || t.result.id;
        ...
        o.querySelector(".filesize").textContent = s,
        n.appendChild(o),
        n.classList.remove("not-populated"),
        n.classList.add("is-populated"),
        this.querySelector(".js-upload-meter").classList.add("d-none")
    }),
...
define("github/upload/upload-manifest-file", ["../fetch", "../jquery", "../observe", "delegated-events", "../once", "../pjax"], function(e, t, i, n, o, r) {
    ...
    function a(e, t) {
        var i = e.closest(".js-upload-manifest-file-container")
          , n = i.querySelector(".js-upload-progress");
        n.classList.add("active"),
        e.classList.add("is-progress-bar");
        var o = n.querySelector(".js-upload-meter-text");
        o.querySelector(".js-upload-meter-range-start").textContent = t.batch.uploaded + 1,
        o.querySelector(".js-upload-meter-range-end").textContent = t.batch.size
    }
    function u(e) {
        e.classList.remove("is-progress-bar");
        var t = e.closest(".js-upload-manifest-file-container")
          , i = t.querySelector(".js-upload-progress");
    ...
    n.on("upload:drop:setup", ".js-upload-manifest-file", function(e) {
        var t = e.detail.files
          , i = parseInt(this.getAttribute("data-directory-upload-max-files"), 10);
        t.length > i && (e.preventDefault(),
        this.classList.add("is-too-many"))
    }),
    n.on("upload:drop:setup", ".js-upload-manifest-tree-view", function(e) {
        e.preventDefault();
        var t = e.detail.upload
          , i = document.querySelector("#js-repo-pjax-container");
    ...
    n.on("upload:start", ".js-upload-manifest-file", function(e) {
        var t = e.detail
          , i = this.closest(".js-upload-manifest-file-container")
          , n = i.querySelector(".js-upload-progress")
          , o = n.querySelector(".js-upload-meter-text");
        o.querySelector(".js-upload-meter-range-start").textContent = t.batch.uploaded + 1,
        o.querySelector(".js-upload-meter-filename").textContent = c(t.file)
    }),
    n.on("upload:complete", ".js-upload-manifest-file", function(e) {
        var t = e.detail
          , i = document.querySelector(".js-manifest-commit-file-template")
          , n = i.rows[0].cloneNode(!0);
    ...
    n.on("upload:progress", ".js-upload-manifest-file", function(e) {
        var t = e.detail
          , i = this.closest(".js-upload-manifest-file-container")
          , n = i.querySelector(".js-upload-meter");
        n.style.width = t.batch.percent() + "%"
    }),
    n.on("upload:error", ".js-upload-manifest-file", l),
    n.on("upload:invalid", ".js-upload-manifest-file", l),
    d["default"](document).on("ajaxSuccess", ".js-remove-manifest-file-form", function() {
        var e = this.closest(".js-manifest-file-list-root");
        if (this.closest(".js-manifest-file-entry").remove(),
        !e.hasChildNodes()) {
    ...
    i.observe(".js-manifest-ready-check", function() {
        ...
        e.fetchPoll(this.getAttribute("data-poll-url")).then(function() {
            ...
            document.querySelector(".js-manifest-ready-check").classList.add("d-none"),
            document.querySelector(".js-manifest-ready-check-failed").classList.remove("d-none")
        })
    })
}),
define("github/uploads", ["./fetch", "delegated-events", "./observe", "./upload/avatar", "./upload/markdown", "./upload/release-file", "./upload/upload-manifest-file"], function(e, t, i) {
    ...
    function o(e, t) {
        var i;
        (i = e.classList).remove.apply(i, O),
        e.classList.add(t)
    }
    function r(i, n) {
    ...
    function s(e, t) {
        var i = t.getAttribute("data-upload-policy-url")
          , o = t.getAttribute("data-upload-repository-id")
          , r = new FormData;
        return r.append("name", e.name),
        r.append("size", e.size),
        r.append("content_type", e.type),
        r.append("authenticity_token", n(t)),
        o && r.append("repository_id", o),
        e._path && r.append("directory", e._path),
        {
            url: i,
            method: "post",
            body: r,
    ...
    function u(i, r, s, u) {
        return {
            ...
            complete: function(a) {
                if (i.completed(r),
                a && a.href && (s.asset || (s.asset = {}),
                s.asset.href = a.href),
                s.asset_upload_url && s.asset_upload_url.length > 0) {
                    var c = new FormData;
                    c.append("authenticity_token", n(u)),
                    e.fetchJSON(s.asset_upload_url, {
                        method: "put",
                        body: c
                    })
                }
    ...
    function T(e) {
        ...
        if (c(n))
            !function() {
                ...
                e.then(function(e) {
                    if (!e.length)
                        return void o(r, "is-hidden-file");
                    var i = x.bind(null , e)
                      , n = !t.fire(r, "upload:drop:setup", {
                        upload: i,
                        files: e
                    });
                    n || x(e, r)
            ...
            r.length && t.fire(this, "upload:drop:links", {
                links: r
            })
        } else
            d(n) && t.fire(this, "upload:drop:text", {
                text: n.getData("text/plain")
            });
        e.stopPropagation(),
        e.preventDefault()
    }
    ...
    function M(e) {
        e.target.classList.contains("js-manual-file-chooser") && (x(e.target.files, this),
        e.target.value = "")
    }
    function D() {
        ...
        e.prototype.process = function() {
            ...
            if (!this.busy && 0 !== this.uploads.length) {
                ...
                for (var n in t.header)
                    i.setRequestHeader(n, t.header[n]);
    ...
    i.observe(".js-document-dropzone", {
        add: function() {
            ...
            document.body.addEventListener("dragend", I),
        ...
        remove: function() {
            ...
            document.body.removeEventListener("dragend", I),
    ...
    i.observe(".js-uploadable-container", {
        add: function() {
            0 === B++ && (document.addEventListener("drop", S),
            ...
            this.addEventListener("change", M),
            this.closest("form").addEventListener("reset", D)
        },
        remove: function() {
            0 === --B && (document.removeEventListener("drop", S),
            ...
            this.removeEventListener("change", M),
            this.closest("form").removeEventListener("reset", D)
        }
    })
}),
...
define("github/stats", ["exports", "./proxy-site-detection", "./document-ready"], function(e, t, i) {
    function n(e) {
        return e && e.__esModule ? e : {
            "default": e
        }
...
function() {
    ...
    function t() {
        ...
        o = u.length; o > t; t++)
            ...
            null != a && (e = a[1],
            d[e + ".js"] = l.src);
        for (c = i("link[rel=stylesheet]"),
        n = 0,
        r = c.length; r > n; n++)
            s = c[n],
            a = s.href.match(/\/([\w-]+)-[0-9a-f]{64}\.css$/),
            null != a && (e = a[1],
            d[e + ".css"] = s.href);
        return d
    }
    var i = require("github/jquery")["default"]
      , n = require("github/stats")["default"];
    i(window).on("load", e)
}(),
function() {
    function e(e) {
...
function() {
    ...
    e(document).on("change", "input.js-check-all", function(t) {
        ...
        if (!e(t.relatedTarget).is("input.js-check-all-item")) {
            for (o = e(i(this)),
            r = o.find("input.js-check-all-item"),
            s = 0,
            u = r.length; u > s; s++)
                a = r[s],
                n(this, a, this.checked);
            r.removeClass("is-last-changed")
        }
    }),
    o = null ,
    e(document).on("mousedown", "input.js-check-all-item", function(e) {
        o = e.shiftKey
    }),
    e(document).on("change", "input.js-check-all-item", function(t) {
        ...
        if (!e(t.relatedTarget).is("input.js-check-all, input.js-check-all-item")) {
            if (r = e(i(this)),
            a = r.find("input.js-check-all")[0],
            s = r.find("input.js-check-all-item"),
            o && (m = s.filter(".is-last-changed")[0]))
                for (u = s.toArray(),
                g = [u.indexOf(m), u.indexOf(this)].sort(),
                y = g[0],
                d = g[1],
                b = u.slice(y, +d + 1 || 9e9),
                h = 0,
                p = b.length; p > h; h++)
                    v = b[h],
                    n(this, v, this.checked);
            o = null ,
            s.removeClass("is-last-changed"),
            e(this).addClass("is-last-changed"),
            j = s.length,
            l = function() {
                var e = void 0
                  , t = void 0
    ...
    e(document).on("change", "input.js-check-all-item", function() {
        ...
        n.length && (o = t.find("input.js-check-all-item:checked").length,
        n.text(o))
    })
}
.call(this),
function() {
    ...
    var r = require("github/jquery")["default"]
    ...
    if (r(document).on("click", ".is-copy-enabled .js-zeroclipboard", function() {
        var e = this
          , r = this.getAttribute("data-clipboard-text");
        if (r)
            i(r);
        else {
            var s = this.closest(".js-zeroclipboard-container")
              , a = s.querySelector(".js-zeroclipboard-target");
            o(a) ? "hidden" === a.type ? i(a.value) : n(a) : t(a)
        }
        var c = this.getAttribute("data-copied-hint")
          , l = this.getAttribute("aria-label");
        c && c !== l && (this.setAttribute("aria-label", c),
        u(this, "mouseleave").then(function() {
    ...
    !document.documentElement.classList.contains("is-copy-enabled")) {
        var f = void 0
          , v = void 0
          , m = null != (f = r("link[rel=assets]").prop("href")) ? f : "/";
        h.config({
            swfPath: m + "static/flash/ZeroClipboard.v" + h.version + ".swf",
            trustedOrigins: [location.hostname],
            flashLoadTimeout: 1e4,
            cacheBust: null != (v = /MSIE/.test(navigator.userAgent) || /Trident\/[\d](?=[^\?]+).*rv:([0-9.].)/.test(navigator.userAgent)) ? v : {
                "true": !1
            }
        }),
        ...
        a("button.js-zeroclipboard", function(e) {
            ...
            n.on("copy", function(e) {
                var t = void 0
                  ...
                  , a = void 0;
                return t = e.target,
                null == t.getAttribute("data-clipboard-text") ? (s = r(t).closest(".js-zeroclipboard-container").find(".js-zeroclipboard-target")[0],
                s ? (a = o(s) ? s.value : s.textContent,
                i = e.clipboardData,
                i.setData("text/plain", a.trim())) : (n = new Error("source of clipboard text not found"),
                l(n, {
                    eventType: "copy",
                    eventTarget: d(t)
                }))) : void 0
            ...
            n.on("aftercopy", function() {
                var t = void 0;
                return t = r(this).attr("data-copied-hint"),
                r("#global-zeroclipboard-html-bridge").attr("aria-label", t || "Copied!"),
                e.blur()
            }),
            n.on("error", function() {
                return r("#global-zeroclipboard-html-bridge, .js-zeroclipboard").remove(),
                r(".js-zeroclipboard-container").addClass("has-zeroclipboard-disabled")
            }),
            i = function() {
                var e = void 0;
                return this.classList.remove("tooltipped", "tooltipped-s"),
                e = r(this).attr("aria-label"),
                r("#global-zeroclipboard-html-bridge").addClass("tooltipped tooltipped-s").attr("aria-label", e || "Copy to clipboard.")
            }
            ,
            t = function() {
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , i = t.replaceContent
      , n = require("github/html-validation")
      , o = n.revalidate
      , r = void 0;
    r = require("github/setimmediate")["default"],
    e(document).on("ajaxBeforeSend", ".js-new-comment-form", function(t) {
    ...
    e(document).on("ajaxSuccess", ".js-new-comment-form", function(t, n, r, s) {
        ...
        if (this === t.target) {
            this.reset(),
            e(this).find(".js-resettable-field").each(function() {
                this.value = this.getAttribute("data-reset-value")
            }),
            o(this),
            e(this).find(".js-write-tab").click(),
            a = s.updateContent;
            for (u in a) {
                var c = a[u]
    ...
    e(document).on("ajaxError", ".js-new-comment-form", function(t, i) {
        var n = void 0
          , o = void 0;
        if (this === t.target)
            return o = "You can't comment at this time",
            422 === i.status && (n = JSON.parse(i.responseText),
            n.errors && (o += " \u2014 your comment ",
            o += " " + n.errors.join(", "))),
            o += ". ",
            e(this).find(".js-comment-form-error").show().text(o),
            !1
    })
}
.call(this),
function() {
    ...
    t(".js-comment-and-button", function() {
        function e() {
            ...
            e !== o && (o = e,
            t.textContent = e ? t.getAttribute("data-comment-text") : n)
        }
        var t = this
          , i = t.form.querySelector(".js-comment-field")
          , n = t.textContent
          , o = !1;
        return {
            add: function() {
...
function() {
    var e = require("github/jquery")["default"]
      , t = void 0;
    t = require("github/has-interactions").hasDirtyFields,
    e(document).on("click", ".js-comment-edit-button", function() {
        var t = void 0;
        t = e(this).closest(".js-comment"),
        t.addClass("is-comment-editing"),
        t.find(".js-write-tab").click(),
    ...
    e(document).on("click", ".js-comment-cancel-button", function() {
        var i = void 0
          ...
          , r = void 0
          , s = void 0;
        if (i = e(this).closest("form"),
        t(i[0]) && !confirm(e(this).attr("data-confirm-text")))
            return !1;
        for (s = i.find("input, textarea"),
        o = 0,
        r = s.length; r > o; o++)
            n = s[o],
            n.value = n.defaultValue;
        return e(this).closest(".js-comment").removeClass("is-comment-editing"),
        !1
    }),
    e(document).on("ajaxSend", ".js-comment-delete, .js-comment-update, .js-issue-update", function(t, i) {
        var n = void 0;
        if (t.target === t.currentTarget) {
            n = e(this).closest(".js-comment"),
            n.addClass("is-comment-loading"),
            n.find(".btn-sm").addClass("disabled");
    ...
    e(document).on("ajaxError", ".js-comment-update", function(t, i, n, o) {
        var r = void 0
          ...
          , a = void 0
          , u = void 0;
        if (t.target === t.currentTarget && (console.error("ajaxError for js-comment-update", o),
        422 === i.status))
            try {
                if (a = JSON.parse(i.responseText),
                r = e(this).closest(".js-comment"),
                a.stale)
                    return i.stale = !0,
                    r.addClass("is-comment-stale"),
                    r.find(".btn-sm").addClass("disabled"),
                    t.preventDefault();
                if (a.errors)
                    return u = "There was an error posting your comment: " + a.errors.join(", "),
                    r.find(".js-comment-update-error").text(u).show(),
                    t.preventDefault()
            } catch (c) {
                return s = c,
                console.error("Error trying to handle ajaxError for js-comment-update: " + s)
            }
    }),
    e(document).on("ajaxComplete", ".js-comment-delete, .js-comment-update", function(t, i) {
        var n = void 0;
        if (t.target === t.currentTarget)
            return n = e(this).closest(".js-comment"),
            n.removeClass("is-comment-loading"),
            n.find(".btn-sm").removeClass("disabled"),
            i.stale ? n.find(".form-actions button[type=submit].btn-sm").addClass("disabled") : void 0
    }),
    e(document).on("ajaxSuccess", ".js-comment-delete", function() {
        var t = void 0
          , i = void 0;
        return t = e(this).closest(".js-comment"),
        i = e(this).closest(".js-comment-container"),
        1 !== i.find(".js-comment").length && (i = t),
        i.fadeOut(function() {
            return t.remove()
        })
    }),
    e(document).on("ajaxSuccess", ".js-comment-update", function(t, i, n, o) {
        var r = void 0
          ...
          , l = void 0;
        if (t.target === t.currentTarget) {
            for (r = e(this).closest(".js-comment"),
            s = e(this).closest(".js-comment-container"),
            s.length || (s = r),
            r.find(".js-comment-body").html(o.body),
            r.find(".js-comment-update-error").hide(),
            r.attr("data-body-version", o.newBodyVersion),
            l = r.find("input, textarea"),
            u = 0,
            c = l.length; c > u; u++)
                a = l[u],
                a.defaultValue = a.value;
            return r.removeClass("is-comment-stale"),
            r.removeClass("is-comment-editing")
        }
    }),
    e(document).on("ajaxSuccess", ".js-issue-update", function(e, t, i, n) {
        ...
        null != n.issue_title && (o.querySelector(".js-issue-title").textContent = n.issue_title,
        u = o.closest(".js-issues-results"),
        l = u && u.querySelector(".js-merge-pull-request textarea"),
        l && l.value === l.defaultValue && (l.value = l.defaultValue = n.issue_title)),
...
.call(this),
function() {
    var e = require("github/menu").deactivate
      , t = void 0
      , i = void 0
      , n = void 0
      , o = void 0
      ...
      , y = void 0
      , j = void 0;
    f = require("github/observe").observe,
    ...
    ,
    j = function(e, t) {
        for (; e[t] && null != e[t - 1] && !e[t - 1].match(/\s/); )
            t--;
        return t
    }
    ,
    ...
    u = function(e, t) {
        ...
        if (!n) {
            r = e.value.slice(0, e.selectionStart),
            i = e.value.slice(e.selectionEnd);
            try {
    ...
    g = function(e, t) {
        var n = void 0
          , o = void 0;
        return o = e.value.slice(e.selectionStart, e.selectionEnd),
        n = t.orderedList ? m(e) : t.multiline && c(o) ? d(e, t) : i(e, t),
        u(e, n)
    }
    ,
    r = function(e, t, i) {
        var n = void 0
          ...
          , r = void 0
          , s = void 0;
        return e.selectionStart === e.selectionEnd ? (e.selectionStart = j(e.value, e.selectionStart),
        e.selectionEnd = y(e.value, e.selectionEnd)) : (s = e.selectionStart - t.length,
        r = e.selectionEnd + i.length,
        n = e.value.slice(s, e.selectionStart) === t,
        o = e.value.slice(e.selectionEnd, r) === i,
        n && o && (e.selectionStart = s,
        e.selectionEnd = r)),
    ...
    h = function(e) {
        var t = void 0
          ...
          , a = void 0
          , u = void 0;
        return i = e.value.slice(0, e.selectionStart),
    ...
    i = function(e, t) {
        ...
        m = t.prefixSpace,
        j = t.scanFor,
        L = t.surroundWithNewlines,
        d = e.selectionStart,
        l = e.selectionEnd,
        w = e.value.slice(e.selectionStart, e.selectionEnd),
        p = c(w) && n.length > 0 ? n + "\n" : v,
        S = c(w) && o.length > 0 ? "\n" + o : k,
        m && (i = e.value[e.selectionStart - 1],
        0 === e.selectionStart || null == i || i.match(/\s/) || (p = " " + p)),
        w = r(e, p, S),
        q = e.selectionStart,
        x = e.selectionEnd,
        s = b.length > 0 && S.indexOf(b) > -1 && w.length > 0,
        L && (g = h(e),
        a = g.newlinesToAppend,
        u = g.newlinesToPrepend,
        p = a + v,
        S += u),
        w.startsWith(p) && w.endsWith(S))
            return y = w.slice(p.length, w.length - S.length),
            d === l ? (f = d - p.length,
            f = Math.max(f, q),
            f = Math.min(f, q + y.length),
            q = x = f) : (q = q,
            x = q + y.length),
            {
                text: y,
        ...
        if (s)
            return j.length > 0 && w.match(j) ? (S = S.replace(b, w),
            y = p + S,
            q = x = q + p.length,
            {
                text: y,
            ...
            q = q + p.length + w.length + S.indexOf(b),
            x = q + b.length,
            {
                text: y,
                selectionStart: q,
    ...
    d = function(e, t) {
        ...
        v = function() {
            ...
            t = n.length; t > e; e++)
                i = n[e],
                o.push(i.startsWith(s) && i.endsWith(l));
            return o
        }(),
        ...
        m ? (f = function() {
            ...
            t = n.length; t > e; e++)
                i = n[e],
                o.push(i.slice(s.length, i.length - l.length));
            return o
        }().join("\n"),
        ...
        d && (a = h(e),
        o = a.newlinesToAppend,
        r = a.newlinesToPrepend,
        c += o.length,
        u = c + f.length,
        f = o + f + r)),
        {
    ...
    o.on("click", ".js-toolbar-item", function() {
        return e(this.closest(".js-menu-container")),
        t(this)
    }),
    t = function(e) {
        var t = void 0
    ...
    ,
    l = navigator.userAgent.match(/Macintosh/) ? "meta" : "ctrl",
    b = new WeakMap,
    s = function(e) {
        var t = void 0
          , i = void 0
        ...
        if (s)
            return s;
        for (s = {},
        o = e.querySelectorAll(".js-toolbar-item[data-toolbar-hotkey]"),
        t = 0,
        n = o.length; n > t; t++)
            r = o[t],
            i = r.getAttribute("data-toolbar-hotkey"),
            s[l + "+" + i] = r;
        return b.set(e, s),
        s
    }
    ...
    v = function() {
        ...
        if (!b.get(this))
            return b.set(this, !0),
            i = this.closest(".js-previewable-comment-form").querySelector(".js-toolbar"),
            e = s(i),
            this.addEventListener("keydown", function(i) {
                var n = e[a(i)];
                n && (t(n),
                i.preventDefault())
            })
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/observe")
      , i = t.observe
      , n = require("github/normalized-event-timestamp")
      , o = n.normalizedTimestamp
      , r = n.timeSinceTimestamp
      , s = require("github/focused")
      , a = s.onFocusedKeydown
      , u = void 0
      , c = void 0
      , l = void 0
      , d = void 0
      ...
      , g = void 0
      , b = void 0;
    h = require("github/fetch").fetchText,
    g = require("github/stats")["default"],
    u = require("github/sliding-promise-queue")["default"],
    b = function(e) {
        var t = void 0;
    ...
    c = function(t) {
        var i = void 0
          ...
          , s = void 0
          , a = void 0;
        return i = t.closest(".js-previewable-comment-form"),
        o = t.classList.contains("js-preview-tab"),
        o && (s = i.querySelector(".js-write-bucket"),
        r = i.querySelector(".js-preview-body"),
        r.style.minHeight = e(s).height() + "px"),
        i.classList.toggle("preview-selected", o),
        i.classList.toggle("write-selected", !o),
        n = i.querySelector(".tabnav-tab.selected"),
        n.setAttribute("aria-selected", !1),
        n.classList.remove("selected"),
        t.classList.add("selected"),
        t.setAttribute("aria-selected", !0),
        a = i.querySelector(".js-write-tab"),
        o ? a.setAttribute("data-hotkey", "ctrl+P,meta+P") : a.removeAttribute("data-hotkey"),
        Promise.resolve(i)
    }
    ,
    ...
    e(document).on("preview:render", ".js-previewable-comment-form", function(e) {
        var t = e.originalEvent.detail.requestedAt || o(e.timeStamp)
          , i = void 0;
        return i = this.querySelector(".js-preview-tab"),
        c(i).then(function(e) {
            p(e, t)
        })
    }),
    ...
    p = function(e, t) {
        var i = void 0
          , n = void 0;
        return n = e.querySelector(".js-comment-field"),
        i = e.querySelector(".comment-body"),
        l(e, n.value).then(function(e) {
            var n = void 0;
    ...
    i(".js-preview-tab", function(e) {
        ...
        e.addEventListener("mouseenter", function() {
            i || (i = e.closest(".js-previewable-comment-form"),
            t = i.querySelector(".js-comment-field")),
            l(i, t.value)
        })
    }),
    a(document, ".js-comment-field", function() {
        ...
        function(t) {
            return "ctrl+P" !== t.hotkey && "meta+P" !== t.hotkey || !e.classList.contains("write-selected") ? void 0 : (this.blur(),
            e.dispatchEvent(new CustomEvent("preview:render",{
                bubbles: !0,
                cancelable: !1,
                detail: {
                    requestedAt: o(t.timeStamp)
                }
            })),
...
function() {
    ...
    n = function() {
        function t(t) {
            this.clearCropFormValues = o(this.clearCropFormValues, this),
            this.setCropFormValues = o(this.setCropFormValues, this),
            this.setCurrentSelection = o(this.setCurrentSelection, this),
            this.setTrueSize = o(this.setTrueSize, this);
            var i = void 0
              , n = void 0
              , r = void 0;
            this.$container = e(t),
            ...
            this.setTrueSize(r),
            this.setCurrentSelection(r),
            n = this,
            this.img.Jcrop(r, function() {
                return n.spinner.addClass("d-none"),
                n.jcrop = this
            })
        }
        return t.prototype.setTrueSize = function(e) {
            var t = void 0
              , i = void 0;
            return i = parseInt(this.img.attr("data-true-width")),
            t = parseInt(this.img.attr("data-true-height")),
            0 !== i && 0 !== t ? e.trueSize = [i, t] : void 0
        }
        ,
        t.prototype.setCurrentSelection = function(e) {
            var t = void 0
              ...
              , n = void 0
              , o = void 0;
            return i = parseInt(this.croppedW.val()),
            t = parseInt(this.croppedH.val()),
            0 !== i && 0 !== t ? (n = parseInt(this.croppedX.val()),
            o = parseInt(this.croppedY.val()),
            e.setSelect = [n, o, n + i, o + t]) : void 0
        }
        ,
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/facebox")["default"];
...
function() {
    ...
    function t() {
        var e = window.location.hash.slice(1);
        if (e)
            for (var t = document.querySelectorAll("[data-hashchange-activated]"), i = 0; i < t.length; i++) {
                var n = t[i];
                if (n.getAttribute("data-hashchange-activated") === e)
                    return n
            }
    }
    function i(e) {
        var t = void 0
          ...
          , a = void 0
          , u = void 0;
        ("tab" === (a = e.hotkey) || "shift+tab" === a) && (e.preventDefault(),
        i = n("#facebox"),
        t = n(Array.from(i.find("input, button, .btn, textarea")).filter(r)).filter(function() {
            return !this.disabled
        }),
        s = "shift+tab" === e.hotkey ? -1 : 1,
        o = t.index(t.filter(":focus")),
        u = o + s,
        u === t.length || -1 === o && "tab" === e.hotkey ? t.first().focus() : -1 === o ? t.last().focus() : t.get(u).focus())
    }
    var n = require("github/jquery")["default"]
      , o = require("github/hash-change")["default"]
      , r = require("github/visible")["default"]
      , s = require("github/history")
      , a = s.getState
      , u = s.replaceState
      , c = require("github/observe")
      , l = c.observe
      , d = require("github/facebox")
      , h = d.addFaceboxEventListener
      , f = d.close
      , v = d.teardownOnClose;
    o(function() {
        var e = t();
    ...
    document.addEventListener("facebox:afterClose", function() {
        ...
        n("#facebox :focus").blur()
    }),
    l("a[rel*=facebox]", function() {
        h(this)
    }),
    document.addEventListener("facebox:close", v),
    n(document).on("click", ".js-facebox-close", f)
}
.call(this),
define("github/fuzzy-filter", ["exports"], function(e) {
    ...
    function o(e) {
        var t = e.toLowerCase()
          , i = "+.*?[]{}()^$|\\".replace(/(.)/g, "\\$1")
          , n = new RegExp("\\(([" + i + "])\\)","g");
        return e = t.replace(/(.)/g, "($1)(.*?)").replace(n, "(\\$1)"),
        new RegExp("(.*)" + e + "$","i")
    }
    function r(e, t, i) {
        null == i && (i = null );
        ...
        if (t) {
            ...
            var a = void 0
              ...
              , c = void 0;
            for (a = u = 1,
            c = r.length; c >= 1 ? c > u : u > c; a = c >= 1 ? ++u : --u) {
                var l = r[a];
                l && (a % 2 === 0 ? s || (n.push("<mark>"),
                s = !0) : s && (n.push("</mark>"),
                s = !1),
                n.push(l))
            }
...
define("github/fuzzy-filter-sort-list", ["exports", "./fuzzy-filter", "./jquery"], function(e, t, i) {
    ...
    function o(e, i, n) {
        ...
        e) {
            i = i.toLowerCase();
            var E = null != (k = n.content) ? k : s
              , T = null != (S = n.text) ? S : a
              , _ = null != (L = n.score) ? L : t.fuzzyScore
              , M = n.limit;
            n.mark === !0 ? x = l : null != n.mark && null != n.mark.call && (x = n.mark);
            var D = c.get(e);
            for (D ? o = u["default"](e).children() : (o = D = u["default"](e).children(),
            c.set(e, D.slice(0))),
            h = 0,
            b = o.length; b > h; h++)
                f = o[h],
            ...
            i) {
                ...
                j = v.length; j > p; p++)
                    f = v[p],
                    null == f.fuzzyFilterTextCache && (f.fuzzyFilterTextCache = T(E(f))),
                    f.fuzzyFilterScoreCache = _(f.fuzzyFilterTextCache, i, f);
                for (v.sort(r),
                q = t.fuzzyRegexp(i),
                g = 0,
                w = v.length; w > g; g++)
                    f = v[g],
                    (!M || M > C) && f.fuzzyFilterScoreCache > 0 && (A++,
                    x && (d = E(f),
                    x(d),
                    x(d, i, q)),
                    P.appendChild(f)),
    ...
    function r(e, t) {
        var i = e.fuzzyFilterScoreCache
          , n = t.fuzzyFilterScoreCache
          , o = e.fuzzyFilterTextCache
          , r = t.fuzzyFilterTextCache;
...
define("github/prefix-filter-list", ["exports", "./jquery"], function(e, t) {
    ...
    function n(e, t, i) {
        ...
        e) {
            t = t.toLowerCase();
            var h = null != (l = i.text) ? l : o
              , f = s["default"](e).children()
              , v = i.limit;
            for (i.mark === !0 ? c = r : null != i.mark && null != i.mark.call && (c = i.mark),
            d = 0,
            n = 0,
            u = f.length; u > n; n++)
                a = f[n],
                0 === h(a).indexOf(t) ? v && d >= v ? a.style.display = "none" : (d++,
                a.style.display = "",
                c && (c(a),
                c(a, t))) : a.style.display = "none";
            return d
        }
    }
    function o(e) {
...
define("github/substring-filter-list", ["exports", "./jquery"], function(e, t) {
    ...
    function n(e, t, i) {
        ...
        e) {
            ...
            var h = null != (l = i.text) ? l : o
              , f = i.limit
              , v = s["default"](e).children();
            for (i.mark === !0 ? c = r : null != i.mark && null != i.mark.call && (c = i.mark),
            d = 0,
            n = 0,
            u = v.length; u > n; n++)
                a = v[n],
                -1 !== h(a).indexOf(t) ? f && d >= f ? a.style.display = "none" : (d++,
                a.style.display = "",
                c && (c(a),
                c(a, t))) : a.style.display = "none";
            return d
...
function() {
    function e(e, t) {
        var i = e.hasAttribute("data-filterable-highlight")
          , n = e.getAttribute("data-filterable-limit")
          , a = 0;
    ...
    var t = require("github/jquery")["default"]
      , i = require("github/observe")
      , n = i.observe
      , o = require("github/fuzzy-filter-sort-list")["default"]
      , r = require("github/prefix-filter-list")["default"]
      , s = require("github/substring-filter-list")["default"]
      , a = require("github/setimmediate")["default"]
      , u = require("delegated-events")
      , c = u.fire
      , l = require("github/throttled-input")
      , d = l.addThrottledInputEventListener
      , h = l.removeThrottledInputEventListener;
    n(".js-filterable-field", function() {
        function e() {
            var e = this;
            i !== this.value && (i = this.value,
            a(function() {
        ...
        return {
            ...
            remove: function() {
                this.removeEventListener("focus", t),
                h(this, e)
            }
        }
    }),
...
function() {
    var e = require("github/jquery")["default"]
      , t = new WeakMap
      , i = require("github/fire")["default"];
    e(document).on("focusin.delay", function(n) {
        var o = void 0;
        o = n.target,
        t.get(o) || i(o, "focusin:delay", function() {
            t.set(o, !0),
            e(o).trigger("focusin:delayed")
        })
    }),
    e(document).on("focusout.delay", function(n) {
        return setTimeout(function() {
            var o = void 0;
            o = n.target,
            o !== document.activeElement && i(o, "focusout:delay", function() {
                t["delete"](n.target),
                e(o).trigger("focusout:delayed")
            })
        }, 200)
    })
}(),
...
function() {
    ...
    o(".js-force-push-default-branch-notice", function() {
        ...
        this.classList.toggle("d-none", e),
        e && (this.submit(),
        i("hide-force-push-default-branch-notice"))
    })
}(),
function() {
    function e(e) {
...
function() {
    function e() {
        ...
        if (l = this.getAttribute("data-url")) {
            ...
            o = document.querySelectorAll(".js-issue-link[data-id='" + a + "']"),
            s = 0,
            u = o.length; u > s; s++)
                i = o[s],
            ...
            r = function(e) {
                return function(i) {
                    var n = void 0
                      , r = void 0;
                    return r = (null != i.response ? i.response.status : void 0) || 500,
                    n = function() {
                        switch (r) {
                        case 404:
    ...
    function t(e, t) {
        ...
        o = e.length; o > n; n++)
            i = e[n],
            r.push(i.setAttribute("title", t));
        return r
    }
    var i = require("github/fetch")
      , n = i.fetchJSON
...
function() {
    ...
    function t(e) {
        0 === e && (null == u && (u = getComputedStyle(r).transition),
        r.style.transition = "none"),
        s = e,
        r.style.width = s + "%",
        0 === e && (r.clientWidth,
        r.style.transition = u)
    }
    function i() {
        0 === s && (s = 12),
        t(Math.min(s + 3, 95)),
...
function() {
    ...
    document.addEventListener("pjax:beforeReplace", function(i) {
        var n = void 0
          ...
          , s = void 0
          , a = void 0;
        for (n = i.detail.contents,
        r = s = 0,
        a = n.length; a > s; r = ++s)
            o = n[r],
            o && ("pjax-head" === o.id ? (t[document.location.pathname] = e(o).children(),
            n[r] = null ) : "js-flash-container" === o.id && (e("#js-flash-container").replaceWith(o),
            n[r] = null ))
    }),
    document.addEventListener("pjax:end", function() {
        var i = void 0
          , n = void 0
          , o = void 0;
        return i = t[document.location.pathname],
        i ? (e("head [data-pjax-transient]").remove(),
        o = e(i).not("title, script, link[rel='stylesheet']"),
        n = e(i).filter("link[rel='stylesheet']"),
        e(document.head).append(o.attr("data-pjax-transient", !0)),
        e(document.head).append(n)) : void 0
    })
}
.call(this),
function() {
    ...
    t = function(t) {
        var i = void 0
          , n = void 0;
        i = e(t),
        n = i.add(i.parents("[data-pjax]")).map(function() {
            var e = void 0;
...
function() {
    function e(e) {
        e.detail && e.detail.url && (window.performance.mark(a),
        r = e.detail.url)
    }
    function t() {
        o(function() {
            if (window.performance.getEntriesByName(a).length) {
                ...
                window.performance.measure(s, a, u);
                var e = window.performance.getEntriesByName(s)
                  , t = e.pop()
                  , o = t ? t.duration : null ;
                o && (n({
                    pjax: {
    ...
    function i() {
        ...
        window.performance.clearMeasures(s)
    }
    var n = require("github/stats")["default"]
      , o = require("github/setimmediate")["default"]
      , r = null
      , s = "last_pjax_request"
      , a = "pjax_start"
      , u = "pjax_end";
...
function() {
    ...
    e(function() {
        ...
        document.addEventListener("facebox:reveal", function() {
            ...
            o = e(".facebox-content .js-quick-issue-body"),
            o.length ? (n = t(),
            i = function() {
                try {
        ...
        e(window).on("error", function(t) {
            return n.push(i(t.originalEvent.error)),
            e(".js-captured-errors").val(JSON.stringify(n))
        }),
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/navigation").push
      , i = require("github/navigation").pop
      , n = require("github/navigation").clear
      , o = void 0
      , r = void 0
      , s = void 0
      , a = function(e, t) {
    ...
    ;
    r = require("github/sliding-promise-queue")["default"],
    s = require("github/fetch").fetchText,
    o = function() {
        function o(i) {
            this.resultsChanged = a(this.resultsChanged, this),
            this.fetchResults = a(this.fetchResults, this),
            this.onFieldInput = a(this.onFieldInput, this),
            this.onNavigationKeyDown = a(this.onNavigationKeyDown, this),
            this.teardown = a(this.teardown, this),
            this.$field = e(i),
            this.$form = e(i.form),
            this.fetchQueue = new r,
            ...
            this.$results = e(".js-quicksearch-results"),
            t(this.$results[0]),
        ...
        o.prototype.onNavigationKeyDown = function(e) {
            if ("esc" === e.hotkey)
                this.$results.removeClass("active"),
                n(this.$results[0]);
            else if ("enter" === e.hotkey && !e.target.classList.contains("js-navigation-item"))
        ...
        o.prototype.fetchResults = function(e) {
            var t = void 0
              , i = void 0
              , n = this.$results.attr("data-quicksearch-url");
            return n ? (i = e.trim() ? (n += ~n.indexOf("?") ? "&" : "?",
            n += this.$form.serialize(),
            this.$form.addClass("is-sending"),
            s(n)) : Promise.resolve(""),
            t = function(e) {
                return function() {
...
define("github/markdown-parsing", ["exports"], function(e) {
    ...
    function i(e) {
        for (var t = e.parentNode.children, i = 0; i < t.length; ++i)
            if (t[i] === e)
                return i
    }
    function n(e) {
    ...
    function s(e, t) {
        var i = void 0
          , r = document.createNodeIterator(e, NodeFilter.SHOW_ELEMENT, {
    ...
    function a(e) {
        ...
        if (n && ("OL" === n.parentNode.nodeName && (u = i(n)),
        !t.querySelector("li"))) {
            var o = document.createElement("li")
              , r = document.createElement(n.parentNode.nodeName);
            o.append(t),
            r.append(o),
            t = document.createDocumentFragment(),
            t.appendChild(r)
    ...
    var u = 0
      , c = {
        ...
        PRE: function(e) {
            var t = e.parentNode;
            return "DIV" === t.nodeName && t.classList.contains("highlight") && (e.textContent = e.textContent.replace(/^/gm, "    "),
            e.append("\n\n")),
            e
        },
        STRONG: function(e) {
...
function() {
    ...
    var t = require("delegated-events")
      , i = t.on
      , n = require("github/markdown-parsing")
      , o = n.selectionToMarkdown
      , r = require("github/setimmediate")["default"];
...
function() {
    ...
    var t = require("github/jquery")["default"]
      ...
      , o = require("delegated-events")
      , r = o.fire
      , s = require("github/scrollto")["default"];
...
function() {
    ...
    var i = require("github/jquery")["default"]
      , n = require("github/menu").deactivate;
    i(document).on("ajaxSuccess", ".js-pick-reaction", function(e, t, o, r) {
        ...
        if (s) {
            ...
            (a = s.querySelector(".js-reactions-container")).replaceWith.apply(a, _toConsumableArray(c)),
            (u = s.querySelector(".js-comment-header-reaction-button")).replaceWith.apply(u, _toConsumableArray(l))
        }
    }),
    i(document).on("menu:activated", ".js-reaction-popover-container", function() {
        i(this).on("mouseenter", ".js-reaction-option-item", e),
        i(this).on("mouseleave", ".js-reaction-option-item", t)
    }),
    i(document).on("menu:deactivated", ".js-reaction-popover-container", function() {
        i(this).off("mouseenter", ".js-reaction-option-item", e),
        i(this).off("mouseleave", ".js-reaction-option-item", t)
    })
}(),
function() {
    var e = require("github/observe")
...
function() {
    ...
    e(document).on("focusin", ".js-repo-filter .js-filterable-field", function() {
    ...
    e(document).on("click", ".js-repo-filter .js-repo-filter-tab", function(e) {
        ...
        for (u && o(u),
        a = t.querySelectorAll(".js-repo-filter-tab"),
        r = 0,
        s = a.length; s > r; r++)
            n = a[r],
            n.classList.toggle("filter-selected", n === this);
        i(t.querySelector(".js-filterable-field"), "filterable:change"),
        e.preventDefault()
    }),
    e(document).on("filterable:change", ".js-repo-filter .js-repo-list", function() {
        var t = void 0
          , i = void 0;
        t = this.closest(".js-repo-filter");
        var n = null != (i = t.querySelector(".js-repo-filter-tab.filter-selected")) ? i.getAttribute("data-filter") : void 0;
...
function() {
    ...
    ,
    r = null ,
    e(window).on("submit:prepare", function(e) {
        r = e.target,
        o(function() {
    ...
    i = function(t) {
        ...
        n = function() {
            var t = void 0
              ...
              , o = void 0
              , r = void 0;
            for (o = e(".js-session-resumable"),
            r = [],
            t = 0,
            n = o.length; n > t; t++)
                i = o[t],
                s(i) && r.push([i.id, i.value]);
            return r
        }(),
        n.length)
            try {
    ...
    n = function(t) {
        ...
        if (l) {
            ...
            s = a.length; s > n; n++) {
                ...
                if (document.dispatchEvent(h),
                !h.defaultPrevented) {
                    var f = document.getElementById(t);
                    f && f.value === f.defaultValue && (f.value = c,
                    i.push(f))
                }
            }
            o(function() {
    ...
    window.addEventListener("pjax:beforeReplace", function(e) {
        var n = void 0
          , r = void 0
          , s = void 0;
        null != e.detail.previousState && (s = e.detail.previousState.url),
        s ? (r = t(new URL(s)),
        i(r)) : (n = new Error("pjax:beforeReplace event.detail.previousState.url is undefined"),
        o(function() {
            throw n
        }))
    })
...
function() {
    ...
    i = function() {
        ...
        e(this).on("mousemove.userResize", function(t) {
            var r = void 0;
            (n.x !== t.clientX || n.y !== t.clientY) && (r = this.style.height,
            i && i !== r && e(this).trigger("user:resize"),
            i = r,
            o()),
            n = {
                x: t.clientX,
...
function() {
    ...
    u = function(t) {
        return e(t).on("user:resize.trackUserResize", function() {
            return e(t).addClass("is-user-resized"),
            e(t).css({
                "max-height": ""
            })
        })
    ...
    e(document).on("reset", "form", function() {
        var t = void 0;
        t = e(this).find("textarea.js-size-to-fit"),
        t.removeClass("is-user-resized"),
        t.css({
            height: "",
            "max-height": ""
        })
    ...
    s = function(i) {
        ...
        s = function() {
            var s = void 0
              ...
              , u = void 0
              , c = void 0;
            i.value !== r && t(i) && (c = n(o[0]),
            c.top < 0 || c.bottom < 0 || (u = o.outerHeight() + c.bottom,
            i.style.maxHeight = u - 100 + "px",
            s = i.parentNode,
            a = s.style.height,
            s.style.height = e(s).css("height"),
            i.style.height = "auto",
            o.innerHeight(i.scrollHeight),
            s.style.height = a,
            r = i.value))
        }
        ,
    ...
    ,
    r("textarea.js-size-to-fit:not(.is-user-resized)", {
        add: s,
        remove: a
    })
}
...
function(e, t) {
    ...
    function e(t, i, n) {
        function o(e, t) {
            ...
            return i.initCustomEvent(e, !1, !1, t),
            i
        }
        var r = {
            debug: !1,
        ...
        n || (n = {});
        for (var s in r)
            "undefined" != typeof n[s] ? this[s] = n[s] : this[s] = r[s];
        this.url = t,
        ...
        this.open = function(t) {
            if (a = new WebSocket(u.url,i || []),
            t) {
                if (this.maxReconnectAttempts && this.reconnectAttempts > this.maxReconnectAttempts)
                    return
            } else
                d.dispatchEvent(o("connecting")),
                this.reconnectAttempts = 0;
            (u.debug || e.debugAll) && console.debug("ReconnectingWebSocket", "attempt-connect", u.url);
            var n = a
              , r = setTimeout(function() {
                (u.debug || e.debugAll) && console.debug("ReconnectingWebSocket", "connection-timeout", u.url),
                l = !0,
                n.close(),
                l = !1
            }, u.timeoutInterval);
            ...
            a.onclose = function(i) {
                ...
                c)
                    ...
                    d.dispatchEvent(o("close"));
                else {
                    u.readyState = WebSocket.CONNECTING;
                    var n = o("connecting");
                    n.code = i.code,
                    n.reason = i.reason,
                    n.wasClean = i.wasClean,
                    d.dispatchEvent(n),
                    t || l || ((u.debug || e.debugAll) && console.debug("ReconnectingWebSocket", "onclose", u.url),
                    d.dispatchEvent(o("close")));
            ...
            a.onerror = function(t) {
                (u.debug || e.debugAll) && console.debug("ReconnectingWebSocket", "onerror", u.url, t),
                d.dispatchEvent(o("error"))
            }
        }
        ,
        ...
        this.send = function(t) {
            if (a)
                return (u.debug || e.debugAll) && console.debug("ReconnectingWebSocket", "send", u.url, t),
                a.send(t);
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , c = void 0
      , l = void 0;
    "undefined" != typeof WebSocket && null !== WebSocket && (n = require("reconnectingwebsocket"),
    c = {},
    r = {},
    o = null ,
    a = function() {
        ...
        if (t = document.head.querySelector("link[rel=web-socket]"))
            ...
            i.addEventListener("message", function(t) {
                ...
                n = o[0],
                i = o[1],
                n && i && e(r[n]).trigger("socket:message", [i, n])
            }),
            i
    }
    ,
    ...
    u = function(e) {
        ...
        if (null != o ? o : o = a())
            ...
            i = u.length; i > t; t++)
                n = u[t],
                l.readyState !== WebSocket.OPEN || c[n] || l.send("subscribe:" + n),
                c[n] = !0,
                null == r[n] && (r[n] = []),
                r[n].push(e)
    }
...
function() {
    var e = require("delegated-events")
      ...
      , n = void 0
      , o = void 0;
    if (o = null != (n = document.querySelector("meta[name=user-login]")) ? n.content : void 0,
    null != o) {
        i = String(!!o.length);
        try {
        ...
        window.addEventListener("storage", function(e) {
            var n = void 0;
            e.storageArea === localStorage && "logged-in" === e.key && e.newValue !== i && (i = e.newValue,
            n = document.querySelector(".js-stale-session-flash"),
            n.classList.toggle("is-signed-in", "true" === i),
            n.classList.toggle("is-signed-out", "false" === i),
            n.classList.remove("d-none"),
...
define("github/text-field-mirror", ["exports"], function(e) {
    function t(e, t) {
        ...
        var h = void 0;
        t !== !1 && (h = document.createElement("span"),
        h.style.cssText = "position: absolute;",
        h.className = "text-field-mirror-marker",
        h.innerHTML = "&nbsp;");
        var f = void 0
          , v = void 0;
        if ("number" == typeof t) {
            var m = e.value.substring(0, t);
            m && (v = document.createTextNode(m)),
            m = e.value.substring(t),
            m && (f = document.createTextNode(m))
        } else {
            var p = e.value;
            p && (v = document.createTextNode(p))
        }
        return v && s.appendChild(v),
        h && s.appendChild(h),
        f && s.appendChild(f),
        s.parentElement || e.parentElement.insertBefore(s, e),
    ...
    var i = ["position:absolute;", "overflow:auto;", "word-wrap:break-word;", "top:0px;", "left:-9999px;"]
      , n = ["box-sizing", "font-family", "font-size", "font-style", "font-variant", "font-weight", "height", "letter-spacing", "line-height", "max-height", "min-height", "padding-bottom", "padding-left", "padding-right", "padding-top", "border-bottom", "border-left", "border-right", "border-top", "text-decoration", "text-indent", "text-transform", "width", "word-spacing"]
      , o = new WeakMap
}),
define("github/text-field-selection-position", ["exports", "./jquery", "./text-field-mirror"], function(e, t, i) {
    ...
    function o(e) {
        var t = arguments.length <= 1 || void 0 === arguments[1] ? e.selectionEnd : arguments[1]
          , i = s["default"](e, t)
          , n = r["default"](i).find(".text-field-mirror-marker").position();
        return n.top += parseInt(r["default"](i).css("border-top-width"), 10),
        n.left += parseInt(r["default"](i).css("border-left-width"), 10),
        setTimeout(function() {
            r["default"](i).remove()
        }, 5e3),
        n
    ...
    var c = a(n)
      ...
      , p = function() {
        ...
        return v(e, [{
            key: "setup",
            value: function() {
                c["default"](this.textarea.form).on("reset.suggester", this.deactivate.bind(this)),
                c["default"](this.textarea).on("paste.suggester", this.onPaste.bind(this)),
                c["default"](this.textarea).on("input.suggester", this.onInput.bind(this)),
                c["default"](this.suggester).on("navigation:keydown.suggester", "[data-value]", this.onNavigationKeyDown.bind(this)),
                c["default"](this.suggester).on("navigation:open.suggester", "[data-value]", this.onNavigationOpen.bind(this)),
                this.teardownManually || c["default"](this.textarea).on("focusout:delayed.suggester", this.teardown),
            ...
            value: function() {
                this.deactivate(),
                c["default"](this.textarea).off(".suggester"),
                c["default"](this.textarea.form).off(".suggester"),
                c["default"](this.suggester).off(".suggester"),
            ...
            value: function(e, i, n, o) {
                ...
                if (r) {
                    ...
                    if (s) {
                        ...
                        a.append("mentionable_type", r),
                        a.append("mentionable_id", s),
                        a.append("query_string", o),
                        t.fetch(e, {
                            method: "POST",
                            body: a
                        })
            ...
            value: function(e) {
                var t = this
                  , i = this._getDataValue(e.target)
                  , n = this.currentSearch.type.typeid
                  , o = this.suggester.querySelector("ul.suggestions").children
                  , r = this._findIndexOfPick(o, i)
                ...
                this.currentSearch.type.onSelection ? this.currentSearch.type.onSelection(i) : (a = a.replace(this.currentSearch.type.match, this.currentSearch.type.replace.replace("$value", i)),
                this.textarea.value = a + u),
                this.deactivate(),
                this.textarea.focus(),
            ...
            value: function() {
                ...
                if (t) {
                    ...
                    this.search(t.type, t.query).then(function(i) {
            ...
            value: function(e) {
                ...
                this.repositionManually || c["default"](this.suggester).css(h["default"](this.textarea, e + 1)),
                this.suggester.classList.contains("active") || (this.suggester.classList.add("active"),
                this.textarea.classList.add("js-navigation-enable"),
                i.push(this.suggester),
                i.focus(this.suggester))
            }
        }, {
            key: "deactivate",
            value: function() {
                this.suggester.classList.contains("active") && (this.suggester.classList.remove("active"),
                c["default"](this.suggester).find(".suggestions").hide(),
                this.textarea.classList.remove("js-navigation-enable"),
                i.pop(this.suggester))
            }
        }, {
            key: "search",
            value: function(e, t) {
                ...
                if (!this.disable || !this.disable(t))
                    for (var i in this.types) {
                        var n = this.types[i]
                          , o = t.match(n.match);
                        if (o)
                            return n.normalizeMatch ? n.normalizeMatch(n, e, o) : this.normalizeMatch(n, e, o)
                    }
            }
        }, {
            key: "normalizeMatch",
            ...
            value: function(e) {
                ...
                document.activeElement === this.textarea ? (this.currentSearch = null ,
                this.checkQuery()) : void 0
            }
        }]),
        e
    }();
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , m = void 0
      , p = void 0;
    u = require("github/feature-detection")["default"],
    ...
    p = {
        mention: {
            ...
            search: function(t, i) {
                var o = void 0
                  ...
                  , s = void 0;
                return s = l(i),
                o = e(t).find("ul.mention-suggestions"),
                r = g(o[0], i, {
                    limit: 5,
                    text: n,
                    score: function(e, t, i) {
                        var n = s.score(e, t, i)
                          , o = i.getAttribute("data-mentionable-score");
        ...
        auditLogUser: {
            ...
            search: function(t, i) {
                var n = void 0
                  , o = void 0;
                return n = e(t).find("ul.user-suggestions"),
                o = g(n[0], i, {
                    limit: 5
                }),
                Promise.resolve([n, o])
        ...
        auditLogOrg: {
            ...
            search: function(t, i) {
                var n = void 0
                  , o = void 0;
                return n = e(t).find("ul.org-suggestions"),
                o = g(n[0], i, {
                    limit: 5
                }),
                Promise.resolve([n, o])
        ...
        auditLogAction: {
            ...
            search: function(t, i) {
                var n = void 0
                  , o = void 0;
                return n = e(t).find("ul.action-suggestions"),
                o = g(n[0], i, {
                    limit: 5
                }),
                Promise.resolve([n, o])
        ...
        auditLogRepo: {
            ...
            search: function(t, i) {
                var n = void 0
                  , o = void 0;
                return n = e(t).find("ul.repo-suggestions"),
                o = g(n[0], i, {
                    limit: 5
                }),
                Promise.resolve([n, o])
        ...
        auditLogCountry: {
            ...
            search: function(t, i) {
                var n = void 0
                  , o = void 0;
                return n = e(t).find("ul.country-suggestions"),
                o = g(n[0], i, {
                    limit: 5
                }),
                Promise.resolve([n, o])
        ...
        emoji: {
            ...
            search: function(t, i) {
                var n = void 0
                  , o = void 0;
                return n = e(t).find("ul.emoji-suggestions"),
        ...
        hashed: {
            ...
            search: function(t, i) {
                var o = void 0
                  ...
                  , s = void 0
                  , a = void 0;
                return o = e(t).find("ul.hashed-suggestions"),
                r = /^\d+$/.test(i) ? (s = new RegExp("\\b" + i),
                function(e) {
                    return h(e, s)
                }
                ) : l(i).score,
    ...
    d = function(e, t, i) {
        ...
        for (o = [],
        n = r = 1,
        s = t.length; s >= 1 ? s > r : r > s; n = s >= 1 ? ++r : --r) {
            if (i = e.indexOf(t[n], i),
            -1 === i)
                return;
            o.push(i++)
        }
    ...
    l = function(e) {
        var t = void 0
          , i = void 0;
        return e ? (t = e.toLowerCase().split(""),
        i = function(i) {
            var n = void 0
              , o = void 0;
            return i && (n = v(i, t)) ? (o = e.length / n[1],
            o /= n[0] / 2 + 1) : 0
        }
        ) : i = c,
        {
...
function() {
    ...
    function o(e) {
        if (e.getAttribute("data-optional-question"))
            return !0;
        var t = e.querySelector("input.js-other-choice")
          , i = e.querySelector("input[type=text]");
        if (t && t.checked) {
            var n = i.value.trim();
            return n
        }
    ...
    function r(e) {
        var t = e.closest(".js-survey")
          , i = t.querySelector(".js-survey-button");
        i.disabled = !o(e)
    }
    function s(e) {
        var t = e.querySelector("input.js-other-choice")
          , i = e.querySelector("input[type=text]");
        t && (i.classList.toggle("d-none", !t.checked),
        t.checked && i.focus())
    }
    function a(e, t) {
        var n = e.querySelector(".js-survey-form")
          , o = e.querySelectorAll(".js-survey-box-header, .js-survey-body, .js-survey-footer")
          , r = e.querySelector(".js-survey-complete");
        t.classList.toggle("d-none", !0),
        Array.from(o).forEach(function(e) {
            return e.classList.toggle("d-none", !0)
        }),
        r.classList.toggle("d-none", !1),
        p({
            category: "survey",
            action: "click",
            label: "submit"
    ...
    function u(e, t, i) {
        var n = i.getAttribute("data-next-question")
          , o = e.querySelector(".js-question-" + n)
        ...
        s.textContent = parseInt(n) + 1,
        o.classList.toggle("d-none", !1),
        r(o),
        o.getAttribute("data-last-question") && (o.querySelector("textarea").focus(),
    ...
    var c = require("github/jquery")["default"]
      ...
      , f = h.getItem
      , v = h.setItem
      , m = require("github/google-analytics")
      , p = m.trackEvent
      , g = 3;
    d(".js-survey", function() {
        ...
        i(),
        this.classList.toggle("d-none", !1)) : this.classList.toggle("d-none", !0)
    }),
    ...
    c(document).on("click", ".js-survey-button", function() {
        var e = this.closest(".js-survey")
          ...
          , i = t.getAttribute("data-last-question")
          , n = this;
        t.classList.toggle("d-none", !0),
        i ? a(e, n) : u(e, n, t)
    }),
...
!function() {
    var e = require("github/jquery")["default"]
      , t = require("github/suggester")["default"]
      , i = require("github/fuzzy-filter").fuzzyScore
      , n = require("github/hotkey")["default"]
      , o = require("github/observe")
      , r = o.observe
      , s = require("github/fuzzy-filter-sort-list")["default"]
      , a = function() {
        function o(e) {
        ...
        return _createClass(o, [{
            ...
            value: function(e) {
                ...
                case "tab":
                case ",":
                    !this.isSuggesterVisible() && this.val() && (e.preventDefault(),
                    this.selectTag(this.val()))
                }
            }
        }, {
            key: "selectTag",
            value: function(e) {
                ...
                t && (this.selections.appendChild(this.templateTag(t)),
                this.input.value = "")
            }
        }, {
            key: "removeTag",
            ...
            value: function(t, n) {
                var o = this.selectedTags()
                  , r = e(t).find("ul.js-tag-suggestions")
                  , a = s(r[0], n, {
                    limit: 5,
                    score: function(e, t) {
...
function() {
    function e(e, t, i) {
        var n = e.replace(/\r/g, "").replace(I, "").replace(H, "").split("\n")
          , o = 0;
        return e.split("\n").map(function(e) {
            return n.indexOf(e) >= 0 && e.match(P) && (o += 1,
            o === t && (e = i ? e.replace(S, k) : e.replace(L, q))),
            e
        }).join("\n")
    }
    function t(e) {
    ...
    function s(e) {
        var t = e.closest(".js-comment-body")
          , i = Array.from(t.children).filter(function(e) {
    ...
    function a(e) {
        ...
        C = !1,
        A = e.target,
        D = A.closest(".contains-task-list"),
        A.classList.add("is-ghost"),
        _ = Array.from(A.parentNode.children),
        T = _.indexOf(A),
        E = _[T + 1] || null
    }
    function u(e) {
        if (A) {
            ...
            M !== t && A && (A.classList.add("is-dragging"),
            M = t,
            o(A, t) ? t.before(A) : t.after(A))
        }
    }
    function c(e) {
        if (A) {
            C = !0;
            var t = Array.from(A.parentNode.children).indexOf(A)
              , i = e.currentTarget.closest(".contains-task-list");
            if (T !== t || D !== i) {
                D === i && t > T && t++;
    ...
    function l() {
        ...
        A.classList.remove("is-ghost"),
        C || D.insertBefore(A, E),
        A = null ,
        E = null ,
        C = !1,
        M = null
    ...
    function h() {
        ...
        i.setAttribute("d", "M12,4V5H4V4h8ZM4,8h8V7H4V8Zm0,3h8V10H4v1Z"),
        t.appendChild(i),
        e.appendChild(t),
        e
    }
    ...
    function m(e) {
        e.querySelectorAll(".js-task-list-field").length > 0 && (e.classList.add("is-task-list-enabled"),
    ...
    function g(e, t, i) {
        ...
        if (o.setAttribute("type", "hidden"),
        o.setAttribute("name", "task_list_track"),
        o.setAttribute("value", t),
        n.appendChild(o),
        i) {
            var r = document.createElement("input");
            r.setAttribute("type", "hidden"),
            r.setAttribute("name", "task_list_reorder"),
            r.setAttribute("value", JSON.stringify(i)),
            n.appendChild(r)
        }
        if (!n.elements.task_list_key) {
            var s = document.createElement("input");
            s.setAttribute("type", "hidden"),
            s.setAttribute("name", "task_list_key"),
            s.setAttribute("value", n.querySelector(".js-task-list-field").getAttribute("name").split("[")[0]),
            n.appendChild(s)
        }
    ...
    var b = require("jquery")
      ...
      , M = null
      , D = null
      , P = RegExp("^(?:\\s*(?:>\\s*)*(?:[-+*]|(?:\\d+\\.)))\\s*(" + t(k) + "|" + t(q) + ")\\s+(?!\\(.*?\\))(?=(?:\\[.*?\\]\\s*(?:\\[.*?\\]|\\(.*?\\))\\s*)*(?:[^\\[]|$))")
      , I = /^`{3}(?:\s*\w+)?[\S\s].*[\S\s]^`{3}$/gm
      , H = RegExp("^(" + t(k) + "|" + t(q) + ").+$", "g");
    ...
    x("change", ".task-list-item-checkbox", function() {
        var t = this.closest(".js-task-list-container")
          , i = t.querySelector(".js-task-list-field")
          , n = 1 + Array.from(t.querySelectorAll(".task-list-item-checkbox")).indexOf(this)
          , o = this.checked;
        i.value = e(i.value, n, o),
        g(t, "checked:" + (o ? 1 : 0))
    }),
    j(".js-reorderable-task-lists .js-comment-body > .contains-task-list > .task-list-item", function() {
        if (!(this.closest(".js-comment-body").querySelectorAll(".task-list-item").length <= 1) && this.closest(".is-task-list-enabled")) {
            ...
            this.addEventListener("dragstart", a),
            this.addEventListener("dragenter", u),
            this.addEventListener("dragend", l),
            this.addEventListener("drop", c),
            this.addEventListener("dragover", d),
            this.addEventListener("mouseenter", i),
    ...
    b(document).on("ajaxComplete", "form.js-comment-update", function(e, t) {
        ...
        if (n && n.remove(),
        200 !== t.status || /^\s*</.test(t.responseText)) {
            if (422 === t.status && t.stale) {
                var o = JSON.parse(t.responseText);
                if (o) {
                    var r = o.updated_markdown
                      , s = o.updated_html
                      , a = o.version;
                    if (r && s && a) {
                        var u = this.closest(".js-task-list-container")
                          , c = u.querySelector(".js-comment-body")
                          , l = u.querySelector(".js-task-list-field");
                        c.innerHTML = s,
                        l.value = r,
                        u.dataset.bodyVersion = a
                    }
                } else
                    window.location.reload()
            }
        } else
            m(this.closest(".js-task-list-container"))
    })
}(),
function() {
    var e = require("github/jquery")["default"]
    ...
    i = function() {
        var i = void 0
          ...
          , u = void 0
          , c = void 0;
        if (c = this.getAttribute("data-url"))
            return u = t(c),
            s = this.getAttribute("data-id"),
            a = e(".js-team-mention[data-id='" + s + "']"),
            ...
            n = function(e) {
                return function(t) {
                    var i = void 0
                      , n = void 0;
                    return n = (null != t.response ? t.response.status : void 0) || 500,
                    i = function() {
                        switch (n) {
                        case 404:
                            return this.getAttribute("data-permission-text");
    ...
    o = function(e) {
        var t = void 0;
        return 0 === e.length ? "" : 1 === e.length ? e[0] : 2 === e.length ? e.join(" and ") : ([].splice.apply(e, [-1, 9e9].concat(t = "and " + e.slice(-1))),
        e.join(", "))
    }
    ,
...
function() {
    ...
    e(document).on("ajaxBeforeSend", function(t, i, n) {
        var o = void 0;
        n.crossDomain || (o = e(".js-timeline-marker"),
        o.length && i.setRequestHeader("X-Timeline-Last-Modified", o.attr("data-last-modified")))
    })
}
.call(this);
...
(function() {
    ...
    function t(e, t, i) {
        var n = new URL(e.getAttribute("data-fragment-url"),window.location.origin)
          , o = new URLSearchParams(n.search.slice(1));
        o.append("focus_type", t),
        o.append("focus_value", i),
        n.search = o.toString(),
        e.src = n.toString()
    }
    function i() {
    ...
    var n = require("github/dimensions")
      , o = n.overflowOffset
    ...
    function t() {
        return setTimeout(function() {
            var e = void 0
              ...
              , h = void 0;
            if (d = {},
            d.crossBrowserLoadEvent = Date.now(),
            ...
            for (l = function() {
                var e = void 0
                  ...
                  , n = void 0
                  , o = void 0;
                for (n = window.performance.getEntriesByType("resource"),
                o = [],
                e = 0,
                t = n.length; t > e; e++)
                    c = n[e],
...
define("github/page-focused", ["exports"], function(e) {
    function t(e) {
        return new Promise(function(t) {
            function i() {
                e.hasFocus() && (t(),
                e.removeEventListener("visibilitychange", i),
                window.removeEventListener("focus", i),
                window.removeEventListener("blur", i))
            }
            e.addEventListener("visibilitychange", i),
...
define("github/in-viewport", ["exports", "./jquery", "./observe", "./page-focused"], function(e, t, i, n) {
    ...
    function r(e) {
        var t = e.getBoundingClientRect()
          , i = d["default"](window).height()
          , n = d["default"](window).width();
        if (0 === t.height)
            return !1;
        if (t.height < i)
            return t.top >= 0 && t.left >= 0 && t.bottom <= i && t.right <= n;
        var o = Math.ceil(i / 2);
    ...
    function a(e) {
        document.hasFocus() && window.scrollY !== v && (v = window.scrollY,
        e.checkPending || (e.checkPending = !0,
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/observe")
      , i = t.observe
      , n = require("github/in-viewport")["default"]
      , o = void 0
      , r = void 0
      , s = void 0;
    s = 0,
    r = function() {
        var t = void 0;
        if (document.hasFocus() && (t = document.querySelector(".js-timeline-marker-form")))
            return e(t).submit()
    }
    ,
    n(".js-unread-item", {
    ...
    e(document).on("socket:message", ".js-discussion", function(e) {
        var t = void 0
          ...
          , r = void 0;
        if (this === e.target)
            for (r = document.querySelectorAll(".js-unread-item"),
            i = 0,
            n = r.length; n > i; i++)
                t = r[i],
                o(t)
...
function() {
    var e = require("github/jquery")["default"]
      , t = void 0
      , i = void 0;
    t = require("github/fragment-target").findElementByFragmentName,
    i = function() {
        var e = void 0
          , i = void 0;
    ...
    e(i),
    document.addEventListener("pjax:success", i)
}
.call(this),
function() {
    function e() {
    ...
    var t = require("github/jquery")["default"]
      , i = require("github/observe")
      , n = i.observe
      , o = require("github/html-validation")
      , r = o.checkValidity
      , s = o.revalidate
      , a = require("github/focused")
      , u = a.onFocusedInput
      , c = ["input[pattern]", "input[required]", "textarea[required]", "select[required]"].join(",");
    u(document, c, e),
    t(document).on("change", c, e),
    n(c, function(e) {
        e.form && s(e)
    }),
...
function() {
    var e = require("github/observe")
      , t = e.observe
      , i = require("github/google-analytics")
      , n = i.trackEvent
      , o = new WeakMap;
...
function() {
    ...
    t("click", ".js-new-user-contrib-example", function(e) {
        ...
        t.classList.contains("sample-graph") || (t.classList.add("sample-graph"),
        i = function(e) {
            var i = document.createElement("div");
            i.innerHTML = e;
            var n = void 0;
            n = t.querySelector(".js-calendar-graph-svg"),
            n.replaceWith(i.children[0])
        }
        ,
        o = function() {
...
function() {
    ...
    s = function() {
        ...
        return e.prototype.initCanvas = function(e) {
            var t = void 0
              ...
              , s = void 0
              , a = void 0;
            return o = e.getElementsByTagName("canvas")[0],
            o.style.zIndex = "0",
            n = o.width,
            i = o.height,
            r = o.getContext("2d"),
            s = window.devicePixelRatio || 1,
            t = r.webkitBackingStorePixelRatio || r.mozBackingStorePixelRatio || r.msBackingStorePixelRatio || r.oBackingStorePixelRatio || r.backingStorePixelRatio || 1,
            a = s / t,
            1 === a ? r : (o.width = n * a,
            o.height = i * a,
            o.style.width = n + "px",
        ...
        e.prototype.init = function(e) {
            var t = void 0
              ...
              , d = void 0;
            if (h) {
                for (this.focus = e.focus,
                this.nethash = e.nethash,
                this.spaceMap = e.spacemap,
                this.userBlocks = e.blocks,
                ...
                c = l.length; c > i; i++)
                    d = l[i],
                    this.users[d.name] = d;
                return this.chrome = new a(this,this.ctx,this.width,this.height,this.focus,this.commits,this.userBlocks,this.users),
                this.graph = new u(this,this.ctx,this.width,this.height,this.focus,this.commits,this.users,this.spaceMap,this.userBlocks,this.nethash),
                this.mouseDriver = new r(this.container,this.chrome,this.graph),
                this.keyDriver = new o(this.chrome,this.graph),
                this.stopLoader(),
    ...
    n = function() {
        ...
        return e.prototype.populate = function(e, t, i) {
            ...
            this.space = e.space,
            this.time = e.time,
            this.parents = this.populateParents(e.parents, i),
            this.requested = !0,
    ...
    a = function() {
        ...
        e.prototype.hover = function(e, t) {
            var i = void 0
              ...
              , o = void 0
              , r = void 0;
            for (r = this.userBlocks,
            n = 0,
            o = r.length; o > n; n++)
                if (i = r[n],
                e > 0 && e < this.namesWidth && t > this.graphTopOffset + this.offsetY + i.start * this.nameLineHeight && t < this.graphTopOffset + this.offsetY + (i.start + i.count) * this.nameLineHeight)
        ...
        e.prototype.drawTimeline = function(e) {
            var t = void 0
              ...
              , h = void 0
              , f = void 0;
            for (e.fillStyle = this.headerColor,
            e.fillRect(0, 0, this.width, this.headerHeight),
            e.fillStyle = this.dividerColor,
            e.fillRect(0, this.headerHeight - 1, this.width, 1),
            c = parseInt((0 - this.offsetX) / this.nameLineHeight),
            0 > c && (c = 0),
            u = c + parseInt(this.width / (this.nameLineHeight - 1)),
            u > this.commits.length && (u = this.commits.length),
            e.save(),
            e.translate(this.offsetX, 0),
            a = null ,
            s = null ,
            r = o = h = c,
            f = u; f >= h ? f > o : o > f; r = f >= h ? ++o : --o)
                t = this.commits[r],
                l = this.months[t.date.getMonth()],
                l !== a && (e.font = "bold 12px 'Helvetica Neue', Arial, sans-serif",
                e.fillStyle = "#555",
                d = this.ctx.measureText(l).width,
                e.fillText(l, r * this.nameLineHeight - d / 2, this.headerHeight / 2 + 4),
                a = l),
                n = t.date.getDate(),
                n !== s && (e.font = "12px 'Helvetica Neue', Arial, sans-serif",
                e.fillStyle = "#555",
                i = this.ctx.measureText(n).width,
                e.fillText(n, r * this.nameLineHeight - i / 2, this.headerHeight + this.dateRowHeight / 2 + 3),
                s = n,
                e.fillStyle = "#ddd",
                e.fillRect(r * this.nameLineHeight, this.headerHeight, 1, 6));
            return e.restore()
        }
        ,
        e.prototype.drawUsers = function(e) {
            var t = void 0
              ...
              , a = void 0;
            for (e.fillStyle = "#fff",
            e.fillRect(0, 0, this.namesWidth, this.height),
            e.save(),
            e.translate(0, this.headerHeight + this.dateRowHeight + this.offsetY),
            s = this.userBlocks,
            n = i = 0,
            o = s.length; o > i; n = ++i)
                t = s[n],
                e.fillStyle = this.userBgColors[n % 2],
                e.fillRect(0, t.start * this.nameLineHeight, this.namesWidth, t.count * this.nameLineHeight),
                this.activeUser && this.activeUser.name === t.name && (e.fillStyle = "rgba(0, 0, 0, 0.05)",
                e.fillRect(0, t.start * this.nameLineHeight, this.namesWidth, t.count * this.nameLineHeight)),
                r = (t.start + t.count / 2) * this.nameLineHeight + 3,
                ...
                e.textAlign = "center",
                e.fillText(t.name, this.namesWidth / 2, r, 96);
            return e.restore(),
    ...
    u = function() {
        function t(e, t, i, n, o, r, s, a, u, c) {
            ...
            this.dateRowHeight = 30,
            this.graphTopOffset = 10 + this.headerHeight + this.dateRowHeight,
            this.bgColors = ["#fff", "#f9f9f9"],
            this.nameLineHeight = 24,
            this.spaceColors = ["#c0392b", "#3498db", "#2ecc71", "#8e44ad", "#f1c40f", "#e67e22", "#34495e", "#e74c3c", "#2980b9", "#1abc9c", "#9b59b6", "#f39c12", "#7f8c8d", "#2c3e50", "#d35400", "#e74c3c", "#95a5a6", "#bdc3c7", "#16a085", "#27ae60"],
            this.offsetX = this.namesWidth + (this.width - this.namesWidth) / 2 - this.focus * this.nameLineHeight,
            this.offsetY = 0,
            this.bgCycle = 0,
            this.marginMap = {},
            ...
            p = w.length; p > f; f++)
                for (l = w[f],
                v = m = x = l.start,
                q = l.start + l.count; q >= x ? q > m : m > q; v = q >= x ? ++m : --m)
                    this.spaceUserMap[v] = this.users[l.name];
            for (this.headsMap = {},
            k = this.userBlocks,
            y = 0,
            g = k.length; g > y; y++)
        ...
        t.prototype.hover = function(e, t) {
            var i = void 0
              ...
              , u = void 0
              , c = void 0;
            for (c = this.timeWindow(),
            o = n = r = c.min,
            s = c.max; s >= r ? s >= n : n >= s; o = s >= r ? ++n : --n)
                if (i = this.commits[o],
                a = this.offsetX + i.time * this.nameLineHeight,
                u = this.offsetY + this.graphTopOffset + i.space * this.nameLineHeight,
                e > a - 5 && a + 5 > e && t > u - 5 && u + 5 > t)
                    return i;
            return null
        }
        ,
        t.prototype.hotLoadCommits = function() {
            ...
            this.lastHotLoadCenterIndex && Math.abs(this.lastHotLoadCenterIndex - t) < 10 ? void 0 : (this.lastHotLoadCenterIndex = t,
            e = this.backSpan(t, o),
            n = this.frontSpan(t, o),
            e || n ? (r = e ? e[0] : n[0],
            i = n ? n[1] : e[1],
            this.requestChunk(r, i)) : void 0)
        }
        ,
        t.prototype.backSpan = function(e, t) {
            var i = void 0
              ...
              , c = void 0;
            for (r = null ,
            n = i = u = e; (0 >= u ? 0 >= i : i >= 0) && n > e - t; n = 0 >= u ? ++i : --i)
            ...
            if (null !== r) {
                for (s = null ,
                a = null ,
                n = o = c = r; (0 >= c ? 0 >= o : o >= 0) && n > r - t; n = 0 >= c ? ++o : --o)
                    if (this.commits[n].requested) {
                        s = n;
                        break
                    }
                return s ? a = s + 1 : (a = r - t,
                0 > a && (a = 0)),
                [a, r]
            }
            return null
        ...
        t.prototype.frontSpan = function(e, t) {
            ...
            for (c = null ,
            n = i = r = e,
            s = this.commits.length; (s >= r ? s > i : i > s) && e + t > n; n = s >= r ? ++i : --i)
                if (!this.commits[n].requested) {
                    c = n;
                    break
                }
            if (null !== c) {
                ...
                d = null ,
                n = o = a = c,
                u = this.commits.length; (u >= a ? u > o : o > u) && c + t > n; n = u >= a ? ++o : --o)
                    if (this.commits[n].requested) {
                        l = n;
                        break
                    }
        ...
        t.prototype.requestChunk = function(t, i) {
            ...
            if (h) {
                for (o = n = r = t,
                s = i; s >= r ? s >= n : n >= s; o = s >= r ? ++n : --n)
                    this.commits[o].requested = new Date;
        ...
        t.prototype.importChunk = function(e) {
            ...
            if (e.commits) {
                ...
                r = a.length; r > n; n++)
                    ...
                    i = this.commits[t.time],
                    i.populate(t, c, this.commits),
                    u.push(function() {
                        var e = void 0
                          , t = void 0
                          , n = void 0
                        ...
                        t = n.length; t > e; e++)
                            ...
                            r.push(function() {
                                ...
                                for (r = [],
                                o = e = t = s.time + 1,
                                n = i.time; n >= t ? n > e : e > n; o = n >= t ? ++e : --e)
                                    this.connectionMap[o] = this.connectionMap[o] || [],
                                    r.push(this.connectionMap[o].push(i));
                                return r
                            }
                            .call(this));
                        return r
        ...
        t.prototype.draw = function() {
            var e = void 0
              ...
              , D = void 0
              , P = void 0;
            for (this.drawBackground(),
            P = this.timeWindow(),
            m = P.min,
            v = P.max,
            this.ctx.save(),
            this.ctx.translate(this.offsetX, this.offsetY + this.graphTopOffset),
            i = {},
            x = this.spaceMap,
            s = r = 0,
            c = x.length; c > r; s = ++r)
                for (M = this.spaceMap.length - s - 1,
                a = u = k = m,
                S = v; S >= k ? S >= u : u >= S; a = S >= k ? ++u : --u)
                    e = this.commits[a],
                    e.populated && e.space === M && (this.drawConnection(e),
                    i[e.id] = !0);
            for (s = f = L = m,
            C = v; C >= L ? C >= f : f >= C; s = C >= L ? ++f : --f)
                if (t = this.connectionMap[s])
                    for (p = 0,
                    l = t.length; l > p; p++)
                        e = t[p],
                        i[e.id] || (this.drawConnection(e),
                        i[e.id] = !0);
            for (A = this.spaceMap,
            s = b = 0,
            d = A.length; d > b; s = ++b)
                for (M = this.spaceMap.length - s - 1,
                a = j = E = m,
                T = v; T >= E ? T >= j : j >= T; a = T >= E ? ++j : --j)
                    e = this.commits[a],
                    e.populated && e.space === M && (e === this.activeCommit ? this.drawActiveCommit(e) : this.drawCommit(e));
            if (this.showRefs)
                for (a = w = _ = m,
                q = v; q >= _ ? q >= w : w >= q; a = q >= _ ? ++w : --w)
                    if (e = this.commits[a],
                    e.populated && (o = this.headsMap[e.id]))
                        for (y = 0,
                        D = 0,
                        h = o.length; h > D; D++)
                            n = o[D],
                            this.spaceUserMap[e.space].name === n.name && (g = this.drawHead(e, n.head, y),
                            y += g);
        ...
        t.prototype.drawBackground = function() {
            var e = void 0
              ...
              , n = void 0
              , o = void 0;
            for (this.ctx.clearRect(0, 0, this.width, this.height),
            this.ctx.save(),
            this.ctx.translate(0, this.offsetY + this.graphTopOffset),
            this.ctx.clearRect(0, -10, this.width, this.height),
            o = this.userBlocks,
            i = t = 0,
            n = o.length; n > t; i = ++t)
                e = o[i],
                this.ctx.fillStyle = this.bgColors[i % 2],
        ...
        t.prototype.drawCommit = function(e) {
            ...
            i = e.space * this.nameLineHeight,
            this.ctx.beginPath(),
            this.ctx.arc(t, i, 3, 0, 2 * Math.PI, !1),
        ...
        t.prototype.drawActiveCommit = function(e) {
            ...
            i = e.space * this.nameLineHeight,
            this.ctx.beginPath(),
            this.ctx.arc(t, i, 6, 0, 2 * Math.PI, !1),
            this.ctx.fillStyle = this.spaceColor(e.space),
            this.ctx.fill()
        }
        ,
        t.prototype.drawCommitInfo = function(e) {
            ...
            s = Math.max(l, 38 + 16 * c.length),
            n = this.offsetX + e.time * this.nameLineHeight,
            o = this.graphTopOffset + this.offsetY + e.space * this.nameLineHeight,
            a = 0,
            u = 0,
            a = n < this.graphMidpoint ? n + 10 : n - (i + 10),
            u = o < 40 + (this.height - 40) / 2 ? o + 10 : o - s - 10,
            this.ctx.save(),
            this.ctx.translate(a, u),
            this.ctx.fillStyle = "#fff",
            this.ctx.strokeStyle = "rgba(0, 0, 0, 0.2)",
            this.ctx.lineWidth = 1,
            this.roundRect(0, 0, i, s, t),
            r = this.gravatars[e.gravatar],
            r ? this.drawGravatar(r, 10, 10) : (r = new Image,
            r.src = e.gravatar,
            r.onload = function(t) {
                return function() {
                    return t.activeCommit === e ? (t.drawGravatar(r, a + 10, u + 10),
                    t.gravatars[e.gravatar] = r) : void 0
                }
            }(this)),
        ...
        t.prototype.drawGravatar = function(e, t, i) {
            ...
            this.ctx.lineWidth = .1,
            this.roundRect(t + 2, i + 2, n, n, 4),
            this.ctx.clip(),
            this.ctx.drawImage(e, t + 2, i + 2, n, n),
            this.ctx.restore()
        }
        ,
        t.prototype.roundRect = function(e, t, i, n, o) {
            return this.ctx.beginPath(),
            this.ctx.moveTo(e, t + o),
            this.ctx.lineTo(e, t + n - o),
            this.ctx.quadraticCurveTo(e, t + n, e + o, t + n),
            this.ctx.lineTo(e + i - o, t + n),
            this.ctx.quadraticCurveTo(e + i, t + n, e + i, t + n - o),
            this.ctx.lineTo(e + i, t + o),
            this.ctx.quadraticCurveTo(e + i, t, e + i - o, t),
            this.ctx.lineTo(e + o, t),
            this.ctx.quadraticCurveTo(e, t, e, t + o),
            this.ctx.fill(),
            this.ctx.stroke()
        }
        ,
        t.prototype.drawMessage = function(e, t, i) {
            var n = void 0
              ...
              , s = void 0
              , a = void 0;
            for (this.ctx.font = "12px 'Helvetica Neue', Arial, sans-serif",
            this.ctx.fillStyle = "#000000",
            a = [],
            o = n = 0,
            r = e.length; r > n; o = ++n)
                s = e[o],
                a.push(this.ctx.fillText(s, t, i + 16 * o));
            return a
        }
        ,
        t.prototype.splitLines = function(e, t) {
            ...
            n = a.length; n > i; i++)
                s = a[i],
                o.length + 1 + s.length < t ? o = "" === o ? s : o + " " + s : (r.push(o),
                o = s);
            return r.push(o),
            r
        }
        ...
        t.prototype.drawHead = function(e, t, i) {
            ...
            this.ctx.save(),
            n = this.ctx.measureText(t.name).width,
            this.ctx.restore(),
            r = e.time * this.nameLineHeight,
            s = e.space * this.nameLineHeight + 5 + i,
            o = 2.5,
            this.ctx.save(),
            this.ctx.translate(r, s - o),
            this.ctx.fillStyle = "rgba(0, 0, 0, 0.8)",
            this.ctx.beginPath(),
            this.ctx.moveTo(0, o),
            this.ctx.lineTo(-4, 10),
            this.ctx.quadraticCurveTo(-9, 10, -9, 15),
            this.ctx.lineTo(-9, 15 + n),
            this.ctx.quadraticCurveTo(-9, 15 + n + 5, -4, 15 + n + 5),
            this.ctx.lineTo(4, 15 + n + 5),
            this.ctx.quadraticCurveTo(9, 15 + n + 5, 9, 15 + n),
        ...
        t.prototype.drawConnection = function(e) {
            ...
            n = r.length; n > t; i = ++t)
                o = r[i],
                0 === i ? o.space === e.space ? s.push(this.drawBasicConnection(o, e)) : s.push(this.drawBranchConnection(o, e)) : s.push(this.drawMergeConnection(o, e));
            return s
        }
        ,
        ...
        t.prototype.drawBranchConnection = function(e, t) {
            ...
            this.ctx.stroke(),
            this.threeClockArrow(i, t.time * this.nameLineHeight, t.space * this.nameLineHeight)
        }
        ,
        t.prototype.drawMergeConnection = function(e, t) {
            var i = void 0
              , n = void 0
              , o = void 0;
            return i = this.spaceColor(e.space),
            this.ctx.strokeStyle = i,
            this.ctx.lineWidth = 2,
            this.ctx.beginPath(),
            e.space > t.space ? (this.ctx.moveTo(e.time * this.nameLineHeight, e.space * this.nameLineHeight),
            o = this.safePath(e.time, t.time, e.space),
            o ? (this.ctx.lineTo(t.time * this.nameLineHeight - 10, e.space * this.nameLineHeight),
            this.ctx.lineTo(t.time * this.nameLineHeight - 10, t.space * this.nameLineHeight + 15),
            this.ctx.lineTo(t.time * this.nameLineHeight - 5.7, t.space * this.nameLineHeight + 7.5),
            this.ctx.stroke(),
            this.oneClockArrow(i, t.time * this.nameLineHeight, t.space * this.nameLineHeight)) : (n = this.closestMargin(e.time, t.time, e.space, -1),
            e.space === t.space + 1 && e.space === n + 1 ? (this.ctx.lineTo(e.time * this.nameLineHeight, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 15, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 9.5, n * this.nameLineHeight + 7.7),
            this.ctx.stroke(),
            this.twoClockArrow(i, t.time * this.nameLineHeight, n * this.nameLineHeight),
            this.addMargin(e.time, t.time, n)) : e.time + 1 === t.time ? (n = this.closestMargin(e.time, t.time, t.space, 0),
            this.ctx.lineTo(e.time * this.nameLineHeight, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 15, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 15, t.space * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 9.5, t.space * this.nameLineHeight + 7.7),
            this.ctx.stroke(),
            this.twoClockArrow(i, t.time * this.nameLineHeight, t.space * this.nameLineHeight),
            this.addMargin(e.time, t.time, n)) : (this.ctx.lineTo(e.time * this.nameLineHeight + 10, e.space * this.nameLineHeight - 10),
            this.ctx.lineTo(e.time * this.nameLineHeight + 10, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 10, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 10, t.space * this.nameLineHeight + 15),
            this.ctx.lineTo(t.time * this.nameLineHeight - 5.7, t.space * this.nameLineHeight + 7.5),
            this.ctx.stroke(),
            this.oneClockArrow(i, t.time * this.nameLineHeight, t.space * this.nameLineHeight),
            this.addMargin(e.time, t.time, n)))) : (n = this.closestMargin(e.time, t.time, t.space, -1),
            n < t.space ? (this.ctx.moveTo(e.time * this.nameLineHeight, e.space * this.nameLineHeight),
            this.ctx.lineTo(e.time * this.nameLineHeight, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 12.7, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 12.7, t.space * this.nameLineHeight - 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 9.4, t.space * this.nameLineHeight - 7.7),
            this.ctx.stroke(),
            this.fourClockArrow(i, t.time * this.nameLineHeight, t.space * this.nameLineHeight),
            this.addMargin(e.time, t.time, n)) : (this.ctx.moveTo(e.time * this.nameLineHeight, e.space * this.nameLineHeight),
            this.ctx.lineTo(e.time * this.nameLineHeight, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 12.7, n * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 12.7, t.space * this.nameLineHeight + 10),
            this.ctx.lineTo(t.time * this.nameLineHeight - 9.4, t.space * this.nameLineHeight + 7.7),
            this.ctx.stroke(),
            this.twoClockArrow(i, t.time * this.nameLineHeight, t.space * this.nameLineHeight),
            this.addMargin(e.time, t.time, n)))
        }
        ,
        t.prototype.addMargin = function(e, t, i) {
            return this.marginMap[i] || (this.marginMap[i] = []),
            this.marginMap[i].push([e, t])
        }
        ,
        t.prototype.oneClockArrow = function(e, t, i) {
            return this.ctx.fillStyle = e,
            this.ctx.beginPath(),
            this.ctx.moveTo(t - 3, i + 10.5),
            this.ctx.lineTo(t - 9, i + 5.5),
            this.ctx.lineTo(t - 2.6, i + 3.5),
            this.ctx.fill()
        }
        ,
        t.prototype.twoClockArrow = function(e, t, i) {
            return this.ctx.fillStyle = e,
            this.ctx.beginPath(),
            this.ctx.moveTo(t - 12.4, i + 6.6),
            this.ctx.lineTo(t - 9.3, i + 10.6),
            this.ctx.lineTo(t - 3.2, i + 2.4),
            this.ctx.fill()
        }
        ,
        t.prototype.threeClockArrow = function(e, t, i) {
            return this.ctx.fillStyle = e,
            this.ctx.beginPath(),
            this.ctx.moveTo(t - 10, i - 3.5),
            this.ctx.lineTo(t - 10, i + 3.5),
            this.ctx.lineTo(t - 4, i),
            this.ctx.fill()
        }
        ,
        ...
        t.prototype.closestMargin = function(e, t, i, n) {
            var o = void 0
              ...
              , a = void 0
              , u = void 0;
            for (a = this.spaceMap.length,
            s = n,
            r = !1,
            o = !1,
            u = !1; !o || !r; ) {
                if (i + s >= 0 && this.safeMargin(e, t, i + s))
                    return i + s;
                0 > i + s && (r = !0),
                i + s > a && (o = !0),
                u === !1 && 0 === s ? (s = -1,
        ...
        t.prototype.safeMargin = function(e, t, i) {
            ...
            if (!this.marginMap[i])
                return !0;
            for (s = this.marginMap[i],
            n = 0,
            o = s.length; o > n; n++)
                if (r = s[n],
                this.pathsCollide([e, t], r))
                    return !1;
            return !0
        }
        ,
    ...
    r = function() {
        function t(t, i, n) {
            ...
            this.canvas = t.getElementsByTagName("canvas")[0],
            this.canvasOffset = e(this.canvas).offset(),
        ...
        t.prototype.docmove = function(e) {
            ...
            return t = e.pageX,
            i = e.pageY,
            this.dragging && (this.graph.moveX(t - this.lastPoint.x),
            this.graph.moveY(i - this.lastPoint.y),
            this.graph.draw(),
            this.chrome.moveX(t - this.lastPoint.x),
            this.chrome.moveY(i - this.lastPoint.y),
            this.chrome.draw()),
            this.lastPoint.x = t,
            this.lastPoint.y = i
        }
        ...
        t.prototype.move = function(e) {
            ...
            return n = e.pageX,
            o = e.pageY,
            this.dragging ? (this.graph.moveX(n - this.lastPoint.x),
            this.graph.moveY(o - this.lastPoint.y),
            this.graph.draw(),
            this.chrome.moveX(n - this.lastPoint.x),
            this.chrome.moveY(o - this.lastPoint.y),
            this.chrome.draw()) : (i = this.chrome.hover(n - this.canvasOffset.left, o - this.canvasOffset.top),
            i !== this.lastHoverUser ? (this.canvas.style.cursor = i ? "pointer" : "move",
            this.chrome.activeUser = i,
            this.chrome.draw(),
            this.lastHoverUser = i) : (t = this.graph.hover(n - this.canvasOffset.left, o - this.canvasOffset.top),
            t !== this.lastHoverCommit && (this.canvas.style.cursor = t ? "pointer" : "move",
            this.graph.activeCommit = t,
            this.graph.draw(),
            this.chrome.draw(),
            this.lastHoverCommit = t))),
            this.lastPoint.x = n,
            this.lastPoint.y = o
        }
        ,
    ...
    o = function() {
        ...
        t.prototype.redraw = function() {
            return this.dirty && (this.graph.draw(),
            this.chrome.draw()),
            this.dirty = !1
        }
        ,
...
function() {
    ...
    n = function() {
        ...
        i = e(this),
        t = i.find(":selected"),
        t.attr("data-already-member") ? (e(".js-account-membership-form").addClass("is-member"),
        e(".js-account-membership-form").removeClass("is-not-member")) : (e(".js-account-membership-form").removeClass("is-member"),
        e(".js-account-membership-form").addClass("is-not-member"))
    }
    ,
    i(".js-account-membership", n),
    e(document).on("change", ".js-account-membership", n)
}
.call(this),
function() {
    var e = require("github/jquery")["default"]
    ...
    r = function() {
        var i = void 0
          , n = void 0;
        return i = e(".js-audit-log-export-status"),
        i.data("oldText", i.text()),
        n = function() {
            var e = void 0;
            return e = u.slice(0, s).join(""),
            i.text("Exporting" + e),
            s >= 3 ? s = 0 : s += 1
        }
        ,
    ...
    l = function() {
        var t = void 0;
        return i(),
        t = e(".js-audit-log-export-status"),
        t.text(t.data("oldText")),
        clearInterval(c),
        s = 0
    }
    ,
    o = function() {
        return l(),
        e("#ajax-error-message").show(function() {
            return this.classList.add("visible")
        })
    }
    ,
    e(document).on("ajaxSend", ".js-audit-log-export", r),
    e(document).on("ajaxError", ".js-audit-log-export", o),
    e(document).on("ajaxSuccess", ".js-audit-log-export", function(e, t, i, r) {
        var s = void 0;
        return s = function() {
            return l(),
            window.location = r.export_url
        }
        ,
...
function() {
    ...
    e(document).on("submit", ".js-find-coupon-form", function(t) {
        var i = void 0
          , n = void 0;
        return i = t.target.action,
        n = e("#code").val(),
        window.location = i + "/" + encodeURIComponent(n),
        t.stopPropagation(),
        t.preventDefault()
    }),
    e(document).on("click", ".js-choose-account", function(t) {
        return e(".js-plan-row, .js-choose-plan").removeClass("selected"),
        e(".js-plan").val(""),
        e(".js-billing-section").addClass("has-removed-contents"),
        n(e(this).closest(".js-account-row")),
        t.stopPropagation(),
        t.preventDefault()
    }),
    e(document).on("click", ".js-choose-plan", function(t) {
        return o(e(this).closest(".js-plan-row")),
        t.stopPropagation(),
        t.preventDefault()
    }),
    ...
    n = function(t) {
        var i = void 0
          ...
          , s = void 0;
        if (t.length)
            return r = t.attr("data-login"),
            s = t.attr("data-plan"),
            e(".js-account-row, .js-choose-account").removeClass("selected"),
            t.addClass("selected"),
            t.find(".js-choose-account").addClass("selected"),
            e(".js-account").val(r),
            e(".js-plan-section").removeClass("d-none"),
            e(".js-billing-plans").addClass("d-none"),
            n = e(".js-plans-for-" + r),
            n.removeClass("d-none"),
            i = e(".js-plan-row", n),
            o(1 === i.length ? i : e("[data-name='" + s + "']", n))
    }
    ,
    o = function(t) {
        var i = void 0
          ...
          , s = void 0;
        if (t.length)
            return r = t.attr("data-name"),
            n = parseInt(t.attr("data-cost"), 10),
            s = t.closest(".js-billing-plans"),
            o = "true" === s.attr("data-has-billing"),
            i = s.attr("data-login"),
            e(".js-plan-row, .js-choose-plan").removeClass("selected"),
            t.addClass("selected"),
            t.find(".js-choose-plan").addClass("selected"),
            t.find(".js-choose-plan-radio").prop("checked", !0),
            e(".js-plan").val(r),
            0 === n || o ? e(".js-billing-section").addClass("has-removed-contents") : e(".js-billing-section[data-login='" + i + "']").removeClass("has-removed-contents")
    }
    ,
    e(function() {
        return n(e(".js-account-row.selected")),
        o(e(".js-plan-row.selected"))
    })
}
.call(this),
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/html-validation")
      , i = t.revalidate;
    e(document).on("change", ".js-survey-select", function() {
        ...
        t = i.find(".js-survey-other-text"),
        o = n.options[n.selectedIndex],
        o.classList.contains("js-survey-option-other") ? (i.addClass("is-other-selected"),
        t.attr("required", "required"),
        t.focus()) : (t.removeAttr("required"),
        i.removeClass("is-other-selected"))
    }),
    e(document).on("change", ".js-survey-radio", function() {
        var t = void 0
          ...
          , o = void 0;
        t = e(this)[0],
        o = e(this).closest(".js-survey-question-form"),
        n = o.find(".js-survey-other-text"),
        t.classList.contains("js-survey-radio-other") ? (o.addClass("is-other-selected"),
        n.attr("required", "required"),
        n.focus()) : (n.removeAttr("required"),
        o.removeClass("is-other-selected")),
        i(this)
    })
}
.call(this),
...
function() {
    ...
    u = function(t) {
        ...
        o = e(".js-file-line"),
        o.length) {
            if (o.css("background-color", ""),
            1 === r.length)
                return e("#" + i + "LC" + r[0]).css("background-color", "#f8eec7");
            if (r.length > 1) {
                for (n = r[0],
                s = []; n <= r[1]; )
                    e("#" + i + "LC" + n).css("background-color", "#f8eec7"),
                    s.push(n++);
                return s
            }
        }
    ...
    l = function(t) {
        var i = void 0
          , n = void 0
          , o = void 0;
        return null == t && (t = r(window.location.hash)),
        o = t.lineRange,
        i = t.anchorPrefix,
        u(t),
        !d && (n = e("#" + i + "LC" + o[0])).length && e(window).scrollTop(n.offset().top - .33 * e(window).height()),
        d = !1
    }
    ,
    h = function(e, t) {
        var i = void 0
          , n = void 0
          , o = void 0;
        return o = "FORM" === e.nodeName ? "action" : "href",
        i = e.getAttribute(o),
        (n = i.indexOf("#")) >= 0 && (i = i.substr(0, n)),
        i += t,
        e.setAttribute(o, i)
    }
    ,
    a(function() {
        ...
        if (document.querySelector(".js-file-line-container")) {
            ...
            o = document.querySelectorAll(".js-update-url-with-hash"),
            r = [],
            i = 0,
            n = o.length; n > i; i++)
                e = o[i],
    ...
    c = function(t) {
        var i = void 0
          , n = void 0;
        return d = !0,
        n = null != (i = e(window).scrollTop()) ? i : 0,
        t(),
    ...
    e(document).on("mousedown", ".js-line-number", function(e) {
        var t = void 0
          , i = void 0;
        return t = r(this.id),
        e.shiftKey && (i = o(window.location.hash),
        t.lineRange.unshift(i[0])),
        c(function() {
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/visible")["default"]
      , i = require("github/focused")
      , n = i.onFocusedKeydown
      , o = require("github/focused")
      , r = o.onFocusedInput
      , s = void 0
      , a = void 0
      , u = void 0
      ...
      , L = void 0;
    l = require("github/fetch").fetchText,
    b = require("github/observe").observe,
    v = function(e) {
        var t = void 0
          , i = void 0
          , n = void 0;
        return i = e[0],
        t = i.querySelector(".js-blob-filename"),
        t ? "." === (n = t.value) || ".." === n || ".git" === n ? !1 : /\S/.test(t.value) : !0
    }
    ,
    s = function(e) {
        var t = void 0;
        return t = e.querySelector(".js-blob-contents"),
        t ? "true" === t.getAttribute("data-allow-unchanged") ? !0 : d(t) : !0
    }
    ,
    g = function(e) {
        var t = void 0;
    ...
    a = function(i) {
        var n = void 0;
        return i = e(".js-blob-form"),
        n = i[0],
        Array.from(i.find(".js-check-for-fork")).some(t) ? !1 : v(i) ? s(n) || g(n) : !1
    }
    ,
    q = function(t) {
        var i = void 0;
        return i = t.find(".js-blob-contents")[0],
        i ? e(i).attr("data-allow-unchanged") ? !0 : d(i) : !1
    }
    ,
    m = function(e) {
        var t = void 0
          , i = void 0;
        return i = e[0],
        t = i.querySelector(".js-blob-contents"),
        d(t) || g(i)
    }
    ,
    u = null ,
    c = function(t) {
        var i = void 0;
        return i = e(t).attr("data-github-confirm-unload"),
        ("yes" === i || "true" === i) && (i = ""),
        null == i && (i = "false"),
        "no" === i || "false" === i ? null : function() {
            return i
        }
    }
    ,
    y = function() {
        var t = void 0;
        return t = e(".js-blob-form"),
        t[0] ? (t.find(".js-blob-submit").prop("disabled", !a(t)),
        t.find(".js-blob-contents-changed").val(q(t)),
        u ? m(t) ? window.onbeforeunload = u : window.onbeforeunload = null : void 0) : void 0
    }
    ,
    j = function(e) {
        var t = void 0
          ...
          , o = void 0
          , r = void 0;
        for (o = e.querySelectorAll("input"),
        r = [],
        i = 0,
        n = o.length; n > i; i++)
            t = o[i],
            "hidden" === t.getAttribute("type") && t.getAttribute("class") && (null == t.getAttribute("data-default-value") ? r.push(t.setAttribute("data-default-value", t.value)) : r.push(void 0));
        return r
    }
    ,
    d = function(e) {
    ...
    w = function(t) {
        var i = void 0
          , n = void 0
          , o = void 0;
        return i = t.querySelector(".js-blob-contents"),
        o = t.querySelector(".js-new-filename-field"),
        n = t.querySelector(".js-blob-filename"),
        i && o && n && null != n.defaultValue && n.defaultValue.length ? e(i).data("old-filename", o.value) : void 0
    }
    ,
    b(".js-blob-form", function() {
        ...
        y(),
        u = c(this),
        e(this).on("submit", function() {
            return window.onbeforeunload = null
        })
    }),
    e(document).on("change", ".js-blob-contents", function() {
        return x(e(".js-blob-filename")),
        y()
    }),
    r(document, ".js-blob-filename", function() {
        return function() {
            return e(".js-blob-contents").attr("data-filename", e(this).val()),
            p(e(this).val()),
            x(e(this))
        }
    }),
    ...
    n(document, ".js-breadcrumb-nav", function() {
        return function(t) {
            return 8 === t.keyCode && 0 === this.selectionStart && 0 === this.selectionEnd && 1 !== e(this).parent().children(".separator").length && (f(e(this), !0),
            t.preventDefault()),
            x(e(this))
        }
    }),
    ...
    p = function(t) {
        var i = void 0
          , n = void 0;
        return i = e(".js-gitignore-template"),
        n = e(".js-license-template"),
        /^(.+\/)?\.gitignore$/.test(t) ? i.addClass("is-visible") : /^(.+\/)?(licen[sc]e|copying)($|\.)/i.test(t) ? n.addClass("is-visible") : (i.removeClass("is-visible"),
    ...
    k = function(t) {
        var i = void 0
          ...
          , f = void 0
          , v = void 0;
        return o = t.closest("form"),
        n = e(".js-blob-contents"),
        i = o.find(".js-new-blob-commit-summary"),
        u = t.val() ? "Create " + t.val() : "Create new file",
        f = n.data("old-filename"),
        c = e(".js-new-filename-field").val(),
        n.removeData("new-filename"),
        u = (null != f ? f.length : void 0) && c !== f && null != t[0] ? (n.data("new-filename", !0),
        s = d(n[0]),
        r = s ? "Update and rename" : "Rename",
        t.val().length && c.length ? (v = f.split("/"),
        l = c.split("/"),
        h = !0,
        a = v.length - 1,
        ...
        v.length === l.length && h ? r + " " + v[a] + " to " + l[a] : r + " " + f + " to " + c) : r + " " + f) : (null != f ? f.length : void 0) && c === f ? "Update " + t.val() : u,
        i.attr("placeholder", u),
        e(".js-commit-message-fallback").val(u)
    }
    ,
    S = function(t) {
        var i = void 0
          , n = void 0;
        return i = e(".breadcrumb").children(".js-path-segment"),
        n = "",
        i.each(function() {
            var t = void 0;
            return t = e(this),
    ...
    f = function(e, t) {
        ...
        ,
        1 !== e.parent().children(".separator").length && (e.prev().remove(),
        i = e.prev().children().children().html(),
        e.prev().remove(),
        t && (e.val("" + i + e.val()),
        n = function() {
            t && (e[0].focus(),
            e[0].setSelectionRange(i.length, i.length))
        }
        )),
        p(e.val()),
    ...
    h = function(t, i, n) {
        var o = void 0
          ...
          , l = void 0;
        return null == n && (n = ""),
        i = i.replace(/[^-.a-z_0-9]+/gi, "-"),
        i = i.replace(/^-+|-+$/g, ""),
        i.length > 0 && (l = t.parent().children(".js-repo-root, [itemtype]").children("a").last().attr("href"),
        l || (o = t.parent().children(".js-repo-root, [itemtype]").children("span").children("a").last(),
        r = o.attr("data-branch"),
        u = o.attr("href"),
        l = u + "/tree/" + r),
        s = e(".js-crumb-template").clone().removeClass("js-crumb-template"),
        s.find("a[itemscope]").attr("href", l + "/" + i),
        s.find("span").text(i),
        a = e(".js-crumb-separator").clone().removeClass("js-crumb-separator"),
        t.before(s, a)),
        t.val(n),
        p(t.val()),
        c = function() {
    ...
    r(document, ".js-new-blob-commit-summary", function() {
        var t = void 0;
        return t = e(this).closest(".js-file-commit-form"),
        function() {
    ...
    e(document).on("change", ".js-gitignore-template input[type=radio]", function() {
        var t = void 0;
        return t = e(this).closest(".js-blob-form").find(".js-code-editor").data("code-editor"),
        l(this.getAttribute("data-template-url")).then(function(e) {
            return t.setCode(e)
        })
    }),
    e(document).on("change", ".js-license-template input[type=radio]", function() {
        var t = void 0
          , i = void 0;
        return t = e(this).closest(".js-blob-form").find(".js-code-editor").data("code-editor"),
        i = e(this).attr("data-template-contents"),
        t.setCode(i)
    }),
    n(document, ".js-new-blob-commit-description", function() {
        return function(t) {
            return "ctrl+enter" === t.hotkey || "meta+enter" === t.hotkey ? (e(this).closest("form").submit(),
            !1) : void 0
        }
    })
}
...
function() {
    ...
    t = function(t) {
        var i = void 0
          ...
          , a = void 0;
        for (t = t.toLowerCase(),
        i = e(".js-csv-data tbody tr"),
        r = [],
        n = 0,
        o = i.length; o > n; n++)
            s = i[n],
            a = e(s).text().toLowerCase(),
            -1 === a.indexOf(t) ? r.push(e(s).hide()) : r.push(e(s).show());
        return r
    }
    ,
    i = function(e) {
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/throttled-input")
      , i = t.addThrottledInputEventListener
      , n = void 0
      , o = void 0
      , r = void 0;
    r = require("github/history").replaceState,
    o = require("github/observe").observe,
    n = null ,
    o(".js-branch-search-field", function() {
        var t = void 0
          , o = void 0
          , s = void 0
          , a = void 0
          ...
          , g = void 0;
        o = e(this),
        s = o.closest(".js-branch-search"),
        t = s.closest(".js-branches"),
        a = t.find(".js-branches-subnav .js-subnav-item"),
        p = s.prop("action"),
        ...
        c = null ,
        u = function(t) {
            return c && c.readyState < 4 && c.abort(),
            c = e.ajax(t)
        }
        ,
        d = function() {
            var e = void 0
              , i = void 0;
            return null === n && (n = a.filter(".selected")),
            e = l(),
            i = e ? p + "?" + s.serialize() : m,
            u({
                url: i,
            ...
            t.toggleClass("is-search-mode", e),
            t.addClass("is-loading"),
            a.removeClass("selected"),
            e ? a.filter(".js-branches-all").addClass("selected") : (n.addClass("selected"),
            n = null )
        }
        ,
        v = function() {
        ...
        o.on("keyup", function(e) {
            return "esc" === e.hotkey ? (v(),
            this.blur()) : void 0
        })
    }),
    e(document).on("submit", ".js-branch-search", !1),
    e(document).on("click", ".js-clear-branch-search", function(t) {
        var i = void 0;
        if (1 === t.which)
            return i = e(this).closest(".js-branch-search").find(".js-branch-search-field"),
            i.focus().val("").trigger("input"),
            t.preventDefault()
    }),
    e(document).on("ajaxSend", ".js-branch-destroy, .js-branch-restore", function(t, i) {
        var n = void 0
          ...
          , a = void 0;
        return o = e(this),
        a = o.is(".js-branch-destroy"),
        s = o.closest(".js-branch-row").attr("data-branch-name"),
        n = o.closest(".js-branches").find(".js-branch-row").filter(function() {
            return this.getAttribute("data-branch-name") === s
        }),
        r = o.find("button[type=submit]"),
        r.blur().removeClass("tooltipped"),
        n.addClass("loading"),
        i.done(function() {
            return n.toggleClass("is-deleted", a)
        }).always(function() {
            return n.removeClass("loading"),
            r.addClass("tooltipped")
        })
    })
}
.call(this),
function() {
    ...
    n = function() {
        var t = void 0
          ...
          , a = void 0;
        return s = [],
        i = e(".js-advanced-search-input").val(),
        a = {
            Repositories: 0,
            Users: 0,
            Code: 0
        },
        t = e("input[type=text].js-advanced-search-prefix, select.js-advanced-search-prefix"),
        s = o(t, function(e, t, i) {
            return "" === e ? "" : ("" !== t && a[i]++,
            "" !== t ? "" + e + t : void 0)
        }),
        e.merge(s, o(e("input[type=checkbox].js-advanced-search-prefix"), function(t, i, n) {
            var o = void 0;
            return o = e(this).prop("checked"),
            o !== !1 && a[n]++,
            o !== !1 ? "" + t + o : void 0
        })),
        n = function(e) {
        ...
        ,
        r = e.trim(s.join(" ")),
        e(".js-type-value").val(n(a)),
        e(".js-search-query").val(e.trim(i + " " + r)),
        e(".js-advanced-query").empty(),
        e(".js-advanced-query").text("" + r),
        e(".js-advanced-query").prepend(e("<span>").text(e.trim(i)), " ")
    }
    ,
    o = function(t, i) {
        return e.map(t, function(t) {
            var n = void 0
              ...
              , r = void 0
              , s = void 0;
            return r = e.trim(e(t).val()),
            n = e(t).attr("data-search-prefix"),
            o = e(t).attr("data-search-type"),
            s = function(e) {
    ...
    e(document).on("change", ".js-advanced-search-prefix", n),
    e(document).on("focusin", ".js-advanced-search-input", function() {
    ...
    e(document).on("click", ".js-see-all-search-cheatsheet", function() {
        return e(".js-more-cheatsheet-info").removeClass("d-none"),
        !1
    }),
    e(function() {
...
function() {
    ...
    e(document).on("navigation:keydown", ".commits-list-item", function(t) {
        return "c" === t.hotkey ? (e(this).find(".commit-title > a").first().click(),
        !1) : void 0
    })
}(),
function() {
    ...
    o = require("github/observe").observe,
    e(document).on("click", ".js-compare-tabs a", function() {
        return e(this).closest(".js-compare-tabs").find("a").removeClass("selected"),
        e(this).addClass("selected"),
        e("#commits_bucket, #files_bucket, #commit_comments_bucket").hide(),
        e(this.hash).show(),
        !1
    }),
    t(function() {
    ...
    e(document).on("click", ".js-toggle-range-editor-cross-repo", function() {
        return e(".js-range-editor").toggleClass("is-cross-repo"),
        !1
    }),
    n.on("pjax:click", ".js-range-editor", function(t) {
        var i = void 0;
        i = t.detail.options,
        e(".js-compare-pr").hasClass("open") && !i.url.match(/expand=1/) && (null == i.data && (i.data = {}),
        i.data.expand = "1")
    }),
    e(document).on("navigation:open", "form.js-commitish-form", function() {
        var t = void 0
          ...
          , n = void 0;
        return i = e(this),
        n = i.find(".js-new-item-name").text(),
        t = e("<input>", {
            type: "hidden",
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/hash-change")["default"]
      , i = require("github/preserve-position")
      , n = i.preservingScrollPosition
      , o = void 0
      , r = void 0
      , s = void 0
      , a = void 0
    ...
    c = require("github/dimensions").overflowOffset,
    s = require("github/fragment-target").findElementByFragmentName,
    t(function() {
        var t = void 0
          , i = void 0
          , n = void 0
        ...
        f = l[2],
        r = l[3],
        !s(document, n.slice(1))) ? (h = 0,
        d = 1,
        (i = function() {
            var u = void 0
              , l = void 0;
            if ((l = e(s(document, t)).next()[0]) && (u = a(l, f, r)))
                return e(u).parents(".js-details-container").addClass("open"),
                o(u).then(function() {
                    var e = void 0
                      , t = void 0
                      , o = void 0
                      , r = s(document, n.slice(1));
                    if (r) {
                        if (t = c(r),
                        o = t.top,
                        e = t.bottom,
    ...
    o = function(t) {
        var i = void 0;
        return i = t.getAttribute("data-url"),
        i += "&anchor=" + encodeURIComponent(t.hash.slice(1)),
        i = i.replace(/[?&]/, "?"),
        new Promise(function(o, s) {
            return r(i).then(function(i) {
                var r = void 0
                  , s = void 0;
                return r = e(t).closest(".js-expandable-line"),
                s = r.next(".file-diff-line"),
                n(s[0], function() {
                    r.replaceWith(i)
                }),
                o()
    ...
    u = function(e) {
        ...
        null != t && 4 === t.length ? t : (i = e.match(/\#(discussion\-diff\-[0-9]+)([L|R])(\d+)$/i),
        null != i && 4 === i.length ? i : null )
    }
    ,
    a = function(t, i, n) {
        var o = void 0
          ...
          , d = void 0;
        for (n = parseInt(n, 10),
        c = e(t).find(".js-expand"),
        a = 0,
        u = c.length; u > a; a++)
            if (r = c[a],
            o = "R" === i ? "data-right-range" : "data-left-range",
            l = r.getAttribute(o).split("-"),
            d = l[0],
            s = l[1],
            parseInt(d, 10) <= n && n <= parseInt(s, 10))
                return r;
        return null
    }
}
...
function() {
    ...
    e(document).on("click", ".js-add-single-line-comment", function() {
        var t = void 0
          , i = void 0
          , n = void 0
          , o = void 0
          , r = void 0
          , a = void 0;
        s(e(this).closest(".file")[0]),
        r = this.getAttribute("data-path"),
        t = this.getAttribute("data-anchor"),
        a = this.getAttribute("data-position"),
        i = this.getAttribute("data-line"),
        o = l(e(this).closest("tr")[0], {
            path: r,
            anchor: t,
            position: a,
            line: i
        }),
        n = e(o).find(".js-line-comments")[0],
        n.classList.contains("is-resolved") ? n.classList.toggle("is-collapsed") : c(n)
    }),
    e(document).on("click", ".js-add-split-line-comment", function() {
        var t = void 0
          , i = void 0
          , n = void 0
          , o = void 0
        ...
        u = this.getAttribute("data-path"),
        t = this.getAttribute("data-anchor"),
        l = this.getAttribute("data-position"),
        ...
        o.classList.contains("is-resolved") ? o.classList.toggle("is-collapsed") : c(o)
    }),
    e(document).on("click", ".js-toggle-inline-comment-form", function() {
        return c(e(this).closest(".js-line-comments")[0]),
        !1
    }),
    e(document).on("quote:selection", ".js-line-comments", function() {
        c(this)
    }),
    i(document, ".js-inline-comment-form .js-comment-field", function() {
        return function(t) {
            return e(this).hasClass("js-navigation-enable") ? void 0 : "esc" === t.hotkey && 0 === this.value.length ? (n(e(this).closest(".js-inline-comment-form")[0]),
            !1) : void 0
        }
    }),
    e(document).on("click", ".js-hide-inline-comment-form", function() {
        return n(e(this).closest(".js-inline-comment-form")[0]),
        !1
    }),
    e(document).on("ajaxSuccess", ".js-inline-comment-form", function(t, i, o, r) {
        var s = void 0;
        this === t.target && (s = e(this).closest(".js-line-comments"),
        s.find(".js-comments-holder").append(r.inline_comment),
        n(this))
    }),
    e(document).on("session:resume", function(t) {
        t = t.originalEvent;
        var i = void 0;
        (i = t.detail.targetId.match(/^new_inline_comment_diff_([\w-]+)_(\d+)$/)) && e(".js-add-line-comment[data-anchor=" + i[1] + "][data-position=" + i[2] + "]").click()
    }),
    c = function(t) {
        return e(t).find(".js-inline-comment-form-container").addClass("open"),
        e(t).find(".js-write-tab").click(),
        e(t).find(".js-comment-field").focus()
    }
    ,
    n = function(t) {
        return t.reset(),
        e(t).closest(".js-inline-comment-form-container").removeClass("open"),
        o()
    }
    ,
    s = function(t) {
        return e(t).find(".js-toggle-file-notes").prop("checked", !0).trigger("change")
    }
    ,
    o = function() {
        var t = void 0
          ...
          , s = void 0
          , a = void 0;
        for (a = e(".file .js-inline-comments-container"),
        r = 0,
        s = a.length; s > r; r++)
            i = a[r],
            t = e(i).find(".js-comments-holder > *"),
            o = t.length > 0,
            n = e(i).find(".js-inline-comment-form-container").hasClass("open"),
            o || n || e(i).remove()
    }
    ,
    r = function(e) {
        ...
        t = i.firstElementChild.cloneNode(!0),
    ...
    l = function(t, i) {
        null == i && (i = {});
        var n = e(t).next(".js-inline-comments-container")[0];
        if (n)
            return n;
        n = r("#js-inline-comments-single-container-template");
    ...
    a = function(t, i, n) {
        var o = void 0;
        null == n && (n = {});
        var s = e(t).find(".js-line-comments." + i)[0];
        if (s)
            return s;
        s = r("#js-inline-comments-split-form-container-template"),
        s.classList.add(i);
        var a = s.querySelector(".js-inline-comment-form");
        return a && u(a, n),
        o = e(t).find("." + i),
        o.last().after(s),
        o.remove(),
    ...
    ,
    d = function(t) {
        var i = e(t).next(".js-inline-comments-container")[0];
        return i ? i : (i = e("#js-inline-comments-split-container-template").clone().children()[0],
        e(t).after(i),
        i)
    }
    ,
    u = function(e, t) {
        ...
        o = r.length; o > n; n++)
            i = r[n],
            i.name in t && (i.value = t[i.name]);
        s = e.querySelector(".js-comment-field"),
        s.id = s.id.replace(/^r\d+ /, "").replace("${anchor}", t.anchor).replace("${position}", t.position)
    }
}
.call(this),
function() {
    ...
    n = function(t, n, o) {
        return i(t, function(t) {
            ...
            a = function(t) {
                c && o(c, !1),
                c = e(t.target).closest(n)[0],
                c && o(c, !0)
            }
            ,
            i = function() {
                return t.addEventListener("mouseenter", r),
                t.addEventListener("mouseleave", s),
                t.addEventListener("mouseover", a)
            }
            ,
            u = function() {
                return t.removeEventListener("mouseenter", r),
    ...
    n(".diff-table", "td.blob-code, td.blob-num", function(e, t) {
        ...
        l = i.length; l > u; s = ++u)
            r = i[s],
            (null == n || o(s) === n) && d.push(r.classList.toggle("is-hovered", t));
        return d
    })
}
.call(this),
function() {
    ...
    s = function() {
        ...
        if (r) {
            ...
            c = r.length; c > s; s++)
                i = r[s],
                i.classList.remove("selected-line");
            r = null
        }
        if (o = window.location.hash.substring(1),
        o && (h = document.getElementById(o)),
        h && h.classList.contains("js-linkable-line-number")) {
            if (d = h.parentNode,
            e = d.children,
            4 === e.length)
                for (n = u = 0,
            ...
            r = function() {
                ...
                r = e.length; r > o; n = ++o)
                    i = e[n],
                    (null == t || a(n) === t) && (i.classList.toggle("selected-line"),
                    s.push(i));
                return s
            }()
        }
...
function() {
    ...
    e(document).on("click", ".js-show-rich-diff", function(t) {
        t.preventDefault(),
        e(this).closest(".js-warn-no-visible-changes").addClass("d-none").hide().siblings(".js-no-rich-changes").removeClass("d-none").show()
    })
}(),
function() {
    function e() {
        var e = document.querySelector("meta[name=diff-view]")
          , t = e && e.content
          , i = document.querySelector(".file-diff-split")
          , n = "split" === t && i || document.querySelector(".wants-full-width-container");
    ...
    i(".js-compare-tabs .tabnav-tab.selected", {
        add: e,
        remove: e
    }),
...
function() {
    ...
    i(".js-inline-comments-container", function() {
        var t = void 0
          , i = void 0
          , n = e(this).closest(".file")[0];
        return n ? (t = i = function() {
            var e = void 0;
            e = null != n.querySelector(".js-inline-comments-container"),
...
function() {
    function e(e) {
        var t = void 0
          ...
          , n = void 0;
        n = e.parentElement,
        i = n.querySelectorAll("td.js-line-comments").length,
        t = n.querySelectorAll("td.js-line-comments.is-collapsed").length,
        n.classList.toggle("is-collapsed", t > 0 && i === t)
    }
    var t = require("github/observe")
      , i = t.observe;
...
function() {
    ...
    n(document, ".js-repository-name", function() {
        var t = void 0
          , i = void 0
          , n = void 0;
        return n = /[^0-9A-Za-z_\-.]/g,
        i = e(".js-form-note"),
        t = e(".js-rename-repository-button"),
        function() {
            i.html("Will be renamed as <strong>" + this.value.replace(n, "-") + "</strong>"),
            n.test(this.value) ? i.show() : i.hide(),
            this.value && this.value !== e(this).attr("data-original-name") ? t.prop("disabled", !1) : t.prop("disabled", !0)
        }
    }),
...
function() {
    ...
    a = function(e, t) {
        var i = void 0;
        return i = t.querySelector(".js-repo-access-error"),
        i.textContent = e,
    ...
    o = function() {
        var e = void 0
          ...
          , n = void 0
          , o = void 0;
        for (n = document.querySelectorAll(".js-repo-access-error"),
        o = [],
        t = 0,
        i = n.length; i > t; t++)
            e = n[t],
            e.textContent = "",
            o.push(e.classList.add("d-none"));
        return o
    }
    ,
    t = function(e) {
    ...
    s = function() {
        ...
        t && (t.querySelector(".js-add-new-collab").disabled = !0,
        e(t.querySelector(".js-add-repo-access-field")).data("autocompleted"))
    }
    ,
    ...
    i = function(e) {
        var t = void 0
          ...
          , r = void 0
          , s = void 0
          , a = document.querySelector(".js-repo-access-team-select");
        if (a) {
            for (s = 0,
            r = a.querySelectorAll(".js-repo-access-team-select-option"),
            t = 0,
            o = r.length; o > t; t++)
                i = r[t],
                n = i.classList,
                e === i.getAttribute("data-team-id") && (n.add("has-access"),
                n.remove("selected")),
                n.contains("has-access") || s++;
            if (0 === s)
                return a.closest(".js-repo-access-group").classList.add("no-form")
        }
    }
    ,
    n = function(e) {
        ...
        return i ? (null != (t = i.querySelector("[data-team-id='" + e + "']")) && t.classList.remove("has-access"),
        i.closest(".js-repo-access-group").classList.remove("no-form")) : void 0
    }
    ,
    ...
    e(document).on("selectmenu:selected", ".js-repo-access-team-select", function() {
        var t = void 0
          , i = void 0;
        return t = this.querySelector(".js-repo-access-team-select-option.selected").getAttribute("data-team-id"),
        i = this.closest(".js-repo-access-group").querySelector(".js-add-repo-access-field"),
        i.value = t,
        e(i.form).submit()
    }),
    ...
    e(document).on("ajaxSuccess", ".js-add-repo-access-form", function(e, n, o, r) {
        ...
        d = u.value,
        u.value = "",
        r.error ? a(r.error, c) : (s(),
        l.insertAdjacentHTML("beforeend", r.html),
        t(c),
        "teams" === c.id ? i(d) : void 0)
    }),
    e(document).on("ajaxSuccess", ".js-remove-repo-access-form", function() {
        var e = void 0
          , i = void 0;
        return o(),
        e = this.closest(".js-repo-access-entry"),
        i = this.closest(".js-repo-access-group"),
        "teams" === i.id && n(e.getAttribute("data-team-id")),
        e.remove(),
        t(i)
    }),
    e(document).on("ajaxError", ".js-remove-repo-access-form", function() {
        return a(this.getAttribute("data-error-message"), this.closest(".js-repo-access-group")),
        !1
    })
}
.call(this),
function() {
    function e(e) {
        var t = e.querySelector(".js-authorized-pushers")
          , i = parseInt(t.getAttribute("data-limit"))
          , n = t.querySelectorAll(".js-authorized-user-or-team").length;
    ...
    t(document).on("autocomplete:result", ".js-add-protected-branch-user-or-team", function(t, i) {
        var o = this.closest(".js-protected-branch-options")
          , r = this.closest(".js-autocomplete-container")
          , s = new URL(r.getAttribute("data-url"),window.location.origin)
          , a = new URLSearchParams(s.search.slice(1));
        a.append("item", i),
        s.search = a.toString();
        var u = o.querySelector(".js-authorized-users-and-teams")
          , c = u.querySelector("div[data-user-or-team-name='" + i + "']");
        c ? (r.querySelector(".js-autocomplete-field").value = "",
        c.querySelector(".js-protected-branch-pusher").classList.add("user-already-added")) : n(s.toString()).then(function(t) {
            r.querySelector(".js-autocomplete-field").value = "",
    ...
    t(document).on("selectmenu:selected", ".js-pages-source", function() {
        var e = document.querySelector(".js-pages-source-btn-text")
          , t = document.querySelector(".js-pages-source-save-btn");
...
function() {
    ...
    l = function(e) {
        ...
        t.loadTimer = null ) : void 0) : void 0
    }
    ,
    a = function(e) {
        var t = void 0
        ...
        if (!e.data("timing"))
            ...
            n.load = Date.now(),
            n.helloTimer = setTimeout(h(e, function() {
                return !n.hello
            }), 1e3 * t),
            n.loadTimer = setTimeout(h(e), 1e3 * i),
            e.data("timing", n)
    }
    ,
    c = function(e) {
    ...
    h = function(e, i) {
        ...
        function() {
            ...
            !n || e.hasClass("is-render-ready") || e.hasClass("is-render-failed") || e.hasClass("is-render-failed-fatally") || !i() ? void 0 : (o = e.data("timing")) ? (console.error("Render timeout: " + JSON.stringify(o) + " Now: " + Date.now()),
            u(e)) : console.error("No timing data on $:", e)
        }
    }
    ,
    o = function(t) {
        var i = void 0
          , n = void 0;
        i = e(t || this),
        (null != (n = i.data("timing")) ? n.load : 0) || (l(i),
        a(i),
        i.addClass("is-render-automatic"),
        c(i))
    }
    ,
    n(".js-render-target", o),
    r = function(t) {
        var i = void 0;
        return i = ".js-render-target",
        e(t ? i + "[data-identity='" + t + "']" : i)
    }
    ,
    e(window).on("message", function(e) {
        ...
        i = d.body,
        u = d.payload,
        h && i && 1 === (t = r(o)).length && a === t.attr("data-host") && "render" === h) ? s(t, h, o, i, u) : void 0
    }),
    s = function(e, t, i, n, o) {
        ...
        case "hello":
            ...
            h = null != (c = e.find("iframe").get(0)) ? c.contentWindow : void 0,
            "function" == typeof h.postMessage && h.postMessage(JSON.stringify(r), "*"),
            "function" == typeof h.postMessage && h.postMessage(JSON.stringify(a), "*"),
            e.hasClass("is-local"))
                return s = e.parents(".js-code-editor").data("code-editor"),
                a = {
                    type: "render:data",
                    body: s.code()
                },
        ...
        case "ready":
            if (e.removeClass(d),
            e.addClass("is-render-ready"),
            null != o && null != o.height)
...
function() {
    ...
    e(function() {
        ...
        t.length ? (i = function() {
            ...
            e.closest(".newsletter-frequency-choice").addClass("selected")
        }
        ,
...
function() {
    ...
    t("click", ".js-toggle-lang-stats", function(e) {
        var t = document.querySelector(".js-stats-switcher-viewport")
          , i = 0 !== t.scrollTop ? "is-revealing-overview" : "is-revealing-lang-stats";
...
function() {
    ...
    t = function() {
        function t(t) {
            var i = void 0;
            i = e(t),
            this.name = i.attr("data-theme-name"),
            this.slug = i.attr("data-theme-slug"),
            this.baseHref = i.attr("href")
        }
    ...
    i = function() {
        function i() {
            ...
            this.$pagePreview = e("#page-preview"),
            this.$contextLoader = e(".theme-picker-spinner"),
            this.$fullPicker = e(".theme-picker-thumbs"),
            this.$miniPicker = e(".theme-picker-controls"),
            this.$scrollBackwardsLinks = e(".theme-toggle-full-left"),
            this.$scrollForwardsLinks = e(".theme-toggle-full-right"),
            this.$prevLinks = e(".theme-picker-prev"),
            this.$nextLinks = e(".theme-picker-next"),
            ...
            this.$pagePreview.on("load", this.onPagePreviewLoad),
            ...
            e(".theme-picker-view-toggle").click(this.onHideClick),
            e("#page-edit").click(this.onEditClick),
            e("#page-publish").click(this.onPublishClick),
        ...
        i.prototype.scrollThemeLinksContainer = function(e) {
            var t = void 0
              , i = void 0
              , n = void 0;
            return i = this.themeLinksContainer.scrollLeft(),
            n = this.themeLinksContainer.outerWidth(!0),
            t = i + n * e,
        ...
        i.prototype.updateScrollLinks = function() {
            ...
            0 >= e ? (this.$scrollBackwardsLinks.addClass("disabled"),
            this.$scrollForwardsLinks.removeClass("disabled")) : (this.$scrollBackwardsLinks.removeClass("disabled"),
            i = this.themeLinksContainer[0].scrollWidth,
            t = i - this.themeLinksContainer.outerWidth(!0),
            e >= t ? this.$scrollForwardsLinks.addClass("disabled") : this.$scrollForwardsLinks.removeClass("disabled"))
        }
        ,
        ...
        i.prototype.scrollToTheme = function(e, t) {
            var i = void 0
              ...
              , a = void 0;
            return null == t && (t = !0),
            i = this.linkForTheme(e),
            a = this.themes.indexOf(e),
            r = i.outerWidth(!0),
            o = a * r,
            n = this.themeLinksContainer.scrollLeft(),
            s = n + this.themeLinksContainer.outerWidth(!0),
            n > o || o + r > s ? t ? this.themeLinksContainer.animate({
                scrollLeft: o
            }, 500) : this.themeLinksContainer.scrollLeft(o) : void 0
        }
        ,
        i.prototype.theme = function(e) {
            return null == e && (e = null ),
            e ? (this.selectedTheme = e,
            this.showPreviewFor(e),
            this.themeLinks.removeClass("selected"),
            this.linkForTheme(e).addClass("selected"),
            this.scrollToTheme(e),
            this.$miniPicker.find(".js-theme-name").text(e.name),
            !1) : this.selectedTheme
        }
        ,
...
function() {
    function e(e) {
        document.querySelector(".js-gist-dropzone").classList.remove("d-none"),
        e.stopPropagation(),
        e.preventDefault()
    }
    function t(e) {
    ...
    function i(e) {
        ...
        s = u.length; s > r; r++)
            ...
            ,
            n(o).then(t, i);
        document.querySelector(".js-gist-dropzone").classList.add("d-none"),
        e.stopPropagation(),
        e.preventDefault()
    }
    function n(e) {
    ...
    var o = require("github/observe")
      , r = o.observe
      , s = require("github/google-analytics")
      , a = s.trackEvent;
    r(".js-gist-dropzone", {
        add: function() {
            ...
            document.body.addEventListener("drop", i)
        },
        remove: function() {
            ...
            document.body.removeEventListener("drop", i)
        }
    })
}
.call(this),
function() {
    var e = require("github/jquery")["default"]
      ...
      , f = void 0
      , v = void 0;
    c = require("github/fetch").fetchJSON,
    u = function(e) {
        var t = void 0
          , i = void 0
          , n = void 0
          ...
          , l = void 0
          , d = void 0;
        for (n = e.querySelector(".js-gist-files"),
        d = document.getElementById("js-gist-file-template"),
        t = document.createElement("div"),
        t.innerHTML = d.textContent,
        c = t.querySelectorAll("[id]"),
        o = 0,
        s = c.length; s > o; o++)
            i = c[o],
            i.removeAttribute("id");
        for (u = t.querySelector(".js-code-textarea"),
        null != u && u.setAttribute("id", "blob_contents_" + Date.now()),
        l = t.children,
        r = 0,
        a = l.length; a > r; r++)
            i = l[r],
    ...
    v = function(e) {
        var t = void 0
          ...
          , r = void 0
          , s = void 0;
        for (r = e.querySelectorAll(".js-gist-file"),
        n = 0,
        o = r.length; o > n; n++)
            if (t = r[n],
            i = t.querySelector(".js-gist-filename"),
            s = t.querySelector(".js-blob-contents"),
            !i.value && !s.value)
                return t;
        return u(e)
    }
    ...
    f = function(t) {
        var i = void 0;
        return i = t.closest(".js-code-editor"),
    ...
    a = function(e) {
        var t = void 0
          ...
          , n = void 0
          , o = void 0;
        for (n = e.querySelectorAll(".js-code-textarea"),
        t = 0,
        i = n.length; i > t; t++)
            if (o = n[t],
    ...
    d = function() {
        var e = void 0
          ...
          , n = void 0
          , o = void 0;
        for (n = document.querySelectorAll(".js-gist-create"),
        o = [],
        t = 0,
        i = n.length; i > t; t++)
            e = n[t],
            o.push(e.disabled = !a(e.form));
        return o
    }
    ,
    ...
    l = function() {
        var e = void 0
          , t = void 0;
        return t = this,
        (e = t.getAttribute("data-language-detection-url")) ? c(e + "?filename=" + encodeURIComponent(t.value)).then(function(e) {
    ...
    e(document).on("gist:filedrop", ".js-blob-form", function(e) {
        var t = void 0
          ...
          , o = void 0
          , r = void 0;
        return o = e.originalEvent.detail,
        t = o.file,
        r = o.text,
        i = v(this),
        n = i.querySelector(".js-gist-filename"),
        n.value = t.name,
        l.call(n),
        f(n).then(function(e) {
            return e.setCode(r)
    ...
    e(document).on("click", ".js-remove-gist-file", function() {
        var e = void 0
          ...
          , n = void 0
          , o = void 0;
        for (e = this.closest(".js-gist-file"),
        o = e.querySelectorAll(".js-gist-deleted input"),
        t = 0,
        n = o.length; n > t; t++)
            i = o[t],
            i.disabled = !1;
    ...
    h = function(e) {
        var t = void 0
          ...
          , o = void 0
          , r = void 0;
        for (i = e.querySelectorAll(".js-remove-gist-file"),
        r = [],
        n = 0,
        o = i.length; o > n; n++)
            t = i[n],
            r.push(t.classList.toggle("d-none", i.length < 2));
        return r
    }
    ,
...
function() {
    ...
    e(document).on("ajaxComplete", ".js-gist-file-update-container .js-comment-update", function(e, t) {
        var i = void 0;
        200 === t.status && (i = JSON.parse(t.responseText),
        this.action = i.url)
    })
}(),
function() {
...
function() {
    ...
    function t(t) {
        var i = t.target
          , n = parseInt(i.value, 10) || 0
          , o = i.getAttribute("data-price")
          , r = n * o
          , s = i.form
          , a = s.querySelector(".js-job-posting-credit-total-cost");
        a.textContent = e(r);
        var u = s.querySelector(".js-job-posting-units");
        u.textContent = "job credit" + (1 === n ? "" : "s")
    }
    var i = require("github/observe")
      , n = i.observe;
...
function() {
    ...
    function r(e) {
        for (var t = [], i = e.elements, n = 0; n < i.length; n++) {
            ...
            if ("_method" !== o.name && "" !== o.name) {
                var r = "INPUT" === o.tagName && "checkbox" === o.type
                  , s = r && o.checked;
    ...
    function s(e) {
        var t = e.target
          , i = t.parentNode.querySelector(".selected");
        if (i)
            i.classList.remove("selected"),
            t.classList.add("selected");
        else {
            var s = document.querySelector(".js-job-posting-form-tabs");
            s.querySelector(".selected.tabnav-tab").classList.remove("selected"),
            s.querySelector(".js-show-job-posting-preview").classList.add("selected")
        }
        window.scrollTo(0, 0);
        var a = t.form
        ...
        n(a, !0);
        for (var c = a.querySelectorAll(".js-job-posting-form-edit-section"), l = 0; l < c.length; l++)
            c[l].classList.add("d-none");
    ...
    function a(e) {
        var t = e.target
          , o = t.parentNode.querySelector(".selected");
...
function() {
    function e() {
        ...
        if ("undefined" != typeof e) {
            var t = e.value
              , n = b("input[type=text].js-job-search-prefix, select.js-job-search-prefix, input[type=hidden].js-job-search-prefix")
              , o = i(n, function(e, t) {
    ...
    function i(e, i) {
        return b.map(e, function(e) {
            var n = null ;
            if (b(e).is("[type=checkbox]"))
                n = b(e).prop("checked") ? "true" : "false";
            else {
    ...
    function n(e) {
        ...
        var n = e.closest(".js-suggester-container")
          , o = n.find('input[type="text"]:not(.js-applied-suggestions-value)')
          , r = n.find(".js-job-search-prefix")
          , s = e[0].getAttribute("data-search-prefix");
        null !== s && (i = s + t(i)),
        r.val(i).change(),
        null === s && o.val(e[0].getAttribute("data-value")).change(),
        e.closest(".js-suggester").empty().addClass("d-none"),
        o.focus()
    }
    function o(e) {
        var t = e[0].getAttribute("data-value")
          , i = e.closest(".js-suggester-container")
          , n = i.find(".js-job-search-prefix")
          , o = e[0].getAttribute("data-search-prefix");
        n.attr("data-search-prefix", o).attr("data-search-value", t).attr("name", "exact_location"),
        n.val(e[0].getAttribute("data-value")).change(),
        e.closest(".js-suggester").empty().addClass("d-none"),
        n.focus()
    }
    function r(e) {
        var t = e[0].getAttribute("data-geonameid")
          , i = e.closest(".js-suggester-container")
          , n = i.find('input[type="text"]:not(.js-applied-suggestions-value)')
          , o = i.find(".applied-suggestions")
          , r = document.createElement("li");
        r.className = "applied-suggestion";
        var s = i.find(".js-applied-suggestions-value")
          , a = s[0].value
          , u = "";
    ...
    function a(e, t) {
        ...
        if (!(i.length < 1)) {
            var n = e.find(".js-navigation-item.navigation-focus")
              , o = null ;
            if (n.length > 0) {
                var r = n.next()
                  , s = n.prev();
                n.removeClass("navigation-focus"),
                o = 1 === t ? r.length > 0 ? r : i.first() : s.length > 0 ? s : i.last()
            } else
                o = 1 === t ? i.first() : i.last();
            o.addClass("navigation-focus")
        }
    }
    function u(e, t) {
        var i = e.closest(".js-suggester-container")[0]
          , n = i.querySelector(".js-suggester");
        n.innerHTML = t,
        n.querySelectorAll("li").length > 0 ? (n.classList.remove("d-none"),
        n.style.display = "block") : n.classList.add("d-none")
    }
    function c(e, t, i) {
        var n = e[0].value.trim()
          , o = e.closest(".js-suggester-container")
          , r = o[0].querySelector(".octospinner");
        if (o.find(".js-suggester").empty(),
        !(n.length < 1)) {
            r.classList.remove("d-none");
            var s = t.indexOf("?") > -1 ? "&" : "?";
            t += s + "q=" + i(n),
    ...
    function f(e, t, i, n) {
        var o = b(t.target)
          , r = o.closest(".js-suggester-container")
          , s = r.find(".js-suggester");
        if (q[e] && clearTimeout(q[e]),
        38 === t.keyCode)
            return void a(s, -1);
        if (40 === t.keyCode)
            return void a(s, 1);
        if (9 === t.keyCode) {
            ...
            return void (u.length > 0 ? (t.preventDefault(),
            n(u)) : h(s[0]))
        }
        if (27 === t.keyCode)
            return void h(s[0]);
        if (13 === t.keyCode) {
            ...
            return void (c.length > 0 && (t.preventDefault(),
            n(c)))
        }
    ...
    function v(e) {
        ...
        null !== i && i.classList.remove("navigation-focus"),
    ...
    function p(e) {
        var t = e.target;
        t.classList.contains("js-navigation-item") || (t = t.closest(".js-navigation-item"));
        var i = t.getAttribute("data-search-prefix")
          , s = t.closest(".js-suggester")
          , a = s.classList.contains("js-job-search-suggester-with-list");
        "title:" === i ? n(b(t)) : a ? r(b(t)) : o(b(t))
    }
    function g(e) {
        e.preventDefault();
        var t = b(e.target)
          , i = t[0].getAttribute("data-value")
          , n = t.closest(".js-suggester-container")
          , o = n[0].querySelector(".js-applied-suggestions-value")
          , r = o.value.split(",")
          , s = r.indexOf(i);
        s > -1 && r.splice(s, 1),
        o.value = r.join(",");
        ...
        t.closest("li").remove(),
        a.querySelectorAll("li").length < 1 && a.classList.add("d-none")
    }
    ...
    b(document).on("ajaxSuccess", ".js-job-search-unwatch", function(e) {
        var t = b(e.target)
          , i = t.closest(".menu");
        t.closest(".menu-item").remove(),
        i.find(".menu-item").length < 1 && (b(".search-job-postings-watched, .js-job-search-watch").removeClass("d-none"),
        b(".js-watched-orgs").addClass("d-none"))
    }),
    ...
    b(document).on("ajaxSuccess", ".js-job-search-watch", function(e, t, i, n) {
        b(".js-job-search-watch")[0].classList.add("d-none"),
        b(".js-job-search-watches").empty().append(b(n))
    }),
    b(document).on("ajaxSuccess", ".js-org-job-search-watch", function(e, t, i, n) {
        b(".js-org-job-search-watch")[0].classList.add("d-none"),
        b(".js-org-job-search-unwatch").removeClass("d-none"),
    ...
    q.jobTitle = null ,
    q.jobLocation = null ,
    j(".js-job-search-input", function() {
        this.addEventListener("keydown", function(e) {
            f("jobTitle", e, l, n)
        })
    }),
    j(".js-job-search-suggester .js-navigation-item", function() {
        this.addEventListener("mouseover", v),
        this.addEventListener("mouseout", m),
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , i = require("github/throttled-input")
      , n = i.addThrottledInputEventListener
      , o = require("github/facebox")["default"]
      , r = void 0
      , s = void 0
      , a = void 0
      , u = void 0
    ...
    a = d.fetch,
    u = d.fetchText,
    c = require("delegated-events").fire,
    l = require("github/observe").observe,
    r = {
        ...
        isValidHttpUrl: function(e) {
            ...
            null == n ? !1 : (t = /^https?/.test(n.protocol),
            i = n.href === e || n.href === e + "/",
            t && i)
        }
    },
    l(".js-hook-url-field", function(t) {
        ...
        o = function(t) {
            var i = void 0
              , n = void 0;
            return i = e(t).closest("form"),
            n = /^https:\/\/.+/.test(t.val()),
            i.toggleClass("is-ssl", n)
        }
        ,
        s = function(e) {
            var t = void 0
              , i = void 0;
            return t = e.val(),
            i = r.isHttpFragment(t) || r.isValidHttpUrl(t),
            e.closest("form").toggleClass("is-invalid-url", !i)
        }
        ,
        i.on("keyup", function() {
            return o(i)
    ...
    e(document).on("click", ".js-hook-toggle-ssl-verification", function(t) {
        ...
        e(".js-ssl-hook-fields").toggleClass("is-not-verifying-ssl"),
        e(".js-ssl-hook-fields").hasClass("is-not-verifying-ssl") ? (e(".js-hook-ssl-verification-field").val("1"),
        c(document, "facebox:close")) : e(".js-hook-ssl-verification-field").val("0")
    }),
    s = function(t) {
        var i = void 0;
        return i = e(".js-hook-event-checkbox"),
        i.prop("checked", !1),
        null != t ? i.filter(t).prop("checked", !0) : void 0
    }
    ,
    e(document).on("change", ".js-hook-event-choice", function() {
        var t = void 0;
        return t = "custom" === e(this).val(),
        e(".js-hook-events-field").toggleClass("is-custom", t),
        !0
    }),
    e(document).on("submit", ".js-hook-form", function() {
        var t = void 0
          , i = void 0;
        return t = e(this),
        i = t.find(".js-hook-event-choice:checked").val(),
        "custom" === i && e(".js-hook-wildcard-event").prop("checked", !1),
        "push" === i && s('[value="push"]'),
        "all" === i && s(".js-hook-wildcard-event"),
        !0
    }),
    e(document).on("details:toggled", ".js-hook-secret", function() {
        var t = void 0
          , i = void 0;
        return t = e(this),
        i = t.find("input[type=password]"),
        t.hasClass("open") ? i.removeAttr("disabled").focus() : i.attr("disabled", "disabled")
    }),
    e(document).on("details:toggled", ".js-hook-delivery-item", function() {
        var i = void 0
          , n = void 0;
        return i = e(this),
        n = this.querySelector(".js-hook-delivery-details"),
        i.data("details-load-initiated") ? void 0 : t().then(function() {
            var t = void 0
              , o = void 0;
            return i.data("details-load-initiated", !0),
            n.classList.add("is-loading"),
            t = function(t) {
                return e(n).replaceWith(t),
                n.classList.remove("is-loading")
            }
            ,
            o = function() {
                return n.classList.add("has-error"),
                n.classList.remove("is-loading")
            }
            ,
    ...
    e(document).on("click", ".js-hook-delivery-details .js-tabnav-tab", function() {
        var t = void 0
          ...
          , n = void 0;
        return i = e(this),
        t = i.closest(".js-hook-delivery-details"),
    ...
    e(document).on("click", ".js-hook-deliveries-pagination-button", function(i) {
        ...
        t().then(function() {
            ...
            u(o.getAttribute("href")).then(function(e) {
    ...
    e(document).on("ajaxSuccess", ".js-redeliver-hook-form", function(t, i) {
        var n = void 0
          ...
          , r = void 0
          , s = void 0;
        return s = this.getAttribute("data-delivery-guid"),
        n = e(".js-hook-delivery-details").filter(function() {
            return this.getAttribute("data-delivery-guid") === s
        }),
        r = n.closest(".js-hook-delivery-item"),
        c(document, "facebox:close"),
        o = e(i.responseText),
        n.replaceWith(o),
        o.on("load", function() {
            return n = r.find(".js-hook-delivery-details"),
            r.find(".js-item-status").removeClass("success pending failure").addClass(n.attr("data-status-class")),
            r.find(".js-item-status-tooltip").attr("aria-label", n.attr("data-status-message"))
        })
    }),
    ...
    e(document).on("submit", ".js-test-hook-form", function(i) {
        ...
        t().then(function() {
            var t = void 0
              ...
              , o = void 0
              , r = void 0;
            return r = document.querySelector(".js-test-hook-message"),
            ...
            o = function(e) {
                ...
                t = r.querySelector(".js-test-hook-message-errors"),
    ...
    h = function() {
        ...
        o = n.find(".js-value"),
        t = n.closest("form"),
        i = t.find(".js-enforcement-value")[0],
        i.value = o.text().split("_")[0],
        r = t.find(".js-final-value")[0],
        "undefined" != typeof r && (o.text().split("_")[1] ? r.value = !1 : r.value = !0),
        t.submit()
    }
    ,
...
function() {
    ...
    t(".js-integration-permissions-selector", function() {
        e("[id^=integration_permission_]").on("change", function() {
            var t = this.getAttribute("data-permission")
              , i = this.getAttribute("data-resource")
              , n = Array.from(document.querySelectorAll(".js-integration-" + i + "-hook-event"));
            "none" !== t ? (e(".js-integration-hook-" + i + "-event-permission-error").addClass("d-none"),
            n.forEach(function(e) {
                return e.readOnly = !1
            }),
            this.closest(".js-list-group-item").classList.remove("disabled")) : (this.closest(".js-list-group-item").classList.add("disabled"),
            n.forEach(function(e) {
                e.readOnly = !0,
                e.checked = !1
            }))
        ...
        e(".js-integration-hook-event").on("click", function() {
            return this.readOnly === !0 ? (e(this.closest(".js-send-events")).find(".js-integration-hook-event-permission-error").removeClass("d-none"),
            !1) : void 0
        })
    })
}
...
function() {
    ...
    e(document).on("navigation:open", ".js-issues-custom-filter", function() {
        var t = void 0
          ...
          , o = void 0;
        return i = e(this),
        o = i.find(".js-new-item-name").text(),
        n = i.attr("data-name"),
        t = e("<input>", {
            type: "hidden",
            name: n,
...
function() {
    function e() {
        var e = t(this)
          , i = t(this).closest(".js-label-editor");
        "#" !== e.val().charAt(0) && e.val("#" + e.val()),
        i.removeClass("is-valid is-not-valid");
        var n = /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(e.val());
        n ? (i.addClass("is-valid"),
        u(e, e.val())) : (i.addClass("is-not-valid"),
        c(e))
    }
    var t = require("github/jquery")["default"]
      ...
      , c = void 0;
    u = function(e, t) {
        return e.closest(".js-label-editor").find(".js-color-editor-bg").css("background-color", t),
        e.css("color", a(t, -.5)),
    ...
    c = function(e) {
        var i = void 0
          , n = void 0;
        return n = "#c00",
        i = t(e).closest(".js-color-editor"),
        i.find(".js-color-editor-bg").css("background-color", n),
        e.css("color", "#c00"),
    ...
    a = function(e, t) {
        var i = void 0
          , n = void 0
          , o = void 0;
        for (e = String(e).toLowerCase().replace(/[^0-9a-f]/g, ""),
    ...
    t(document).on("mousedown", ".js-color-chooser-color", function() {
        var e = void 0
          , i = void 0
          , n = void 0;
        return t(this).closest(".js-color-editor").removeClass("open"),
        e = t(this).closest(".js-label-editor"),
        i = "#" + t(this).attr("data-hex-color"),
    ...
    t(document).on("submit", ".js-label-editor form", function() {
        var e = void 0
          , i = void 0;
        return e = t(this).find(".js-color-editor-input"),
        i = e.val(),
        i.length < 6 && (i = i[1] + i[1] + i[2] + i[2] + i[3] + i[3]),
        e.val(i.replace("#", ""))
    }),
    ...
    t(document).on("reset", ".js-create-label", function() {
        var e = void 0
          , n = void 0
          , o = void 0;
        return e = t(this).find(".color-chooser span").removeAttr("data-selected"),
        o = e.eq(Math.floor(Math.random() * e.length)),
        n = "#" + o.attr("data-selected", "").attr("data-hex-color"),
        i(function(e) {
            return function() {
                var i = void 0;
                return i = t(e).find(".js-color-editor-input"),
                i.attr("data-original-color", n).attr("value", n),
                u(i, i.val())
            }
        }(this))
    })
...
function() {
    ...
    function t(e) {
        ...
        i = n + e,
        t.textContent = s(i),
        o(i, document.querySelector(".js-labels-label")),
        i
    }
    var i = require("github/jquery")["default"]
      , n = require("github/inflector")
      , o = n.pluralizeNode
      , r = require("github/number-helpers")
      , s = r.formatNumber
      , a = r.parseFormattedNumber;
    ...
    i(document).on("click", ".js-edit-label-cancel", function() {
        this.form.reset(),
        i(this).closest(".labels-list-item").removeClass("edit")
    }),
    i(document).on("ajaxSuccess", ".js-create-label", function(n, o, r, s) {
        this.reset(),
        i(this).nextAll(".table-list").prepend(s),
        t(1),
        e(this, !1)
    }),
    ...
    i(document).on("ajaxError", ".js-update-label, .js-create-label", function(e, t) {
        return i(this).find(".error").text(t.responseText),
        !1
    }),
    i(document).on("ajaxSuccess", ".js-delete-label", function() {
        ...
        n = t(-1),
        e(this, 0 === n),
        i(this).closest(".labels-list-item").fadeOut()
    })
}
.call(this),
function() {
    ...
    e(function(e) {
        ...
        return n ? (t = n[1],
        window.location = i.replace(/\/?#issue\/.+/, "/" + t)) : void 0
    }),
    e(function(e) {
        var t = void 0
          , i = void 0
        ...
        return o ? (i = o[1],
        t = o[2],
        window.location = n.replace(/\/?#issue\/.+/, "/" + i + "#issuecomment-" + t)) : void 0
    })
}
.call(this),
function() {
...
function() {
    ...
    e(document).on("selectmenu:selected", ".js-issue-sidebar-form", function(t) {
        var i = void 0
          , o = void 0
          , r = void 0
          , s = void 0
        ...
        if (u = d.hasAttribute("data-multiple"),
        !r.hasAttribute("data-clear-assignees")) {
            if (u) {
                var h = d.getAttribute("data-max-options");
                if (h) {
                    var f = Number(h)
                      , v = d.querySelectorAll('input[type="checkbox"]:checked').length
                      , m = v > f;
                    d.querySelector(".js-max-warning").classList.toggle("d-none", !m)
                }
                return e(this).off(".deferredSubmit"),
                e(this).one("menu:deactivate.deferredSubmit", l)
            }
            return l()
        }
        for (a = r.closest(".js-menu-content"),
        c = a.querySelectorAll('input[name="issue[user_assignee_ids][]"]:checked'),
        o = 0,
        s = c.length; s > o; o++)
            i = c[o],
            i.disabled = !1,
    ...
    e(document).on("ajaxSuccess", ".js-discussion-sidebar-item", function(e, t, i, n) {
        ...
        o.contains("js-issue-sidebar-form") && r(this, n)
    }),
    ...
    o = function(t) {
        var n = void 0
          ...
          , a = void 0
          , u = void 0;
        for (n = t.closest("form"),
        a = e(n).serializeArray(),
        u = [],
        o = 0,
        r = a.length; r > o; o++)
            s = a[o],
            e.contains(t, i(n, s)) && u.push(s);
        return u
    }
    ,
    i = function(e, t) {
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/menu").deactivate
      , i = void 0
      , n = void 0
      , o = void 0
      , r = void 0;
    ...
    e(document).on("change", ".js-issues-list-check", function() {
        for (var e = document.querySelectorAll(".js-issues-list-check:checked"), t = Array.from(e).map(function(e) {
            ...
            var o = i[n];
            a(o, t),
            o.classList.add("js-load-contents")
        }
    }),
    e(document).on("selectmenu:selected", ".js-issues-toolbar-triage .js-navigation-item", function() {
        var i = void 0
          ...
          , s = void 0
          , a = void 0
          , u = this.closest(".js-menu-container").hasAttribute("data-submits-hash");
        i = e(this).closest("form"),
        s = e(this).hasClass("selected"),
        ...
        i.find(".js-issues-triage-fields").append(n),
        i.addClass("will-submit")
    }),
    e(document).on("menu:deactivate", ".js-issues-toolbar-triage .js-menu-container", function(o) {
        var r = void 0
          , s = void 0;
        (r = this.querySelector("form.will-submit")) && (this.classList.add("is-loading"),
        s = i(r.getAttribute("action"), {
        ...
        s.then(function(e) {
            return function(i) {
                var o = void 0
                  , r = void 0
                  , s = void 0;
                return s = n(i.job.url, {
                    headers: {
                        accept: "application/json"
                    }
                }),
                o = function() {
                    return t(e.closest(".js-menu-container")),
                    location.reload()
                }
                ,
                r = function() {
        ...
        r.classList.remove("will-submit"),
        o.preventDefault())
    })
}
.call(this),
define("github/date-input", ["exports", "./jquery"], function(e, t) {
    ...
    function n(e, t) {
        "object" != typeof t && (t = {}),
        o["default"].extend(this, n.DEFAULT_OPTS, t),
        this.input = o["default"](e),
    ...
    n.prototype = {
        build: function() {
            ...
            this.monthNameSpan = o["default"](".month-name", e),
            o["default"](".prev", e).click(this.bindToObj(function() {
                this.moveMonthBy(-1)
            })),
            ...
            this.yearNameSpan = o["default"](".year-name", t),
            o["default"](".prev", t).click(this.bindToObj(function() {
                this.moveMonthBy(-12)
            })),
            o["default"](".next", t).click(this.bindToObj(function() {
                this.moveMonthBy(12)
            }));
            var i = o["default"]("<div></div>").append(e, t)
              , n = "<table><thead><tr>";
            o["default"](this.adjustDays(this.short_day_names)).each(function() {
                n += "<th>" + this + "</th>"
            }),
            n += "</tr></thead><tbody></tbody></table>",
            this.dateSelector = this.rootLayers = o["default"]('<div class="date-selector"></div>').append(i, n).insertAfter(this.input),
            this.tbody = o["default"]("tbody", this.dateSelector),
        ...
        selectMonth: function(e) {
            ...
            if (!this.currentMonth || this.currentMonth.getFullYear() != t.getFullYear() || this.currentMonth.getMonth() != t.getMonth()) {
                ...
                for (var i = this.rangeStart(e), n = this.rangeEnd(e), r = this.daysBetween(i, n), s = "", a = 0; r >= a; a++) {
                    ...
                    this.isFirstDayOfWeek(u) && (s += "<tr>"),
                    s += u.getMonth() == e.getMonth() ? '<td class="selectable-day" date="' + this.dateToString(u) + '">' + u.getDate() + "</td>" : '<td class="unselected-month" date="' + this.dateToString(u) + '">' + u.getDate() + "</td>",
                    this.isLastDayOfWeek(u) && (s += "</tr>")
                }
                this.tbody.empty().append(s),
                this.monthNameSpan.empty().append(this.monthName(e)),
                this.yearNameSpan.empty().append(this.currentMonth.getFullYear()),
                o["default"](".selectable-day", this.tbody).mousedown(this.bindToObj(function(e) {
                    this.changeInput(o["default"](e.target).attr("date"))
                })),
                o["default"]("td[date='" + this.dateToString(new Date) + "']", this.tbody).addClass("today"),
                o["default"]("td.selectable-day", this.tbody).mouseover(function() {
            ...
            o["default"](".selected", this.tbody).removeClass("selected"),
            o["default"]('td[date="' + this.selectedDateString + '"]', this.tbody).addClass("selected")
        },
        ...
        show: function() {
            ...
            o["default"]([window, document.body]).click(this.hideIfClickOutside),
        ...
        bindMethodsToObj: function() {
            for (var e = 0; e < arguments.length; e++)
                this[arguments[e]] = this.bindToObj(this[arguments[e]])
        },
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , i = require("github/has-interactions")
      , n = i.hasDirtyFields
      , o = require("github/observe")
      , r = o.observe;
...
function() {
    function e(e) {
        return e.classList.contains("read") ? void 0 : (e.classList.toggle("unread"),
    ...
    t(document).on("ajaxSuccess", ".js-mark-visible-as-read", function() {
        var e = void 0
          ...
          , r = void 0
          , s = void 0;
        for (e = this.closest(".js-notifications-browser"),
        o = e.querySelectorAll(".unread"),
        i = 0,
        n = o.length; n > i; i++)
            t = o[i],
            t.classList.remove("unread"),
            t.classList.add("read");
        return null != (r = e.querySelector(".js-mark-visible-as-read")) && r.classList.add("mark-all-as-read-confirmed"),
        null != (s = e.querySelector(".js-mark-as-read-confirmation")) ? s.classList.add("mark-all-as-read-confirmed") : void 0
    }),
    t(document).on("ajaxSuccess", ".js-mark-remaining-as-read", function() {
        ...
        null != (t = e.querySelector(".js-mark-remaining-as-read")) && t.classList.add("d-none"),
        null != (i = e.querySelector(".js-mark-remaining-as-read-confirmation")) ? i.classList.remove("d-none") : void 0
    }),
...
function() {
    ...
    var t = require("github/jquery")["default"]
      , i = require("github/updatable-content")
      , n = i.replaceContent;
    t(document).on("ajaxSend", ".js-setting-toggle", function() {
        e(),
        t(this).find(".js-status-indicator").addClass("status-indicator-loading")
    }),
    t(document).on("ajaxError", ".js-setting-toggle", function() {
        e(),
        t(this).find(".js-status-indicator").addClass("status-indicator-failed")
    }),
    t(document).on("ajaxSuccess", ".js-setting-toggle", function() {
        e(),
        t(this).find(".js-status-indicator").addClass("status-indicator-success")
    }),
    ...
    t(document).on("ajaxError", ".js-unignore-form, .js-ignore-form", function() {
        t(this).closest(".js-subscription-row").removeClass("loading"),
        t(this).find(".btn-sm").addClass("btn-danger").attr("title", "There was a problem unignoring this repo.")
    }),
    ...
    t(document).on("ajaxError", ".js-unsubscribe-form, .js-subscribe-form", function() {
        t(this).closest(".js-subscription-row").removeClass("loading"),
        t(this).find(".btn-sm").addClass("btn-danger").attr("title", "There was a problem with unsubscribing :(")
    }),
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , s = void 0
      , a = void 0;
    i = require("delegated-events").fire,
    r = require("github/observe").observe,
    ...
    e(document).on("ajaxSuccess", ".js-toggler-container .js-set-approval-state", function(e, t, i, n) {
        if (1 === n.approval_state)
            this.closest(".js-toggler-container").classList.add("on");
        else if (2 === n.approval_state) {
            var o = this.closest(".js-toggler-container");
            o.classList.add("revoked"),
    ...
    n = function(e) {
        var i = void 0;
        return i = e.querySelector(".js-all-repositories-radio"),
        i.checked || t(e)
    }
    ,
    a = function() {
    ...
    r(".js-integrations-install-form", function() {
        var t = void 0
          ...
          , c = void 0;
        u = this,
        s = u.querySelector(".js-integrations-install-form-submit"),
        t = u.querySelector(".js-autocomplete"),
        r = t.getAttribute("data-search-url"),
        i = u.querySelector(".js-autocomplete-field"),
        c = function() {
            return s.disabled = !n(this),
            null !== u.querySelector(".flash") ? (i.disabled = o(this),
            u.querySelector(".flash").classList.toggle("d-none", !o(this))) : void 0
        }
        ,
        this.addEventListener("change", c),
        c.call(this),
        e(document).on("click", ".js-repository-picker-remove", function() {
            var e = void 0;
            return e = this.closest(".js-repository-picker-result"),
            e.remove(),
            0 === document.querySelector(".js-integrations-install-repo-picked").children.length && document.querySelector(".js-min-repository-error").classList.remove("d-none"),
            a(),
            c.call(u)
        }),
        ...
        e(document).on("autocomplete:autocompleted:changed", ".js-integrations-install-repo-picker", function() {
            var e = void 0
              ...
              , s = void 0;
            for (s = r,
            o = document.querySelectorAll(".js-integrations-install-repo-picked .js-selected-repository-field"),
            i = 0,
            n = o.length; n > i; i++)
                e = o[i],
                s += ~s.indexOf("?") ? "&" : "?",
        ...
        e(document).on("autocomplete:result", ".js-integrations-install-repo-picker", function(e, t) {
            var n = this.querySelector("#repo-result-" + t)
              , o = u.querySelector(".js-integrations-install-repo-picked");
            return n.classList.remove("d-none"),
            o.insertBefore(n, o.firstChild),
            i.value = "",
            u.querySelector(".js-autocomplete-results").innerHTML = "",
            document.querySelector(".js-min-repository-error").classList.add("d-none"),
            a(),
            c.call(u)
        }),
        e(document).on("click", ".js-all-repositories-radio", function() {
            document.querySelector(".js-integrations-install-repo-picked, .js-min-repository-error").classList.add("d-none"),
            a()
        }),
        e(document).on("click", ".js-select-repositories-radio", function() {
            document.querySelector(".js-integrations-install-repo-picked").classList.remove("d-none"),
            a()
        }),
...
function() {
    ...
    var t = require("delegated-events")
      ...
      , n = require("github/observe")
      , o = n.observe;
    i("change", ".js-org-reinstate-option", e),
    o(".js-org-reinstate-forms", e)
}
.call(this),
define("github/org-sidebar-stats", ["exports", "./inflector"], function(e, t) {
    function i(e, i) {
        var n = arguments.length <= 2 || void 0 === arguments[2] ? 0 : arguments[2]
          , o = e.querySelector("." + i)
          , r = o.parentNode.querySelector(".js-stat-label");
        o.textContent = n,
        t.pluralizeNode(n, r)
    }
    Object.defineProperty(e, "__esModule", {
...
function() {
    ...
    var t = require("github/jquery")["default"]
      , i = require("github/sudo")["default"]
      , n = require("github/fetch")
      , o = n.fetchText
      , r = require("delegated-events")
      , s = r.on
      , a = require("github/org-sidebar-stats")
      , u = a.updateStat
      , c = require("github/setimmediate")["default"]
      , l = require("github/focused")
      , d = l.onFocusedKeydown
      , h = require("github/throttled-input")
      , f = h.dispatchThrottledInputEvent
      , v = require("github/facebox")["default"];
    s("click", ".js-member-remove-confirm-button", function(t) {
        t.preventDefault();
        var i = new URL(this.getAttribute("data-url"),window.location.origin)
          , n = new URLSearchParams(i.search.slice(1))
          , r = this.getAttribute("data-member-id");
        if (r)
            n.append("member_ids[]", r);
        else
    ...
    s("click", ".js-member-search-filter", function(e) {
        ...
        var t = this.getAttribute("data-filter")
          ...
          , n = document.querySelector(".js-member-filter-field")
          , o = n.value
          , r = new RegExp(i + ":[a-z]+")
          , s = o.toString().trim().replace(r, "");
        n.value = (s + " " + t).replace(/\s\s/, " "),
        n.focus(),
        f(n)
    }),
    ...
    t(document).on("autocomplete:result", ".js-bulk-add-team-form .js-autocomplete-field", function(e) {
        var n = this
          , r = t(this).data("autocompleted");
        r.indexOf("/") > 0 && !function() {
            var t = n.form.action
              , r = n.form.method
              , s = new FormData(n.form);
            i().then(function() {
                v(function() {
                    o(t, {
                        method: r,
    ...
    t(document).on("ajaxSuccess", ".js-add-team-member-or-repo-form", function(e, i) {
        ...
        d ? (n = t(d.list_item_html),
        d.stat_count_class && null != d.item_count && u(document.body, d.stat_count_class, d.item_count)) : n = t(i.responseText),
        o = t(".js-member-list"),
        ...
        if (f)
            ...
            a = l.length; a > r; r++)
                if (s = l[r],
                s.getAttribute("data-login") === f)
                    return;
        return o.prepend(n),
        c = !o.children().length,
        o.closest(".js-org-section").toggleClass("is-empty", c),
        o.siblings(".js-subnav").addClass("subnav-bordered")
    }),
    t(document).on("ajaxSuccess", ".js-remove-team-repository", function(e, i) {
        var n = void 0
          ...
          , a = void 0;
        o = t(this),
        n = o.closest(".js-org-section"),
        r = n.find(".js-org-list"),
        o.closest(".js-org-repo").remove(),
        s = !r.children().length,
        n.toggleClass("is-empty", s),
        s && (r.removeClass("table-list-bordered"),
        r.siblings(".js-subnav").removeClass("subnav-bordered"));
        try {
    ...
    t(document).on("ajaxError", ".js-add-team-member-or-repo-form, .js-remove-team-repository", function(e, i) {
        ...
        if (!/<html/.test(i.responseText)) {
            ...
            return t(".flash-messages").remove(),
            o.before(n),
            !1
        }
    })
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("delegated-events")
      , i = t.on
      , n = require("github/facebox")["default"];
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , r = void 0
      , s = void 0;
    i = require("github/debounce")["default"],
    e(document).on("change", ".js-customize-member-privileges-default-repository-permission-radio", function() {
        var e = void 0;
    ...
    e(document).on("change", ".js-customize-member-privileges-repository-creation-radio", function() {
        ...
        e.classList.toggle("migrate-ability-not-possible", o()),
        s()
    }),
    ...
    s = function() {
        var e = void 0;
        return e = document.querySelector(".js-save-member-privileges-button-container"),
        e.classList.toggle("member-privilege-radios-preserved", t())
    }
    ,
    n = function() {
    ...
    e(function() {
        ...
        null != a ? (u = a.getBoundingClientRect(),
        c = 16,
        l = u.top + window.pageYOffset - c,
        t = a.style.position,
        n = a.style.top,
        e = a.style.left,
        o = a.style.width,
        r = i(function() {
            var i = void 0
              , r = void 0;
            return i = a.parentNode.getBoundingClientRect(),
            r = i.right - u.width,
            window.pageYOffset >= l ? (a.style.position = "fixed",
            a.style.top = c + "px",
            a.style.left = r + "px",
            a.style.width = "250px") : (a.style.position = t,
            a.style.top = n,
            a.style.left = e,
            a.style.width = o)
        }, 5),
...
function() {
    ...
    t = require("github/observe").observe;
    var n = require("github/throttled-input")
      , o = n.addThrottledInputEventListener;
    t(".js-rename-owners-team-input", function() {
        o(this, function() {
            ...
            "owners" === n || "" === n ? i(!1, "") : (t.classList.add("is-sending"),
            r = new URL(this.getAttribute("data-check-url"),window.location.origin),
            o = new URLSearchParams(r.search.slice(1)),
            o.append("name", n),
            r.search = o.toString(),
            e(r.toString()).then(function(e) {
                var n = void 0;
                return e = e.trim(),
                n = "" === e,
    ...
    i = function(e, t) {
        ...
        document.querySelector(".js-rename-owners-team-note").classList.toggle("d-none", "" !== t)
    }
}
.call(this),
function() {
...
function() {
    ...
    e(document).on("click", ".js-org-billing-plans .js-choose-plan", function() {
        return t(e(this).closest(".js-plan-row")),
        !1
    }),
    t = function(t) {
        var n = void 0
          ...
          , s = void 0;
        return r = t.attr("data-name"),
        o = parseInt(t.attr("data-cost"), 10),
        n = parseInt(null != (s = t.attr("data-balance")) ? s : "0", 10),
        e(".js-org-billing-plans").find(".js-plan-row, .js-choose-plan").removeClass("selected"),
        t.find(".js-choose-plan").addClass("selected"),
        t.addClass("selected"),
        e(".js-plan").val(r),
        0 === o && 0 === n ? e(".js-billing-section").addClass("has-removed-contents") : (e(".js-billing-section").removeClass("has-removed-contents"),
        null != t.attr("data-balance") ? i(r) : void 0)
    }
    ,
    i = function(t) {
        return e(".js-plan-change-message").addClass("d-none"),
        e('.js-plan-change-message[data-name="' + t + '"]').removeClass("d-none")
    }
    ,
    e(function() {
...
function() {
    ...
    t = function(t) {
        ...
        for (o in n)
            r = n[o],
            e(o).text(r);
        return i = 100 === t.filled_seats_percent,
        e(".js-live-update-seats-percent").css("width", t.filled_seats_percent + "%"),
        e(".js-need-more-seats").toggleClass("d-none", !i),
        e(".js-add-team-member-or-repo-form").toggleClass("d-none", i)
    }
    ,
...
function() {
    var e = require("delegated-events")
      ...
      , r = require("github/observe")
      , s = r.observe
      , a = require("github/throttled-input")
      , u = a.dispatchThrottledInputEvent
      , c = require("github/facebox")["default"];
    t("click", ".js-repo-search-filter", function() {
        var e = this.getAttribute("data-filter")
          , t = this.getAttribute("data-negate")
          , i = document.querySelector(".js-repo-filter-field")
          , n = i.value;
        if (n.indexOf(t) > -1 && (n = n.replace(t, ""),
        n = n.replace(/^\s*/, "")),
        -1 === n.indexOf(e)) {
            var o = n && n.match(/\s$/) ? "" : " ";
            i.value = "" + n + o + e + " ",
...
function() {
    ...
    e(document).on("ajaxSuccess", ".js-select-repo-permission", function(e, t, i, n) {
        ...
        null != (o = this.closest(".js-org-repo")) ? o.classList.toggle("with-higher-access", n.members_with_higher_access) : void 0
    })
}(),
function() {
    var e = require("github/observe")
      , t = e.observe
      , i = require("github/facebox")["default"];
    t(".js-two-factor-needs-enforced", function() {
        this.addEventListener("submit", function(e) {
            var t = e.target
              , n = t.querySelector("input[type=checkbox]");
            n.checked && (e.preventDefault(),
            i({
...
function() {
    ...
    e(document).on("click", ".js-team-remove-user", function(t) {
        var i = void 0;
        t.preventDefault(),
        e(".js-team-add-user-form").removeClass("d-none"),
        e(".js-team-add-user-name").focus(),
        i = e(this).closest("li").remove(),
        i.attr("data-login")
    }),
    e(document).on("click", ".js-team-add-user-button", function(i) {
        var n = void 0
          ...
          , u = void 0;
        if (i.preventDefault(),
        o = e(".js-team-add-user-name"),
        u = o.val(),
        u && o.data("autocompleted")) {
            for (o.val(""),
            a = e(".js-team-user-logins li"),
            n = 0,
            r = a.length; r > n; n++)
                if (s = a[n],
                e(s).attr("data-login") === u)
                    return;
            return t().then(function() {
                return e.ajax({
                    ...
                    success: function(t) {
                        ...
                        e(".js-team-add-user-form").addClass("d-none")
                    }
                }),
                e(".js-team-add-user-name").focus()
            })
...
function() {
    ...
    t(document).on("autocomplete:autocompleted:changed", ".js-team-ldap-group-field", function() {
        var e = void 0;
        (e = this.closest(".js-ldap-group-adder")) && (e.classList.remove("is-exists"),
        e.querySelector(".js-ldap-group-adder-button").disabled = !t(this).data("autocompleted"))
    }),
    t(document).on("navigation:open", ".js-team-ldap-group-autocomplete-results .js-navigation-item", function() {
        ...
        i = t(this).attr("data-dn"),
        e.find(".js-team-ldap-dn-field").val(i),
        t(this).closest(".js-ldap-import-groups-container").find(".js-ldap-group-dn").map(function(n, o) {
            t(o).text() === i && (e.addClass("is-exists"),
            e[0].querySelector(".js-ldap-group-adder-button").disabled = !0)
        })
    }),
    ...
    t(document).on("ajaxSuccess", ".js-ldap-group-adder", function(e, i, n, o) {
        return t(this).closest(".js-ldap-import-groups-container").removeClass("is-empty").find(".js-ldap-imported-groups").prepend(t(o)),
        this.reset(),
        t(this).find(".js-team-ldap-group-field").focus(),
        this.querySelector(".js-ldap-group-adder-button").disabled = !0,
        t(".js-import-form-actions").removeClass("d-none")
    }),
    ...
    t(document).on("ajaxSuccess", ".js-team-remove-group", function() {
        ...
        document.querySelector(".js-team:not(.is-removing)") || (document.querySelector(".js-ldap-import-groups-container").classList.add("is-empty"),
        document.querySelector(".js-import-form-actions").classList.add("d-none"))
    }),
    ...
    t(document).on("click", ".js-edit-team", function(e) {
        return t(this).closest(".js-team").hasClass("is-removing") ? !1 : (e.preventDefault(),
        t(this).closest(".js-team").addClass("is-editing"),
        t(this).closest(".js-team").find(".js-team-name-field").focus())
    }),
    ...
    t(document).on("click", ".js-cancel-team-edit", function(e) {
        var i = void 0
          , n = void 0;
        return e.preventDefault(),
        n = t(this).closest(".js-team").removeClass("is-editing"),
        i = n.find(".js-team-form").removeClass("is-exists"),
        i.find(".js-slug").text(i.find(".js-slug").attr("data-original-slug")),
        i[0].reset()
    }),
    ...
    t(document).on("ajaxSuccess", ".js-team-form.is-checking", function(e, i, n, o) {
        var r = void 0
          , s = void 0;
        return r = t(this).removeClass("is-checking"),
        "function" == typeof (s = r.find(".js-team-name-field")).removeData && s.removeData("autocheck-xhr"),
        o.error ? (r.find(".js-save-button").addClass("disabled"),
        "exists" === o.error ? (r.addClass("is-exists"),
        r.find(".js-slug").html(o.slug)) : void 0) : (r.find(".js-slug").html(o.slug),
        r.find(".js-save-button").removeClass("disabled"))
    }),
    ...
    e(".js-team-name-field", function() {
        n(this, function() {
            var e = void 0
              ...
              , o = void 0;
            return i = t(this),
            e = i.closest(".js-team-form"),
            null != (n = i.data("autocheck-xhr")) && n.abort(),
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/throttled-input")
      , i = t.dispatchThrottledInputEvent;
...
function() {
    var e = void 0
      ...
      , i = void 0;
    t = require("github/fetch").fetchText,
    i = require("github/observe").observe;
    var n = require("github/throttled-input")
      , o = n.addThrottledInputEventListener;
    e = function(e) {
        var i = void 0
        ...
        o = e.value.trim(),
        i = e.form,
        i.classList.add("is-sending"),
        i.classList.remove("is-name-check-fail"),
        i.classList.remove("is-name-check-success"),
        r = new URL(e.getAttribute("data-check-url"),window.location.origin),
        n = new URLSearchParams(r.search.slice(1)),
        n.append("name", o),
        r.search = n.toString(),
        t(r.toString()).then(function(t) {
            var n = void 0
              , r = void 0
              , s = void 0
              , a = void 0
              , u = void 0;
            return i.classList.remove("is-sending"),
            i.querySelector(".js-team-name-errors").innerHTML = t || "",
            s = null != (a = e.getAttribute("data-original")) ? a.trim() : void 0,
            r = s && o === s,
            n = !!i.querySelector(".js-error"),
            u = (n || !o) && !r,
            i.querySelector(".js-create-team-button").disabled = u,
            i.classList.toggle("is-name-check-fail", n),
            i.classList.toggle("is-name-check-success", !n && o)
        })
    }
    ,
...
function() {
    ...
    e(document).on("ajaxComplete", ".js-team-description-form", function() {
        var t = void 0;
        return t = e(".js-team-description-field").val(),
        e(".js-description-toggler").toggleClass("on"),
        t.trim() ? e(".js-team-description .description").text(t) : e(".js-team-description .description").html("<span class='link'>This team has no description</span>")
    }),
    e(document).on("ajaxSuccess", ".js-add-team-members-form", function(t, i) {
        var o = void 0;
        return o = e(document).find(".js-member-listings-container"),
        n(document, "facebox:close"),
        o.html(i.responseText)
    }),
    ...
    e(function() {
        ...
        return e("#load-readme").click(function() {
            var i = void 0
              ...
              , s = void 0
              , a = void 0;
            return n = e("#gollum-editor-body"),
            i = e("#editor-body-buffer"),
            r = e("#undo-load-readme"),
            a = i.text(),
            t(n, i),
            o = e(this),
            o.prop("disabled", !0),
            o.text(o.attr("data-readme-name") + " loaded"),
            r.show(),
            s = function() {
                return e(this).val() !== a && r.hide(),
                n.off("change keyup", s)
            }
            ,
            n.on("change keyup", s),
            !1
        ...
        e("#undo-load-readme").click(function() {
            ...
            i = e("#load-readme"),
            i.prop("disabled", !1),
            i.text("Load " + i.attr("data-readme-name")),
            e(this).hide(),
            !1
        }),
        t = function(t, i) {
...
function() {
    function e(e, t) {
        var i = e.querySelector("table.timeline-commits > tbody")
          , n = t.querySelectorAll("table.timeline-commits > tbody > tr.commit");
...
function() {
    ...
    e(document).on("details:toggled", ".js-pull-merging", function() {
        var i = void 0;
        i = e(this).find(".js-merge-pull-request"),
        i.toggleClass("is-dirty", Array.from(i).some(t))
    }),
    ...
    e(document).on("change", ".js-merge-method", function() {
        ...
        var t = e.closest(".js-pull-merging")
          , i = t.getAttribute("data-url");
        i = i.replace(/merge_type=(\w+)/, "merge_type=" + this.value),
        t.setAttribute("data-url", i)
    }),
    e(document).on("change", ".js-merge-button-toggle", function() {
        var e = void 0
          ...
          , o = void 0
          , r = void 0;
        for (n = this.closest(".js-merge-pr"),
        o = !this.checked,
    ...
    e(document).on("navigation:open", ".js-merge-method-menu .js-navigation-item", function() {
        var e = this.closest(".js-merge-pr")
          ...
          , i = e.querySelector(".js-merge-message");
        t.defaultValue === t.value && (t.defaultValue = this.getAttribute("data-input-title-value")),
        i.defaultValue === i.value && (i.defaultValue = this.getAttribute("data-input-message-value"))
    })
}
.call(this),
function() {
    var e = require("github/jquery")["default"]
      , t = void 0;
    t = require("github/fetch").fetchText,
    e(document).on("ajaxError", ".js-handle-pull-merging-errors", function(t, i) {
        var n = void 0
          , o = void 0
          , r = void 0;
        return n = this.closest(".js-pull-merging"),
        n.classList.add("is-error"),
        422 === i.status && (r = i.responseText) && (o = n.querySelector(".js-pull-merging-error"),
        e(o).replaceWith(r)),
        !1
    }),
...
function() {
    ...
    var i = require("github/jquery")["default"]
      , n = require("github/observe")
      , o = n.observe;
    o(".pull-request-ref-restore", {
        add: e,
        remove: e
    }),
    o("#js-pull-restorable", {
        add: t,
        remove: t
    })
}(),
...
function() {
    var e = require("github/jquery")["default"]
      ...
      , c = void 0
      , l = void 0;
    i = require("github/fetch").fetchJSON,
    s = require("github/history").replaceState,
    n = require("github/observe").observe,
    o = require("github/pjax"),
    e(document).on("click", ".js-timeline-tags-expander", function() {
        return e(this).closest(".js-timeline-tags").removeClass("is-collapsed")
    }),
    a = ["is-default", "is-saving", "is-saved", "is-failed"],
    u = function(e, t) {
        var i = void 0;
        return (i = e.classList).remove.apply(i, a),
        e.classList.add(t),
    ...
    e(document).on("release:saved", ".js-release-form", function(t) {
        var i = void 0
          ...
          , c = void 0
          , l = void 0;
        a = t.originalEvent.detail.release,
        n = this,
        c = n.getAttribute("data-repo-url"),
        l = r("tag", c, a.tag_name),
        i = r("edit", c, a.tag_name),
        n.setAttribute("action", l),
        s(o.getState(), document.title, i);
        var d = document.querySelector("#delete_release_confirm form");
        return d && d.setAttribute("action", l),
        u = n.querySelector("#release_id"),
        u.value ? void 0 : (u.value = a.id,
        e(n).append('<input type="hidden" name="_method" value="put">'))
    }),
    e(document).on("click", ".js-publish-release", function() {
        return e("#release_draft").val("0")
    }),
    l = ["is-loading", "is-empty", "is-valid", "is-invalid", "is-duplicate", "is-pending"],
    c = function(t) {
        var i = void 0;
        switch (t) {
        case "is-valid":
        ...
        return i = e(".js-release-tag"),
        i.removeClass(l.join(" ")),
        i.addClass(t)
    }
    ,
    t = function(t) {
        return t.val() && t.val() !== t.data("last-checked") ? (c("is-loading"),
        e.ajax({
            url: t.attr("data-url"),
            type: "GET",
            data: {
            ...
            dataType: "json",
            success: function(i) {
                return "duplicate" === i.status && parseInt(t.attr("data-existing-id")) === parseInt(i.release_id) ? void c("is-valid") : (e(".js-release-tag .js-edit-release-link").attr("href", i.url),
                c("is-" + i.status))
            },
            error: function() {
                return c("is-invalid")
    ...
    e(document).on("change", ".js-release-tag", function() {
        ...
        if (n = e(this),
        t = n.closest("form"),
        i = t.find(".js-previewable-comment-form"),
        i.length) {
            for (o = i.data("base-preview-url"),
            o || (o = i.attr("data-preview-url"),
            o += o.indexOf("?") >= 0 ? "&" : "?",
            i.data("base-preview-url", o)),
            r = [],
            c = n.find('input[name="release[tag_name]"], input[name="release[target_commitish]"]:checked'),
            s = 0,
            u = c.length; u > s; s++)
                a = c[s],
                a.value && r.push({
...
function() {
    ...
    e(document).on("change", ".js-pulse-period", function(i) {
        var n = void 0;
        return n = e(i.target).attr("data-url"),
        t["default"]({
            url: n,
...
function() {
    ...
    i = function() {
        function i() {
            ...
            this.current_login = t("input[name=owner]:checked").prop("value"),
            this.privateRepo = this.selectedPrivacyToggleElement() == this.elements.$privateRadio,
            this.changedPrivacyManually = this.privateRepo,
            this.elements.$ownerContainer.on("change", "input[type=radio]", this.handleOwnerChange),
            this.elements.$privacyToggles.on("change", function(e) {
                return function(t) {
            ...
            this.elements.$suggestion.on("click", function(e) {
                return function(i) {
                    var n = void 0;
                    return n = e.elements.$repoNameField,
                    n.val(t(i.target).text()),
                    n.trigger("change")
                }
            }(this)),
        ...
        return i.prototype.handleOwnerChange = function() {
            var e = void 0;
            return this.current_login = t("input[name=owner]:checked").prop("value"),
            ...
            "yes" === e.attr("data-permission") ? (t(".with-permission-fields").show(),
            t(".without-permission-fields").hide(),
            t(".errored").show(),
            t("dl.warn").show()) : (t(".with-permission-fields").hide(),
            t(".without-permission-fields").show(),
            t(".errored").hide(),
            t("dl.warn").hide()),
            this.updateUpsell(),
        ...
        i.prototype.handlePrivacyChange = function(e, t) {
            ...
            i = this.elements.$upgradeUpsell.find(".js-billing-section"),
            "false" === e.val() ? (this.privateRepo = !0,
            this.elements.$upgradeUpsell.show(),
            i.removeClass("has-removed-contents"),
            this.elements.$upgradeUpsell.find("input[type=checkbox]").prop("checked", "checked"),
            this.elements.$iconPreviewPublic.hide(),
            this.elements.$iconPreviewPrivate.show()) : (this.privateRepo = !1,
            this.elements.$upgradeUpsell.hide(),
            i.addClass("has-removed-contents"),
            this.elements.$upgradeUpsell.find("input[type=checkbox]").prop("checked", null ),
            this.elements.$form.attr("action", this.elements.$form.attr("data-url")),
            this.elements.$iconPreviewPrivate.hide(),
            this.elements.$iconPreviewPublic.show()),
            this.validate()
        }
        ,
    ...
    n.on("autocheck:send", "#repository_name", function(e) {
        ...
        n = e.detail,
        i = t(this),
        o = i.closest("form").find("input[name=owner]:checked").val(),
        n.owner = o,
        i.trigger("repoform:validate")
    }),
    ...
    n.on("autocheck:success", "#repository_name", function(e) {
        var t = void 0
          , i = void 0
          , n = void 0;
        null != e.detail && (n = e.detail.trim()),
        n && (t = this.closest("dl.form-group"),
...
function() {
    ...
    document.addEventListener("pjax:end", function() {
        var t = void 0
          ...
          , l = void 0
          , d = void 0;
        if (d = e(document.head).find("meta[name='selected-link']").attr("value"),
        null != d)
            for (n = e(".js-sidenav-container-pjax .js-selected-navigation-item").removeClass("selected"),
            t = 0,
            r = n.length; r > t; t++)
                for (i = n[t],
                u = null != (c = e(i).attr("data-selected-links")) ? c : "",
                l = u.split(" "),
                o = 0,
                s = l.length; s > o; o++)
                    a = l[o],
                    a === d && e(i).addClass("selected")
    })
}
.call(this),
function() {
    ...
    e(document).on("change", ".js-repository-import-lfs-opt", function() {
        ...
        t.querySelector("span.js-usage-text").innerText = i
    }),
    ...
    e(document).on("ajaxSuccess", ".js-repository-import-author-form", function(t, i, n, o) {
        var r = e.parseHTML(o.trim())
          , s = this.closest(".js-repository-import-author");
...
function() {
    ...
    var n = require("github/jquery")["default"]
      ...
      , a = s.on;
    n(document).on("ajaxSend", ".js-send-auth-code", e),
    n(document).on("ajaxSuccess", ".js-send-auth-code", t),
    n(document).on("ajaxError", ".js-send-auth-code", function(e, t) {
        i(t.responseText)
    }),
    a("click", ".js-send-two-factor-code", function() {
        var n = this.form
          , o = n.querySelector(".js-country-code-select").value
          , s = n.querySelector(".js-sms-number").value
          , a = o + " " + s
          , u = n.querySelector(".js-two-factor-secret").value;
        e();
        var c = new FormData;
        c.append("number", a),
        c.append("two_factor_secret", u),
        c.append("authenticity_token", n.elements.authenticity_token.value),
        r(this.getAttribute("data-url"), {
            method: "post",
            body: c
        }).then(function() {
            t(),
            Array.from(n.querySelectorAll(".js-2fa-enable")).forEach(function(e) {
                return e.disabled = !1
            }),
            n.querySelector(".js-2fa-otp").focus()
        })["catch"](function(e) {
            e.response && e.response.text().then(i),
            Array.from(n.querySelectorAll(".js-2fa-enable")).forEach(function(e) {
                return e.disabled = !0
            })
        })
    ...
    document.addEventListener("facebox:reveal", function() {
        ...
        e && (n(".js-configure-sms-fallback .facebox-alert").text("").hide(),
        n(".js-configure-sms-fallback").show(),
        n(".js-verify-sms-fallback").hide())
    }),
    n(document).on("ajaxSuccess", ".js-two-factor-set-sms-fallback", function(e, t) {
        ...
        case 201:
            ...
            break;
        case 202:
            n(".js-configure-sms-fallback").hide(),
            n(".js-verify-sms-fallback").show(),
            n(".js-fallback-otp").focus()
        }
    }),
    n(document).on("ajaxError", ".js-two-factor-set-sms-fallback", function(e, t) {
        ...
        case 422:
            ...
            break;
        case 429:
            return n(".js-configure-sms-fallback .facebox-alert").text(t.responseText).show(),
            !1
        }
    })
}(),
...
function() {
    function e() {
        var e = this
          ...
          , i = e.closest(".js-user-profile-bio-container").querySelector(".js-user-profile-bio-message")
          , n = e.value
          , o = e.getAttribute("data-bio-label")
          , r = t - n.length;
        n.length > t || 5 >= r ? (i.textContent = r + " " + o,
        i.classList.remove("d-none")) : (i.textContent = "",
        i.classList.add("d-none"))
    }
    function t(e) {
    ...
    var n = void 0
      , o = void 0;
    n = require("delegated-events").fire,
    o = require("github/observe").observe;
    var r = require("github/jquery")["default"]
      , s = require("github/facebox").close;
    ...
    r(document).on("change", ".js-email-global-unsubscribe-form", function() {
        ...
        return e = function() {
            var e = void 0
              ...
              , n = void 0
              , o = void 0;
            for (n = this.querySelectorAll(".js-email-global-unsubscribe"),
            o = [],
            e = 0,
            i = n.length; i > e; e++)
                t = n[e],
    ...
    r(document).on("ajaxSuccess", ".js-remove-ssh-key", function() {
        return r(this).closest("li").remove(),
        0 === r(".js-ssh-keys-box li").length ? r(".js-ssh-keys-container").removeClass("has-keys") : void 0
    }),
    ...
    r(document).on("ajaxSuccess", ".js-remove-gpg-key", function() {
        return r(this).closest("li").remove(),
        0 === r(".js-gpg-keys-box li").length ? r(".js-gpg-keys-container").removeClass("has-keys") : void 0
    }),
    ...
    r(document).on("ajaxSuccess", ".js-leave-collaborated-repo", function(e) {
        ...
        i = document.querySelector(".js-collab-repo[data-repo-id='" + t + "']"),
        i.remove(),
        s()
    }),
    r(document).on("ajaxSuccess", ".js-newsletter-unsubscribe-form", function() {
        var e = void 0
          ...
          , n = void 0
          , o = void 0;
        for (n = document.querySelectorAll(".js-newsletter-unsubscribe-message"),
        o = [],
        t = 0,
        i = n.length; i > t; t++)
            e = n[t],
            o.push(e.classList.toggle("d-none"));
        return o
    }),
    r(document).on("click", ".js-show-new-ssh-key-form", function() {
        return r(".js-new-ssh-key-box").toggle().find(".js-ssh-key-title").focus(),
        !1
    }),
    r(document).on("click", ".js-show-new-gpg-key-form", function() {
        return r(".js-new-gpg-key-box").toggle().find(".js-gpg-key-public_key").focus(),
        !1
    }),
    r(document).on("ajaxSuccess", ".js-revoke-access-form", function() {
        ...
        i = this.getAttribute("data-type-name"),
        t = document.querySelector(".js-revoke-item[data-type='" + i + "'][data-id='" + e + "']"),
        s(),
        t.remove(),
    ...
    r(document).on("click", ".js-delete-oauth-application-image", function() {
        var e = void 0
          ...
          , o = void 0
          , s = void 0;
        return e = r(this).closest(".js-uploadable-container"),
        t = e.closest("form"),
        i = this.getAttribute("data-app-logo-destroy-path"),
        n = this.getAttribute("data-app-logo-destroy-method"),
        o = this.getAttribute("data-app-logo-destroy-field-name"),
        s = this.getAttribute("data-app-logo-destroy-field-value"),
        t.attr("action", i),
        t.append('<input name="' + o + '" type="hidden" value="' + s + '">'),
        t.append('<input name="_method" type="hidden" value="' + n + '">'),
        t.submit(),
        !1
    }),
    r(document).on("click", ".js-new-callback", function(e) {
        var t = void 0
          , i = void 0;
        return e.preventDefault(),
        t = r(e.currentTarget).closest(".js-callback-urls"),
        i = t.find(".js-callback-url").first().clone(),
        i.removeClass("is-default-callback"),
        i.find("input").val(""),
        t.addClass("has-many"),
        r(e.currentTarget).before(i)
    }),
    r(document).on("click", ".js-delete-callback", function(e) {
        ...
        return e.preventDefault(),
        t = r(e.currentTarget).closest(".js-callback-urls"),
        r(e.currentTarget).closest(".js-callback-url").remove(),
        i = t.find(".js-callback-url"),
        i.length <= 1 ? t.removeClass("has-many") : void 0
    }),
    r(document).on("click", ".js-oauth-application-whitelist .js-deny-this-request", function(e) {
        return r(e.currentTarget).siblings("#state").val("denied"),
        r(e.currentTarget).closest(".js-org-application-access-form").submit()
    }),
    ...
    r(document).on("click", ".js-user-rename-warning-continue", function() {
        var e = void 0
          ...
          , n = void 0
          , o = void 0;
        for (n = document.querySelectorAll(".js-user-rename-warning, .js-user-rename-form"),
        o = [],
        t = 0,
        i = n.length; i > t; t++)
            e = n[t],
    ...
    r(document).on("change", ".js-checkbox-scope", function() {
        var e = void 0
          ...
          , o = void 0
          , r = void 0;
        for (n = this.closest(".js-check-scope-container"),
        o = n.querySelectorAll(".js-checkbox-scope"),
        r = [],
        t = 0,
        i = o.length; i > t; t++)
            e = o[t],
            e !== this ? (e.checked = this.checked,
            r.push(e.disabled = this.checked)) : r.push(void 0);
        return r
    }),
    r(document).on("click", ".js-generate-integration-key", function() {
        var e = void 0;
        return n(document, "facebox:close"),
        e = document.querySelector(".js-integration-key-management-wrapper"),
        e.classList.add("downloading")
    }),
    r(document).on("keyup", ".js-user-profile-bio", e).on("change", ".js-user-profile-bio", e),
    o(".js-block-users-form", i),
    r(document).on("ajaxSuccess", ".js-block-users-form", function(e, o, r, s) {
        var a = document.querySelector(".js-user-block-settings-list")
          , u = a.querySelector(".js-blocked-list");
        i(this);
        var c = this.querySelector(".js-add-blocked-user-field");
        c.value = "",
        n(c, "change"),
        t(a),
        u.insertAdjacentHTML("afterBegin", s)
    }),
...
function() {
    function e(e) {
        ...
        n(".js-site-search").removeClass("scoped-search"),
    ...
    function t(e) {
        ...
        n(".js-site-search").addClass("scoped-search"),
        e.setAttribute("placeholder", e.getAttribute("data-scoped-placeholder"))
    }
    function i(i) {
        var n = i.target
          , o = n.value;
        "" === o && "backspace" === i.hotkey && n.classList.contains("is-clearable") && e(n),
        "" === o && "esc" === i.hotkey && t(n),
        n.classList.toggle("is-clearable", "" === o)
    }
    var n = require("github/jquery")["default"];
...
function() {
    var e = require("github/observe")
      , t = e.observe
      , i = require("github/html-validation")
      , n = i.revalidate;
...
function() {
    var e = require("github/observe")
      , t = e.observe
      , i = require("github/jquery")["default"]
      , n = void 0
      , o = void 0;
    n = function() {
        var e = void 0;
        return e = i("#js-features-branch-diagram"),
        e.removeClass("preload"),
        e.find("path").each(function() {
            var e = void 0
              , t = void 0
              , n = void 0;
            return i(this).is("#js-branch-diagram-branch") ? n = "stroke-dashoffset 3.5s linear 0.25s" : i(this).is("#js-branch-diagram-master") ? n = "stroke-dashoffset 4.1s linear 0s" : i(this).is("#js-branch-diagram-arrow") && (n = "stroke-dashoffset 0.2s linear 4.3s"),
            t = i(this).get(0),
            e = t.getTotalLength(),
    ...
    i(document).on("click", ".js-segmented-nav-button", function(e) {
        var t = void 0
          , n = void 0;
        return n = i(this).attr("data-selected-tab"),
        t = i(this).closest(".js-segmented-nav"),
...
function() {
    var e = require("github/jquery")["default"]
      , t = require("github/visible")["default"]
      , i = require("github/facebox")["default"]
      , n = require("github/facebox").close
      , o = void 0
      , r = void 0;
    o = require("github/fetch").fetchText,
    r = function() {
    ...
    e(document).on("click", ".js-see-all-keyboard-shortcuts", function() {
        return this.remove(),
        e(".facebox .js-hidden-pane").css("display", "table-row-group"),
        !1
    }),
    e(document).on("keypress", function(i) {
        return i.target === document.body && 63 === i.which ? (Array.from(e(".facebox")).some(t) ? n() : r(),
        !1) : void 0
    })
}
.call(this),
function() {
    ...
    t(".js-site-status-container", function() {
        var e = void 0
          ...
          , o = void 0;
        o = this,
        t = o.querySelector(".js-site-status-message"),
        i = o.querySelector(".js-site-status-time"),
        e = o.querySelector(".flash"),
        n = document.querySelector("meta[name=site-status-api-url]").content,
        window.fetch(n).then(function(e) {
            return e.json()
        }).then(function(n) {
            var r = void 0;
            null != n.status && "good" !== n.status && (t.textContent = n.body,
            i.setAttribute("datetime", n.created_on),
            r = "major" === n.status ? "error" : "warn",
            e.classList.add("flash-" + r),
...
function() {
    ...
    e(document).on("ajaxComplete", ".js-action-ldap-create", function(t, i) {
        var n = void 0
          , o = void 0;
        return n = e(this),
        o = 500 === i.status ? "Oops, something went wrong." : i.responseText,
        n.find(".js-message").show().html(" &ndash; " + o),
        200 === i.status && n.find(".btn").hide(),
        !1
    })
}
.call(this),
function() {
    function e(t, i) {
        ...
        if (n) {
            var o = g.get(n);
            if (!o)
                return void (null == p && (p = r(n.getAttribute("data-url")).then(function(i) {
                    g.set(n, i.paths),
                    e(t),
                    p = null
                })["catch"](function() {
            ...
            var s = n.querySelector(".js-tree-browser-result-template").firstElementChild
              , d = n.querySelector(".js-tree-finder-results");
            null == i && (i = t.value);
            var h = void 0
              , f = void 0;
            i ? (h = u(i),
            f = a(o, i)) : f = o,
            n.classList.toggle("filterable-empty", !f.length);
    ...
    var i = require("github/observe")
      ...
      , a = s.fuzzySort
      , u = s.fuzzyRegexp
      , c = s.fuzzyHighlightElement
      , l = require("github/navigation").focus
      , d = require("github/focused")
      , h = d.onFocusedKeydown
      , f = require("github/throttled-input")
      , v = f.addThrottledInputEventListener
      , m = f.removeThrottledInputEventListener
      , p = null
      , g = new WeakMap;
    h(document, ".js-tree-finder-field", function() {
        return function(e) {
            "esc" === e.hotkey && (history.back(),
            e.preventDefault())
        }
    }),
...
function() {
    function e(e, t) {
        ...
        return regeneratorRuntime.async(function(a) {
            for (; ; )
                ...
                case 0:
                    return i = document.querySelector(".js-calendar-graph"),
                    n = i.getAttribute("data-graph-url"),
                    o = n + "?from=" + m(e) + "&to=" + m(t),
                    a.next = 5,
                    regeneratorRuntime.awrap(s(document, o));
                case 5:
                    r = a.sent,
                    document.querySelector(".js-calendar-graph-svg").replaceWith(r);
                case 7:
                case "end":
                    return a.stop()
                }
    ...
    function t(t, i) {
        var n = new Date(Date.parse("1 " + t + " " + i + " 00:00:00 UTC"))
          , o = new Date(Date.UTC(n.getUTCFullYear(), n.getUTCMonth() + 1, 0));
        e(n, o)
    }
    function i(e) {
    ...
    var o = require("github/jquery")["default"]
      , r = require("github/fetch")
      , s = r.fetchSafeDocumentFragment
      , a = require("github/pjax")["default"]
      , u = void 0
      , c = void 0
      , l = void 0
      , d = void 0
      ...
      , A = void 0
      , E = void 0;
    f = require("delegated-events"),
    j = require("github/inflector").pluralize,
    v = require("github/number-helpers").formatNumber,
    g = require("github/observe").observe,
    y = null ,
    w = null ,
    L = null ,
    C = null ,
    ...
    ,
    f.on("pjax:send", "#js-contribution-activity", function() {
        this.classList.add("loading")
    }),
    f.on("pjax:complete", "#js-contribution-activity", function() {
        this.classList.remove("loading")
    }),
    g(".js-calendar-graph-svg", function() {
        var e = void 0
          , t = void 0
          , i = void 0;
    ...
    f.on("click", ".js-calendar-graph rect.day", function(e) {
        var t = void 0;
        t = E(this.getAttribute("data-date")),
        x(t, e.shiftKey, !1)
    }),
    l = function(e) {
        return e.target.matches("rect.day") ? A(e.target) : void 0
    }
    ,
    h = function() {
        var e = void 0;
    ...
    A = function(e) {
        var t = void 0
          ...
          , c = void 0
          , l = void 0;
        return n = E(e.getAttribute("data-date")),
        i = parseInt(e.getAttribute("data-count")),
        a = 0 === i ? "No" : v(i),
        s = u[n.getUTCMonth()].slice(0, 3) + " " + n.getUTCDate() + ", " + n.getUTCFullYear(),
        r = o('<div class="svg-tip svg-tip-one-line">\n  <strong>' + a + " " + j(i, "contribution") + "</strong> on " + s + "\n</div>").get(0),
        o(".svg-tip").remove(),
        document.body.appendChild(r),
        t = e.getBoundingClientRect(),
        c = t.left + window.pageXOffset - r.offsetWidth / 2 + t.width / 2,
        l = t.bottom + window.pageYOffset - r.offsetHeight - 2 * t.height,
        r.style.top = l + "px",
        r.style.left = c + "px"
    }
    ,
    ...
    q = function(e, t) {
        var i = void 0
          , n = void 0;
        return n = e.getAttribute("class").trim().split(" "),
        n = function() {
            var e = void 0
              , o = void 0
              , r = void 0;
    ...
    S = function(e, t) {
        var i = void 0
          ...
          , l = void 0
          , d = void 0;
        for (i = document.querySelector(".js-calendar-graph"),
        d = i.querySelectorAll("rect.day"),
        r = 0,
        a = d.length; a > r; r++)
            n = d[r],
            q(n, "active");
        if (i.classList.remove("days-selected"),
        e || t) {
            for (i.classList.add("days-selected"),
            o = function(i) {
                var n = void 0;
                return n = E(i.getAttribute("data-date")).getTime(),
                e && t ? e.getTime() <= n && n <= t.getTime() : n === e.getTime()
            }
            ,
            l = [],
            s = 0,
    ...
    ,
    m = function(e) {
        return e.getUTCFullYear() + "-" + b(e.getUTCMonth() + 1) + "-" + b(e.getUTCDate())
    }
    ,
    E = function(e) {
        var t = void 0
    ...
    x = function(e, t, i) {
        var n = void 0
          ...
          , c = void 0
          , l = void 0;
        return l = d() + "?tab=overview",
        e >= L && C >= e ? void k("weekly") : ("object" == typeof t && (w = t,
        t = !0),
        w && t ? (r = new Date(w.getTime() - 26784e5),
        o = new Date(w.getTime() + 26784e5),
        s = e > w ? [w, e] : [e, w],
        n = s[0],
        c = s[1],
        r > n && (n = r),
    ...
    f.on("click", ".js-year-link", function(i) {
        i.preventDefault(),
        i.stopPropagation();
        var n = document.querySelector(".js-year-link.selected")
          , o = i.target;
        n.classList.remove("selected"),
    ...
    window.addEventListener("hashchange", function(e) {
        ...
        return o ? (e.stopPropagation(),
        void i(o)) : !0
    }),
    g(".js-no-contributions-activity", function() {
...
!function() {
    function e(e, t, i) {
        var n = e.querySelector(".js-remaining-pinned-repos-count")
          , o = n.getAttribute("data-remaining-label")
          , r = i - t;
        n.textContent = r + " " + o,
        n.classList.toggle("text-red", 1 > r)
    }
    function t(t) {
        var i = parseInt(t.getAttribute("data-max-repo-count"), 10)
          , n = t.querySelectorAll("input[type=checkbox]:checked").length
          , o = Array.from(t.querySelectorAll("input[type=checkbox]"));
    ...
    function i(e) {
        var t = Array.from(e.querySelectorAll(".js-pinned-repo-source:checked"))
          , i = t.map(function(e) {
            return e.value
        })
          , n = i.indexOf("owned") > -1
          , o = i.indexOf("contributed") > -1;
    ...
    function n(e) {
        var t = e.classList.contains("js-owned-repo")
          , i = e.classList.contains("js-contributed-repo");
        return [t, i]
    }
    function o(e) {
        "enter" === a(e) && e.preventDefault();
        var t = e.target.closest(".js-pinned-repos-selection-form")
          , o = t.querySelector(".js-pinned-repos-filter").value.trim().toLowerCase()
          , r = o.length < 1
          , s = t.querySelectorAll(".js-pinned-repos-selection")
          , u = i(t)
        ...
        Array.from(s).forEach(function(e) {
            var t = e.querySelector(".js-repo").textContent.trim()
              ...
              , h = t.toLowerCase().indexOf(o) > -1
              , f = (r || h) && (a && l || u && d)
              , v = c || f;
            e.classList.toggle("d-none", !v)
        })
    }
    var r = require("delegated-events")
      , s = r.on
      , a = require("github/hotkey")["default"];
    ...
    s("keyup", ".js-pinned-repos-filter", o),
    s("change", ".js-pinned-repos-filter", o),
    s("search", ".js-pinned-repos-filter", o),
    s("change", ".js-pinned-repo-source", o),
    document.addEventListener("facebox:reveal", function() {
...
function() {
    ...
    function t(e) {
        var t = e.oldIndex
          ...
          , n = e.item;
        if (t !== i) {
            var o = n.closest(".js-pinned-repos-reorder-form")
              , s = o.closest(".js-pinned-repos-reorder-container")
              , a = s.querySelector(".js-pinned-repos-spinner")
              , u = s.querySelector(".js-pinned-repos-reorder-error");
            u.textContent = "",
    ...
    var i = require("delegated-events")
      , n = i.on
      , o = require("github/fetch")
      , r = o.fetchText
      , s = require("github/observe")
      , a = s.observe
      , u = require("sortablejs")
      , c = null
      , l = null ;
    ...
    e(function() {
        function t() {
            ...
            i && n("_current").then(function(n) {
                i == n ? setTimeout(t, 5e3) : o || (e("#gollum-error-message").text("Someone has edited the wiki since you started. Please reload this page and re-apply your changes."),
                e("#gollum-error-message").show(),
                e("#gollum-editor-submit").attr("disabled", "disabled"),
                e("#gollum-editor-submit").attr("value", "Cannot Save, Someone Else Has Edited"))
            })
        }
        var i = require("github/fetch")
          , n = i.fetchText
...
function() {
    var e = require("github/observe")
      ...
      , o = void 0
      , r = void 0;
    n = null != (o = document.querySelector("meta[name=form-nonce]")) ? o.content : void 0,
    null != n && (r = require("github/failbot").reportError,
    i = require("github/inspect")["default"],
    t("form", function(e) {
        var t = void 0
          , o = void 0;
        "get" !== e.method.toLowerCase() && (o = e.getAttribute("data-form-nonce"),
        null != o && o !== n && (t = new Error("Incorrect form-nonce"),
        r(t, {
            form: i(e),
            method: e.method,
            action: e.action
...
function() {
    var e = void 0
      ...
      , o = void 0
      , r = void 0;
    r = require("github/failbot").reportError,
    n = require("github/proxy-site-detection")["default"],
    e = "$__",
    n(document) && (t = {
