<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hobbies.aspx.cs" Inherits="Hobbies" %>
                                ...
                                <div class="columns popular-repos">
                                    <div class="single-column">
                                        <div class="boxed-group flush js-pinned-repos-reorder-container">
                                            <h3>Tennis &amp; work-out</h3>
                                            <div class="boxed-group-inner clearfix">
                                                <div class="single-column">
                                                    <dl class="form-group edit-profile-avatar">
                                                        <dt><label for="upload-profile-picture">My dream is that I could play tennis at least one a week, but it seems difficult to find a partner!!!</label></dt>
                                                        <dd class="avatar-upload-container clearfix">
                                                            <img style="padding:10px;height:700px;width:600px;" alt="@CodingFrank" class="avatar float-left" src="images/DSC_7454.jpg">
                                                            <img style="padding:10px;" alt="@CodingFrank" class="avatar float-left" height="600" src="images/DSC_7479.jpg" width="700">
                                                        </dd>
                                                    </dl>
                                                    <dl class="form-group edit-profile-avatar">
                                                        <dt><label for="upload-profile-picture">My favorite tennis star is Andre Agassie, but he retired, 13 years ago.</label></dt>
                                                        <dd class="avatar-upload-container clearfix">
                                                            <img style="padding:10px;" alt="@CodingFrank" class="avatar float-left" height="620" src="images/agassi1959607.jpg" width="700">
                                                        </dd>
                                                    </dl>
                                                </div>
                                            </div>
